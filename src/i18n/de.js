export default {
  a11y: {
    dateiGespeichert: 'Datei wird auf diesem Gerät gespeichert',
    dateiGewaehlt: 'Datei von diesem Gerät auswählen',
  ...
  lebenszustaende: {
    ...
    sectionIntro: { sie: 'Manches steht einem nicht wegen eines einzelnen Ereignisses zu, sondern wegen einer andauernden Situation. Wählen Sie, was passt. Das bleibt auf Ihrem Gerät und hilft nur, Ihnen Passendes zu zeigen — kein Profil, keine Bewertung.', du: 'Manches steht einem nicht wegen eines einzelnen Ereignisses zu, sondern wegen einer andauernden Situation. Wähle, was passt. Das bleibt auf deinem Gerät und hilft nur, dir Passendes zu zeigen — kein Profil, keine Bewertung.' },
    selectHint: 'Eine Situation antippen, um zu sehen, was infrage kommt.',
    quelleLabel: 'Quelle',
    standLabel: 'Stand',
    regio: {
      title: { sie: 'Angebote in Ihrer Region', du: 'Angebote in deiner Region' },
      kulturlegiRegion: { sie: 'Ihre regionale KulturLegi', du: 'Deine regionale KulturLegi' },
      kulturlegiRegionText: { sie: 'Die Angebote für Ihre Region — Kultur, Kurse, Sport und mehr.', du: 'Die Angebote für deine Region — Kultur, Kurse, Sport und mehr.' },
      checkTitle: { sie: 'Ihre regionale KulturLegi finden', du: 'Deine regionale KulturLegi finden' },
      checkText: { sie: 'Die KulturLegi listet vergünstigte Angebote je Region — sehen Sie nach, was bei Ihnen gilt.', du: 'Die KulturLegi listet vergünstigte Angebote je Region — schau, was bei dir gilt.' },
      noneNote: { sie: 'In Ihrer Region scheint es noch keine KulturLegi zu geben — das kann sich ändern.', du: 'In deiner Region scheint es noch keine KulturLegi zu geben — das kann sich ändern.' },
      offers: {
        familienpass: { titel: 'Familienpass Region Basel', text: 'Über 150 Angebote und Vergünstigungen für Familien; FamilienpassPlus für kleine Budgets (30.–/Jahr).' },
    ...
    dashboardLink: { sie: 'Trifft eine Situation auf Sie zu?', du: 'Trifft eine Situation auf dich zu?' },
    tiefesEinkommen: {
      ...
      berechtigungen: {
        ...
        betreuungsgutscheine: { titel: 'Betreuungsgutscheine (Kita & Tagesbetreuung)', text: { sie: 'Viele Gemeinden und Kantone verbilligen die familienergänzende Betreuung einkommensabhängig — oft unbekannt. Fragen Sie bei Ihrer Wohngemeinde nach Betreuungsgutscheinen oder subventionierten Plätzen.', du: 'Viele Gemeinden und Kantone verbilligen die familienergänzende Betreuung einkommensabhängig — oft unbekannt. Frag bei deiner Wohngemeinde nach Betreuungsgutscheinen oder subventionierten Plätzen.' } },
        familienEL: { titel: 'Ergänzungsleistungen für Familien', text: { sie: 'Ihr Kanton zahlt erwerbstätigen Familien mit kleinen Kindern und knappem Einkommen eine monatliche Ergänzungsleistung — damit eine Familie nicht in die Sozialhilfe rutscht. Oft unbekannt.', du: 'Dein Kanton zahlt erwerbstätigen Familien mit kleinen Kindern und knappem Einkommen eine monatliche Ergänzungsleistung — damit eine Familie nicht in die Sozialhilfe rutscht. Oft unbekannt.' } },
        mutterschaftsbeihilfe: { titel: 'Mutterschaftsbeihilfe', text: { sie: 'Einige Kantone zahlen Ihnen nach der Geburt während mehreren Monaten eine Beihilfe, damit Sie Ihr Kleinkind selbst betreuen können, wenn das Einkommen den Lebensbedarf nicht deckt. Oft unbekannt.', du: 'Einige Kantone zahlen dir nach der Geburt während mehreren Monaten eine Beihilfe, damit du dein Kleinkind selbst betreuen kannst, wenn das Einkommen den Lebensbedarf nicht deckt. Oft unbekannt.' } },
        kulturlegi: { titel: 'KulturLegi (Caritas)', text: { sie: 'Der Ausweis für kleine Budgets: mindestens 30% Rabatt auf tausende Angebote in Kultur, Sport, Bildung (z.B. Kurse) und Gesundheit (z.B. Zahnbehandlung). Das Angebot ist je Region verschieden — Ihre kantonale KulturLegi zeigt, was bei Ihnen gilt.', du: 'Der Ausweis für kleine Budgets: mindestens 30% Rabatt auf tausende Angebote in Kultur, Sport, Bildung (z.B. Kurse) und Gesundheit (z.B. Zahnbehandlung). Das Angebot ist je Region verschieden — deine kantonale KulturLegi zeigt, was bei dir gilt.' } },
    ...
    alleinerziehend: {
      ...
      frage: { sie: 'Ziehen Sie ein oder mehrere Kinder allein gross?', du: 'Ziehst du ein oder mehrere Kinder allein gross?' },
    ...
    beeintraechtigung: {
      ...
      frage: { sie: 'Leben Sie mit einer Beeinträchtigung, chronischen Krankheit oder anerkannten Indikation?', du: 'Lebst du mit einer Beeinträchtigung, chronischen Krankheit oder anerkannten Indikation?' },
    ...
    pflegendeAngehoerige: {
      ...
      berechtigungen: {
        ...
        betreuungsentschaedigung: { titel: 'Betreuungsentschädigung (EO)', text: 'Bezahlter Urlaub von bis zu 14 Wochen zur Betreuung eines schwer kranken oder verunfallten Kindes — entschädigt über die EO. Für kurze Abwesenheiten wegen anderer Angehöriger zahlt der Arbeitgeber bis zu 3 Tage pro Ereignis und 10 pro Jahr (OR Art. 329h).' },
    ...
    frischZugezogen: {
      ...
      berechtigungen: {
        ...
        quellensteuer: { titel: 'Quellensteuer', text: 'Ohne Niederlassungsbewilligung (C) wird die Steuer in der Regel direkt vom Lohn abgezogen — nicht aber bei Ehe mit einer Person mit Schweizer Bürgerrecht oder C-Bewilligung (DBG Art. 83). Abzüge lassen sich über eine nachträgliche ordentliche Veranlagung geltend machen: auf Antrag bis 31. März des Folgejahres, der Antrag ist endgültig (DBG Art. 89a, QStV Art. 10).' },
    ...
    inAusbildung: {
      ...
      berechtigungen: {
        stipendien: { titel: 'Stipendien & Ausbildungsbeiträge', text: { sie: 'Kantonale Stipendien und Darlehen unterstützen Lehre und Studium — abhängig von Ihrem Einkommen und dem Ihrer Eltern, und mit Fristen bei der Anmeldung.', du: 'Kantonale Stipendien und Darlehen unterstützen Lehre und Studium — abhängig vom Einkommen von dir und deinen Eltern, und mit Fristen bei der Anmeldung.' } },
    ...
    rentnerin: {
      ...
      frage: { sie: 'Beziehen Sie eine AHV-Rente oder stehen Sie kurz davor?', du: 'Beziehst du eine AHV-Rente oder stehst kurz davor?' },
      intro: 'Im Alter bleibt manches ungenutzt — allen voran die Ergänzungsleistungen. Vieles davon ist ein Recht, keine Fürsorge.',
      berechtigungen: {
        pensionierung: { titel: 'Übergang in die Pensionierung', text: { sie: 'Stehen Sie kurz davor? AHV-Anmeldung, die Wahl zwischen Rente oder Kapital aus der Pensionskasse und der gestaffelte Bezug der 3. Säule wollen früh entschieden sein — der geführte Ablauf zeigt die Schritte und Fristen.', du: 'Stehst du kurz davor? AHV-Anmeldung, die Wahl zwischen Rente oder Kapital aus der Pensionskasse und der gestaffelte Bezug der 3. Säule wollen früh entschieden sein — der geführte Ablauf zeigt die Schritte und Fristen.' } },
    ...
    erwerbslos: {
      ...
      berechtigungen: {
        rav: { titel: 'Rechtzeitig beim RAV anmelden', text: { sie: 'Die RAV-Anmeldung ist die wichtigste Frist — am besten am ersten Tag ohne Stelle, bevor Sie Taggeld beziehen. Jeder zu späte Tag kostet Taggeld. Der geführte Ablauf zeigt die Schritte und legt die Frist in Ihren Kalender.', du: 'Die RAV-Anmeldung ist die wichtigste Frist — am besten am ersten Tag ohne Stelle, bevor du Taggeld beziehst. Jeder zu späte Tag kostet Taggeld. Der geführte Ablauf zeigt die Schritte und legt die Frist in deinen Kalender.' } },
        alv: { titel: 'Arbeitslosentaggeld (ALV)', text: { sie: 'Melden Sie sich so früh wie möglich beim RAV an — die Taggelder hängen von Ihren Beitragsmonaten ab, und eine späte Anmeldung kostet Tage.', du: 'Melde dich so früh wie möglich beim RAV an — die Taggelder hängen von deinen Beitragsmonaten ab, und eine späte Anmeldung kostet Tage.' } },
    ...
    verschuldet: {
      ...
      frage: { sie: 'Belasten Sie Schulden oder eine Betreibung?', du: 'Belasten dich Schulden oder eine Betreibung?' },
    ...
    halbwaise: {
      ...
      frage: { sie: 'Ist ein Elternteil verstorben, und sind Sie oder Ihr Kind unter 25 oder in Ausbildung?', du: 'Ist ein Elternteil verstorben, und bist du oder dein Kind unter 25 oder in Ausbildung?' },
  ...
  umzug: {
    ...
    step3Add: 'merken',
    step3Added: 'gemerkt',
    step3AddAll: 'Alle in die Merkliste',
    step3TodoPrefix: 'Adresse ändern:',
  ...
  todesfall: {
    ...
    step1Text: { sie: 'Eine Ärztin oder ein Arzt stellt die Todesbescheinigung aus. Der Todesfall wird innert zwei Tagen beim Zivilstandsamt des Sterbeorts gemeldet — ein Bestattungsinstitut übernimmt das meist für Sie. Sie müssen in diesen Tagen nicht alles allein tragen.', du: 'Eine Ärztin oder ein Arzt stellt die Todesbescheinigung aus. Der Todesfall wird innert zwei Tagen beim Zivilstandsamt des Sterbeorts gemeldet — ein Bestattungsinstitut übernimmt das meist für dich. Du musst in diesen Tagen nicht alles allein tragen.' },
    step2Title: '2 · Bestattung organisieren',
    step2Text: { sie: 'Das Bestattungsinstitut begleitet Sie durch die Organisation. Fragen Sie nach den Wünschen der verstorbenen Person (Testament, Vorsorgedokumente) und lassen Sie sich die Kosten transparent aufschlüsseln. Die Gemeinde regelt das Grab.', du: 'Das Bestattungsinstitut begleitet euch durch die Organisation. Fragt nach den Wünschen der verstorbenen Person (Testament, Vorsorgedokumente) und lasst euch die Kosten transparent aufschlüsseln. Die Gemeinde regelt das Grab.' },
    step3Title: '3 · Renten & Versicherungen melden',
    step3Text: { sie: 'Melden Sie den Todesfall der AHV-Ausgleichskasse, der Pensionskasse sowie Krankenkasse, Lebensversicherung und Bank. Vieles davon hat ein paar Wochen Zeit.', du: 'Meldet den Todesfall der AHV-Ausgleichskasse, der Pensionskasse sowie Krankenkasse, Lebensversicherung und Bank. Vieles davon hat ein paar Wochen Zeit.' },
    step3Link: 'Vorsorge ansehen',
    step3LinkSituation: 'Wenn ein Elternteil verstorben ist: Situation „Halbwaise“',
    stepElTitle: '4 · Hinterbliebenenrente & EL prüfen',
    stepElText: 'Hinterbliebene haben oft Anspruch auf eine Witwen-, Witwer- oder Waisenrente. Deckt sie die Lebenskosten nicht, können Ergänzungsleistungen (EL) sie aufstocken — kein Almosen, sondern ein gesetzlicher Anspruch.',
    step4Title: '5 · Erbschaft & Nachlass',
  ...
  pflege: {
    ...
    step1Link: 'Im Vorsorge-Rechner eintragen',
    stepLohnTitle: { sie: '2 · Ihren Einsatz entlöhnen lassen', du: '2 · Deinen Einsatz entlöhnen lassen' },
    stepLohnText: 'Pflege ist Arbeit — und sie darf entlöhnt werden. Manche (Spitex-nahen) Organisationen stellen pflegende Angehörige an und zahlen einen Stundenlohn. So sieht eine grobe Schätzung aus:',
    entl: {
      hoursLabel: 'Pflege pro Woche',
      hoursUnit: 'Std.',
      resultLabel: 'Mögliche Entlöhnung (Brutto)',
      month: 'Monat',
      year: 'Jahr',
      rateNote: 'gerechnet mit ca. CHF 37.90/h — Angabe eines privaten Anbieters (pflegewegweiser.ch, September 2026), kein gesetzlicher Tarif',
      zuschlaege: 'Für Abend-, Wochenend- oder Nachteinsätze sind je nach Organisation Zuschläge möglich.',
      disclaimer: 'Unverbindliche Orientierung. Der tatsächliche Lohn hängt von der anstellenden Organisation und vom Kanton ab — kein garantierter Tarif.',
      extLink: { sie: 'Spitex-Organisation in Ihrer Region finden', du: 'Spitex-Organisation in deiner Region finden' },
    },
    step2Title: '3 · Betreuungsentschädigung (EO)',
    step2Text: 'Für die Pflege eines schwer kranken oder verunfallten Kindes gibt es bezahlten Betreuungsurlaub, entschädigt über die Erwerbsersatzordnung (EO). Auch kurze Urlaube für erwachsene Angehörige sind möglich.',
    step2Link: 'Erwerbsersatz (EO) ansehen',
    step3Title: '4 · Hilflosenentschädigung der gepflegten Person',
    step3Text: 'Braucht die gepflegte Person im Alltag regelmässig Hilfe, hat sie allenfalls Anspruch auf eine Hilflosenentschädigung — unabhängig vom Einkommen. Sie hilft mit, die nötige Betreuung zu finanzieren.',
    step3Link: 'Krankheit & IV ansehen',
    step4Title: '5 · Entlastung & Beratung',
    step4Text: { sie: 'Sie müssen das nicht allein tragen. Entlastungsdienste, Pro Senectute, Pro Infirmis und die Spitex begleiten und entlasten. Die passende Lebenssituation bündelt weitere Ansprüche an einem Ort.', du: 'Du musst das nicht allein tragen. Entlastungsdienste, Pro Senectute, Pro Infirmis und die Spitex begleiten und entlasten. Die passende Lebenssituation bündelt weitere Ansprüche an einem Ort.' },
    step4Link: 'Situation „Angehörige pflegen" ansehen',
  ...
  iv: {
    ...
    step1Text: { sie: 'Lassen Sie sich die Arbeitsunfähigkeit ärztlich bescheinigen und informieren Sie den Arbeitgeber. Eine Zeit lang läuft der Lohn weiter; danach greift — wenn vorhanden — ein Krankentaggeld (KTG). Ist die Ursache ein Unfall, gilt die Unfallversicherung (UVG).', du: 'Lass dir die Arbeitsunfähigkeit ärztlich bescheinigen und informiere den Arbeitgeber. Eine Zeit lang läuft der Lohn weiter; danach greift — wenn vorhanden — ein Krankentaggeld (KTG). Ist die Ursache ein Unfall, gilt die Unfallversicherung (UVG).' },
    ...
    step2Button: 'Erinnerung „IV-Anmeldung prüfen“ setzen ({date})',
    step2Done: 'Erinnerung im Kalender gespeichert.',
    step2CalendarLink: 'Im Kalender ansehen',
    reminderTitle: 'IV-Anmeldung / Früherfassung prüfen',
    step3Title: '3 · Existenz sichern',
    step3Text: { sie: 'Fällt Einkommen weg, gibt es Auffangnetze: Ergänzungsleistungen zur IV, Prämienverbilligung für die Krankenkasse und — wenn nötig — Sozialhilfe. Das sind Ansprüche, keine Almosen. Prüfen Sie sie ohne Scheu.', du: 'Fällt Einkommen weg, gibt es Auffangnetze: Ergänzungsleistungen zur IV, Prämienverbilligung für die Krankenkasse und — wenn nötig — Sozialhilfe. Das sind Ansprüche, keine Almosen. Prüfe sie ohne Scheu.' },
    step3Link: 'Anspruch prüfen',
    step4Title: '4 · Unterstützung & Entlastung',
    step4Text: { sie: 'Sie müssen das nicht allein tragen. Beratungsstellen (z. B. Pro Infirmis) begleiten durchs IV-Verfahren. Denken Sie auch an Vorsorgeauftrag und Patientenverfügung, solange Sie selbst entscheiden können — das nimmt Druck für später.', du: 'Du musst das nicht allein tragen. Beratungsstellen (z. B. Pro Infirmis) begleiten durchs IV-Verfahren. Denk auch an Vorsorgeauftrag und Patientenverfügung, solange du selbst entscheiden kannst — das nimmt Druck für später.' },
  ...
  bewilligung: {
    ...
    step1Text: { sie: 'Stellen Sie den Verlängerungsantrag etwa zwei bis drei Monate vor Ablauf bei der Gemeinde oder dem kantonalen Migrationsamt. Die Bewilligung verlängert sich nicht von selbst. Wer die Frist verpasst, riskiert Lücken im Aufenthaltsrecht — tragen Sie sich das Ablaufdatum darum gut sichtbar ein.', du: 'Stell den Verlängerungsantrag etwa zwei bis drei Monate vor Ablauf bei der Gemeinde oder dem kantonalen Migrationsamt. Die Bewilligung verlängert sich nicht von selbst. Wer die Frist verpasst, riskiert Lücken im Aufenthaltsrecht — trag dir das Ablaufdatum darum gut sichtbar ein.' },
    ...
    step2Text: { sie: 'Halten Sie Pass, die aktuelle Bewilligung, einen Arbeitsvertrag oder Einkommensnachweis und den Mietvertrag bereit. Je nach Kanton und Bewilligung kann ein Sprachnachweis verlangt werden (Integrationskriterien). Legen Sie die Dokumente an einem Ort ab, damit Sie sie schnell finden.', du: 'Halte Pass, die aktuelle Bewilligung, einen Arbeitsvertrag oder Einkommensnachweis und den Mietvertrag bereit. Je nach Kanton und Bewilligung kann ein Sprachnachweis verlangt werden (Integrationskriterien). Leg die Dokumente an einem Ort ab, damit du sie schnell findest.' },
  ...
  fuehrerausweis: {
    ...
    step1Text: { sie: 'Legen Sie den Führerausweis im Kreditkartenformat in Ihren Dokumenten-Tresor — dann finden Sie ihn bei Verlust oder einer Kontrolle schnell wieder.', du: 'Leg den Führerausweis im Kreditkartenformat in deinen Dokumenten-Tresor — dann findest du ihn bei Verlust oder einer Kontrolle schnell wieder.' },
    step1Link: 'Im Dokumenten-Tresor ablegen',
    step2Title: '2 · Alten Papierausweis umtauschen',
    step2Text: { sie: 'Haben Sie noch den alten blauen Führerausweis aus Papier? Er ist seit dem 1. November 2024 nicht mehr gültig. Tauschen Sie ihn beim kantonalen Strassenverkehrsamt ins Kreditkartenformat um — der Ausweis selbst hat kein Ablaufdatum.', du: 'Hast du noch den alten blauen Führerausweis aus Papier? Er ist seit dem 1. November 2024 nicht mehr gültig. Tausch ihn beim kantonalen Strassenverkehrsamt ins Kreditkartenformat um — der Ausweis selbst hat kein Ablaufdatum.' },
    step2Link: 'Zum Behörden-Dossier',
    step3Title: '3 · Ab 75: ärztliche Kontrolle',
    step3Text: 'Ab dem 75. Geburtstag gehört alle zwei Jahre eine verkehrsmedizinische Untersuchung dazu. Die Einladung kommt vom Kanton — den Termin im Blick zu behalten schadet nicht.',
    step3Button: 'Erinnerung „Kontrolluntersuchung“ anlegen',
    step3Done: 'Erinnerung im Kalender gespeichert.',
    step3CalendarLink: 'Im Kalender ansehen',
    reminderTitle: 'Verkehrsmedizinische Kontrolluntersuchung (ab 75, alle 2 Jahre)',
    step4Title: '4 · Neu am Steuer: Ausweis auf Probe',
    ...
    step5Title: '5 · Verlust oder Diebstahl',
    step5Text: { sie: 'Ist der Ausweis weg, beantragen Sie beim kantonalen Strassenverkehrsamt einen Ersatz. Eine Kopie oder ein Foto im Tresor hilft, die Angaben schnell zur Hand zu haben.', du: 'Ist der Ausweis weg, beantrag beim kantonalen Strassenverkehrsamt einen Ersatz. Eine Kopie oder ein Foto im Tresor hilft, die Angaben schnell zur Hand zu haben.' },
    step5Link: 'Zum Behörden-Dossier',
    relatedTitle: 'Verwandte Ereignisse',
  ...
  heirat: {
    ...
    step1Text: { sie: 'Vor der Trauung läuft beim Zivilstandsamt ein Vorbereitungsverfahren. Melden Sie sich früh an und halten Sie Ausweise, Wohnsitzbestätigung und je nach Herkunft weitere Dokumente bereit. Bei ausländischer Staatsangehörigkeit kann es länger dauern — und für eine ausländische Partnerin oder einen ausländischen Partner kann die Heirat der Grund für Familiennachzug und eine Aufenthaltsbewilligung sein.', du: 'Vor der Trauung läuft beim Zivilstandsamt ein Vorbereitungsverfahren. Meldet euch früh an und haltet Ausweise, Wohnsitzbestätigung und je nach Herkunft weitere Dokumente bereit. Bei ausländischer Staatsangehörigkeit kann es länger dauern — und für eine ausländische Partnerin oder einen ausländischen Partner kann die Heirat der Grund für Familiennachzug und eine Aufenthaltsbewilligung sein.' },
    step1Button: 'Erinnerung „Trauung anmelden“ setzen ({date})',
    step1Done: 'Erinnerung im Kalender gespeichert.',
    step1CalendarLink: 'Im Kalender ansehen',
    step1LinkBewilligung: 'Aufenthaltsbewilligung & Fristen ansehen',
    reminderTitle: 'Trauung beim Zivilstandsamt anmelden',
    step2Title: '2 · Name & Zivilstand',
    step2Text: { sie: 'Sie können Ihren bisherigen Namen behalten oder einen gemeinsamen Familiennamen wählen. Nach der Heirat ändert sich der Zivilstand — denken Sie an die Anpassung von Ausweisen, AHV-Daten und Arbeitgeber-Angaben.', du: 'Ihr könnt euren bisherigen Namen behalten oder einen gemeinsamen Familiennamen wählen. Nach der Heirat ändert sich der Zivilstand — denk an die Anpassung von Ausweisen, AHV-Daten und Arbeitgeber-Angaben.' },
    step3Title: '3 · Steuern',
    step3Text: { sie: 'Verheiratete und eingetragene Partner werden gemeinsam veranlagt — ab dem Jahr der Heirat fürs ganze Jahr. Das kann die Steuerlast erhöhen oder senken. Wer an der Quelle besteuert wird, sollte den Tarif anpassen lassen. Auch Ihre Prämienverbilligung (IPV) wird jetzt aufs gemeinsame Einkommen berechnet — ein Neuberechnen lohnt sich.', du: 'Verheiratete und eingetragene Partner werden gemeinsam veranlagt — ab dem Jahr der Heirat fürs ganze Jahr. Das kann die Steuerlast erhöhen oder senken. Wer an der Quelle besteuert wird, sollte den Tarif anpassen lassen. Auch deine Prämienverbilligung (IPV) wird jetzt aufs gemeinsame Einkommen berechnet — ein Neuberechnen lohnt sich.' },
    step3Link: 'Steuern ansehen',
    step3LinkPremium: 'Prämienverbilligung neu berechnen',
    step4Title: '4 · Versicherungen & Vorsorge',
    step4Text: { sie: 'Die Krankenkasse bleibt individuell. Prüfen Sie Hausrat und Haftpflicht — oft genügt eine gemeinsame Police. Passen Sie die Begünstigung in Säule 3a und Pensionskasse an, damit im Ernstfall die richtige Person abgesichert ist.', du: 'Die Krankenkasse bleibt individuell. Prüft Hausrat und Haftpflicht — oft genügt eine gemeinsame Police. Passt die Begünstigung in Säule 3a und Pensionskasse an, damit im Ernstfall die richtige Person abgesichert ist.' },
  ...
  kind: {
    ...
    step2Text: { sie: 'Versichern Sie das Kind innert drei Monaten nach der Geburt bei einer Krankenkasse — die Deckung gilt dann rückwirkend ab Geburt. Sie können frei wählen; oft lohnt ein Vergleich, gerade bei Zusatzversicherungen für Kinder.', du: 'Versichere das Kind innert drei Monaten nach der Geburt bei einer Krankenkasse — die Deckung gilt dann rückwirkend ab Geburt. Du kannst frei wählen; oft lohnt ein Vergleich, gerade bei Zusatzversicherungen für Kinder.' },
    ...
    step3Text: { sie: 'Für jedes Kind gibt es eine Kinderzulage, später eine Ausbildungszulage. Beantragt wird sie über den Arbeitgeber bzw. die Ausgleichskasse — sie kommt nicht automatisch. Auch Nichterwerbstätige können Anspruch haben. Einige Kantone zahlen zudem eine einmalige Geburtszulage — fragen Sie bei Ihrer Ausgleichskasse nach.', du: 'Für jedes Kind gibt es eine Kinderzulage, später eine Ausbildungszulage. Beantragt wird sie über den Arbeitgeber bzw. die Ausgleichskasse — sie kommt nicht automatisch. Auch Nichterwerbstätige können Anspruch haben. Einige Kantone zahlen zudem eine einmalige Geburtszulage — frag bei deiner Ausgleichskasse nach.' },
    ...
    step5Title: '5 · Ansprüche neu prüfen',
    step5Text: { sie: 'Ein grösserer Haushalt ändert, was Ihnen zusteht. Ihre Prämienverbilligung (IPV) wird auf den neuen Haushalt neu berechnet — ein zweiter Blick lohnt sich. Wenn Sie das Kind allein grossziehen oder mit knappem Budget, sammeln die Lebenszustände weitere Unterstützung an einem ruhigen Ort.', du: 'Ein grösserer Haushalt ändert, was dir zusteht. Deine Prämienverbilligung (IPV) wird auf den neuen Haushalt neu berechnet — ein zweiter Blick lohnt sich. Wenn du das Kind allein grossziehst oder mit knappem Budget, sammeln die Lebenszustände weitere Unterstützung an einem ruhigen Ort.' },
    step5LinkIpv: 'Prämienverbilligung neu berechnen',
    step5LinkSituation: 'Passende Lebenssituationen ansehen',
    relatedTitle: 'Verwandte Ereignisse',
  ...
  trennung: {
    ...
    step2Text: { sie: 'Klären Sie, wer in der Wohnung bleibt. Stehen beide im Mietvertrag, haften meist beide weiter — eine Anpassung beim Vermieter schafft Klarheit. Wer auszieht, meldet die neue Adresse überall nach.', du: 'Klärt, wer in der Wohnung bleibt. Stehen beide im Mietvertrag, haften meist beide weiter — eine Anpassung beim Vermieter schafft Klarheit. Wer auszieht, meldet die neue Adresse überall nach.' },
    step2Link: 'Umzug-Ablauf ansehen',
    step3Title: '3 · Kinder & Unterhalt',
    step3Text: { sie: 'Bei Kindern gehen Sorge und Betreuung weiter — das Wohl der Kinder steht im Zentrum. Kindes- und allenfalls Ehegattenunterhalt werden geregelt; bei Uneinigkeit hilft die KESB oder das Gericht. Zahlt der andere Elternteil den vereinbarten Unterhalt nicht, kann ihn Ihre Gemeinde bevorschussen (Alimentenbevorschussung) und beim Einfordern helfen (Inkassohilfe) — Sie müssen dem Geld nicht allein nachrennen. Nehmen Sie sich Zeit, es muss nicht alles sofort entschieden sein.', du: 'Bei Kindern gehen Sorge und Betreuung weiter — das Wohl der Kinder steht im Zentrum. Kindes- und allenfalls Ehegattenunterhalt werden geregelt; bei Uneinigkeit hilft die KESB oder das Gericht. Zahlt der andere Elternteil den vereinbarten Unterhalt nicht, kann ihn deine Gemeinde bevorschussen (Alimentenbevorschussung) und beim Einfordern helfen (Inkassohilfe) — du musst dem Geld nicht allein nachrennen. Nehmt euch Zeit, es muss nicht alles sofort entschieden sein.' },
    step4Title: '4 · Finanzen & Steuern',
    step4Text: { sie: 'Leben Sie am Ende des Steuerjahres dauerhaft getrennt (gerichtlich oder tatsächlich), werden Sie für das ganze Jahr getrennt besteuert, mit je einer eigenen Steuererklärung — der Verheirateten-Tarif fällt weg, Sie werden zum Alleinstehenden- oder, mit Kindern, zum Elterntarif veranlagt, der geschuldete Betrag ändert sich also. Trennen Sie gemeinsame Konten und Vollmachten und verschaffen Sie sich einen Überblick. Bei einer Scheidung wird das AHV-Einkommen der Ehejahre hälftig auf beide aufgeteilt (AHV-Splitting), Erziehungsgutschriften werden geteilt, und die Pensionskasse für diese Jahre wird ebenfalls geteilt (Vorsorgeausgleich).', du: 'Lebt ihr am Ende des Steuerjahres dauerhaft getrennt (gerichtlich oder tatsächlich), werdet ihr für das ganze Jahr getrennt besteuert, mit je einer eigenen Steuererklärung — der Verheirateten-Tarif fällt weg, du wirst zum Alleinstehenden- oder, mit Kindern, zum Elterntarif veranlagt, der geschuldete Betrag ändert sich also. Trennt gemeinsame Konten und Vollmachten und verschafft euch einen Überblick. Bei einer Scheidung wird das AHV-Einkommen der Ehejahre hälftig auf beide aufgeteilt (AHV-Splitting), Erziehungsgutschriften werden geteilt, und die Pensionskasse für diese Jahre wird ebenfalls geteilt (Vorsorgeausgleich).' },
  ...
  selbstaendigkeit: {
    ...
    step1Text: { sie: 'Selbständigkeit beginnt offiziell, wenn Sie Ihre AHV-Ausgleichskasse als selbständigerwerbend anerkennt. Melden Sie sich früh an und halten Sie Rechnungen, Aufträge und Ihr Geschäftskonzept bereit — die Kasse prüft, ob Sie wirklich auf eigenes Risiko arbeiten.', du: 'Selbständigkeit beginnt offiziell, wenn dich deine AHV-Ausgleichskasse als selbständigerwerbend anerkennt. Melde dich früh an und halte Rechnungen, Aufträge und dein Geschäftskonzept bereit — die Kasse prüft, ob du wirklich auf eigenes Risiko arbeitest.' },
    step1Button: 'Erinnerung „AHV-Anmeldung“ setzen ({date})',
    step1Done: 'Erinnerung im Kalender gespeichert.',
    step1CalendarLink: 'Im Kalender ansehen',
    ...
    step2Text: { sie: 'Bleibt die Selbständigkeit ein Zusatz neben einer Anstellung (Nebenerwerb) oder wird sie Ihr Haupteinkommen? Das beeinflusst Ihre AHV-Beiträge, Ihre Vorsorge und ob Sie sich gegen Erwerbsausfall absichern müssen. Beim Haupterwerb fällt das Sicherheitsnetz des Arbeitgebers ganz weg — und gegen Arbeitslosigkeit (ALV) sind Sie nicht versichert. Bleibt das Einkommen knapp oder unregelmässig, stehen Sie nicht ohne Unterstützung da: der Lebenszustand „Tiefes Einkommen" sammelt, was Ihnen trotzdem zusteht (Prämienverbilligung, Mietzinsbeitrag, ergänzende Sozialhilfe).', du: 'Bleibt die Selbständigkeit ein Zusatz neben einer Anstellung (Nebenerwerb) oder wird sie dein Haupteinkommen? Das beeinflusst deine AHV-Beiträge, deine Vorsorge und ob du dich gegen Erwerbsausfall absichern musst. Beim Haupterwerb fällt das Sicherheitsnetz des Arbeitgebers ganz weg — und gegen Arbeitslosigkeit (ALV) bist du nicht versichert. Bleibt das Einkommen knapp oder unregelmässig, stehst du nicht ohne Unterstützung da: der Lebenszustand „Tiefes Einkommen" sammelt, was dir trotzdem zusteht (Prämienverbilligung, Mietzinsbeitrag, ergänzende Sozialhilfe).' },
    step2LinkSituation: 'Situation „Tiefes Einkommen" ansehen',
    step3Title: '3 · Versicherungslücken schliessen',
    step3Text: { sie: 'Als Selbständige:r sind Sie nicht mehr automatisch gegen Unfall (UVG) versichert und zahlen nicht mehr in eine Pensionskasse (BVG) ein. Schliessen Sie den Unfall in Ihrer Krankenkasse ein oder versichern Sie sich freiwillig, denken Sie an ein Krankentaggeld (KTG) und bauen Sie Ihre Vorsorge über Säule 3a oder freiwilliges BVG auf.', du: 'Als Selbständige:r bist du nicht mehr automatisch gegen Unfall (UVG) versichert und zahlst nicht mehr in eine Pensionskasse (BVG) ein. Schliesse den Unfall in deiner Krankenkasse ein oder versichere dich freiwillig, denk an ein Krankentaggeld (KTG) und baue deine Vorsorge über Säule 3a oder freiwilliges BVG auf.' },
    step3LinkUk: 'Unfall oder Krankheit — was zählt',
    step3LinkVorsorge: 'Vorsorge ansehen',
    step4Title: '4 · Steuern & MwSt zurücklegen',
    step4Text: { sie: 'Ihr Einkommen wird nicht mehr an der Quelle besteuert — legen Sie darum von Anfang an Geld für die Steuerrechnung zurück (Akontozahlungen). Ab 100 000 Franken Jahresumsatz werden Sie mehrwertsteuerpflichtig. Eine saubere Buchhaltung von Tag eins erspart später viel.', du: 'Dein Einkommen wird nicht mehr an der Quelle besteuert — leg darum von Anfang an Geld für die Steuerrechnung zurück (Akontozahlungen). Ab 100 000 Franken Jahresumsatz wirst du mehrwertsteuerpflichtig. Eine saubere Buchhaltung von Tag eins erspart später viel.' },
  ...
  wohnungGekuendigt: {
    ...
    footerNote: { sie: 'Sie müssen das nicht allein durchstehen — die Schlichtungsbehörde berät in Mietsachen, und der Mieterverband begleitet Mitglieder. Dies ist Orientierung, keine Rechtsberatung; kantonale Formulare und Abläufe unterscheiden sich.', du: 'Du musst das nicht allein durchstehen — die Schlichtungsbehörde berät in Mietsachen, und der Mieterverband begleitet Mitglieder. Dies ist Orientierung, keine Rechtsberatung; kantonale Formulare und Abläufe unterscheiden sich.' },
  ...
  quellensteuer: {
    ...
    footerNote: 'Quellensteuer-Tarife und Formulare legt jeder Kanton fest; die Beträge unterscheiden sich darum von Kanton zu Kanton. Maloja rechnet hier nichts aus — verbindlich ist die Auskunft der kantonalen Steuerverwaltung. Dies ist Orientierung, keine Steuerberatung.',
  ...
  aussteuerung: {
    ...
    footerNote: 'Sozialhilfe, Prämienverbilligung und Programme für Ausgesteuerte regelt jeder Kanton selbst — Beträge und Abläufe unterscheiden sich. Dieser Ablauf nennt darum bewusst keine Beträge. Dies ist Orientierung, keine Rechtsberatung; verbindlich ist die Auskunft der zuständigen Stelle.',
  ...
  zuzug: {
    ...
    footerNote: { sie: 'Vieles hängt von Ihrer Staatsangehörigkeit (EU/EFTA oder nicht) und vom Kanton ab. Verbindlich sind die Gemeinde und das kantonale Migrationsamt. Dies ist Orientierung, keine Rechtsberatung.', du: 'Vieles hängt von deiner Staatsangehörigkeit (EU/EFTA oder nicht) und vom Kanton ab. Verbindlich sind die Gemeinde und das kantonale Migrationsamt. Dies ist Orientierung, keine Rechtsberatung.' },
  ...
  einbuergerung: {
    ...
    footerNote: 'Voraussetzungen, Ablauf und Gebühren sind je nach Kanton und Gemeinde verschieden. Verbindlich sind die kantonale Einbürgerungsbehörde und das SEM. Dies ist Orientierung, keine Rechtsberatung.',
  ...
  vorsorgeauftrag: {
    ...
    footerNote: 'Diese Dokumente sind persönlich; Vorlagen und Beratung bieten Fachstellen, Ärztinnen und Ärzte sowie Notariate. Dies ist Orientierung, keine Rechtsberatung; die Abläufe bei KESB und Zivilstandsamt unterscheiden sich je nach Kanton.',
  ...
  ergaenzungsleistungen: {
    ...
    footerNote: { sie: 'Die EL-Stelle Ihres Kantons informiert und rechnet Ihren Anspruch aus (ELG Art. 21). Dies ist Orientierung, keine Rechtsberatung; Beträge, vergütete Kosten und Anmeldestellen unterscheiden sich je nach Kanton.', du: 'Die EL-Stelle deines Kantons informiert und rechnet deinen Anspruch aus (ELG Art. 21). Dies ist Orientierung, keine Rechtsberatung; Beträge, vergütete Kosten und Anmeldestellen unterscheiden sich je nach Kanton.' },
  ...
  zusammenziehen: {
    ...
    footerNote: 'Vieles davon lässt sich mit wenigen Dokumenten ordnen. Für Testament, Erbvertrag oder Konkubinatsvertrag beraten Notariate und Fachstellen. Dies ist Orientierung, keine Rechtsberatung; Steuern, Erbschaftssteuern und Prämienverbilligung unterscheiden sich je nach Kanton.',
  ...
  ausweis: {
    ...
    footerNote: 'Abläufe, Termine und Fotoregeln unterscheiden sich je nach Kanton; verbindlich ist die kantonale Passstelle bzw. die Schweizer Vertretung. Dies ist Orientierung, keine Rechtsberatung.',
  ...
  betreibungsAuszug: {
    ...
    footerNote: 'Ein Eintrag im Betreibungsregister ist kein Urteil und kein Strafregistereintrag. Dies ist Orientierung, keine Rechtsberatung; verbindlich ist das zuständige Betreibungsamt. Bei Schulden hilft eine Schuldenberatung.',
  ...
  lehre: {
    ...
    footerNote: { sie: 'Lehrverträge, Formulare und Zuständigkeiten sind kantonal; bei Fragen hilft das Amt für Berufsbildung Ihres Kantons. Dies ist Orientierung, keine Rechtsberatung.', du: 'Lehrverträge, Formulare und Zuständigkeiten sind kantonal; bei Fragen hilft das Amt für Berufsbildung deines Kantons. Dies ist Orientierung, keine Rechtsberatung.' },
  ...
  volljaehrig: {
    ...
    footerNote: 'Mit 18 ändert sich vieles auf dem Papier, wenig über Nacht. Kantone regeln Steuern, Stipendien und Prämienverbilligung je eigen. Dies ist Orientierung, keine Rechtsberatung.',
  ...
  dienst: {
    ...
    footerNote: 'Aufgebote, Formulare und Zuständigkeiten liegen beim Kanton (Kreiskommando) und bei der Vollzugsstelle für den Zivildienst. Sätze und Beträge gelten mit Stand September 2026 und ändern sich — der Erwerbsersatz ab Juli 2027. Dies ist Orientierung, keine Rechtsberatung.',
  ...
  betreibung: {
    ...
    footerNote: { sie: 'Eine Betreibung ist kein Strafregister-Eintrag. Dritte sehen sie im Auszug bis fünf Jahre nach Abschluss des Verfahrens (SchKG Art. 8a Abs. 4). Haben Sie Rechtsvorschlag erhoben, können Sie frühestens drei Monate nach Zustellung des Zahlungsbefehls verlangen, dass sie Dritten nicht mehr gezeigt wird — ausser der Gläubiger weist innert 20 Tagen nach, dass er ein Verfahren eingeleitet hat (Art. 8a Abs. 3). Dies ist Orientierung, keine Rechtsberatung.', du: 'Eine Betreibung ist kein Strafregister-Eintrag. Dritte sehen sie im Auszug bis fünf Jahre nach Abschluss des Verfahrens (SchKG Art. 8a Abs. 4). Hast du Rechtsvorschlag erhoben, kannst du frühestens drei Monate nach Zustellung des Zahlungsbefehls verlangen, dass sie Dritten nicht mehr gezeigt wird — ausser der Gläubiger weist innert 20 Tagen nach, dass er ein Verfahren eingeleitet hat (Art. 8a Abs. 3). Dies ist Orientierung, keine Rechtsberatung.' },
  },
  pensionierung: {
    ...
    step2Text: { sie: 'Beim Pensionskassen-Guthaben entscheiden Sie zwischen lebenslanger Rente, Kapitalbezug oder einer Mischung. Der Entscheid ist endgültig und steuerlich bedeutsam — und oft Monate im Voraus anzumelden. Lassen Sie sich frühzeitig beraten.', du: 'Beim Pensionskassen-Guthaben entscheidest du zwischen lebenslanger Rente, Kapitalbezug oder einer Mischung. Der Entscheid ist endgültig und steuerlich bedeutsam — und oft Monate im Voraus anzumelden. Lass dich frühzeitig beraten.' },
    ...
    step4Text: { sie: 'Reichen AHV und Pensionskasse nicht für den Lebensbedarf, haben Sie allenfalls Anspruch auf Ergänzungsleistungen (EL). Das ist kein Almosen, sondern ein gesetzlicher Anspruch — prüfen Sie ihn ohne Scheu. Im AHV-Alter kommt oft mehr dazu: Prämienverbilligung (IPV), SERAFE-Befreiung bei EL-Bezug, Hilflosenentschädigung — der Lebenszustand „Pensioniert" sammelt sie an einem ruhigen Ort.', du: 'Reichen AHV und Pensionskasse nicht für den Lebensbedarf, hast du allenfalls Anspruch auf Ergänzungsleistungen (EL). Das ist kein Almosen, sondern ein gesetzlicher Anspruch — prüfe ihn ohne Scheu. Im AHV-Alter kommt oft mehr dazu: Prämienverbilligung (IPV), SERAFE-Befreiung bei EL-Bezug, Hilflosenentschädigung — der Lebenszustand „Pensioniert" sammelt sie an einem ruhigen Ort.' },
    ...
    step5Text: { sie: 'Manche Kosten kommen erst im Alter: Pflege zu Hause (Spitex) oder im Heim. Die Krankenkasse übernimmt die eigentliche Pflege — Betreuung und Wohnen (im Heim Unterkunft und Essen) tragen Sie selbst. Reichen Rente und Vermögen nicht, springen die Ergänzungsleistungen ein. Brauchen Sie im Alltag regelmässig Hilfe, gibt es die Hilflosenentschädigung der AHV, unabhängig vom Einkommen. Bei Hilfsmitteln wie Hörgeräten beteiligt sich die AHV. Pro Senectute berät Sie kostenlos.', du: 'Manche Kosten kommen erst im Alter: Pflege zu Hause (Spitex) oder im Heim. Die Krankenkasse übernimmt die eigentliche Pflege — Betreuung und Wohnen (im Heim Unterkunft und Essen) trägst du selbst. Reichen Rente und Vermögen nicht, springen die Ergänzungsleistungen ein. Brauchst du im Alltag regelmässig Hilfe, gibt es die Hilflosenentschädigung der AHV, unabhängig vom Einkommen. Bei Hilfsmitteln wie Hörgeräten beteiligt sich die AHV. Pro Senectute berät dich kostenlos.' },
    step5Link: 'Ergänzungsleistungen & Beratung ansehen',
    step5LinkSituation: { sie: 'Pensioniert / im AHV-Alter: was Ihnen zusteht', du: 'Pensioniert / im AHV-Alter: was dir zusteht' },
  ...
  kkErst: {
    ...
    step1Text: { sie: 'Wer in die Schweiz zieht, muss sich innert drei Monaten krankenversichern. Schliessen Sie rechtzeitig ab, gilt die Deckung rückwirkend ab dem ersten Tag — es entsteht keine Lücke. Verpassen Sie die Frist, wird Ihnen eine Kasse zugewiesen und es können Zuschläge anfallen.', du: 'Wer in die Schweiz zieht, muss sich innert drei Monaten krankenversichern. Schliesst du rechtzeitig ab, gilt die Deckung rückwirkend ab dem ersten Tag — es entsteht keine Lücke. Verpasst du die Frist, wird dir eine Kasse zugewiesen und es können Zuschläge anfallen.' },
    ...
    step2Text: { sie: 'Die Grundversicherung ist gesetzlich überall gleich — die Leistungen sind identisch, nur Prämie und Service unterscheiden sich. Sie haben freie Wahl, und keine Kasse darf Sie für die Grundversicherung ablehnen (Aufnahmepflicht).', du: 'Die Grundversicherung ist gesetzlich überall gleich — die Leistungen sind identisch, nur Prämie und Service unterscheiden sich. Du hast freie Wahl, und keine Kasse darf dich für die Grundversicherung ablehnen (Aufnahmepflicht).' },
    step2Link: 'Prämien vergleichen',
    step3Title: '3 · Franchise & Unfalldeckung',
    step3Text: { sie: 'Wählen Sie Ihre Franchise (höher = tiefere Prämie, aber mehr Selbstbehalt im Krankheitsfall). Sind Sie weniger als 8 Stunden pro Woche beim selben Arbeitgeber angestellt oder nicht erwerbstätig, müssen Sie den Unfall in der Krankenkasse einschliessen.', du: 'Wähle deine Franchise (höher = tiefere Prämie, aber mehr Selbstbehalt im Krankheitsfall). Bist du weniger als 8 Stunden pro Woche beim selben Arbeitgeber angestellt oder nicht erwerbstätig, musst du den Unfall in der Krankenkasse einschliessen.' },
    step3LinkFranchise: 'Franchise vergleichen',
    step3LinkUk: 'Unfall oder Krankheit — was zählt',
    step4Title: '4 · Prämienverbilligung prüfen',
    step4Text: { sie: 'Bei tieferem Einkommen übernimmt der Kanton einen Teil der Prämie (individuelle Prämienverbilligung, IPV). Prüfen Sie früh, ob Ihnen das zusteht — das kann die Kosten deutlich senken.', du: 'Bei tieferem Einkommen übernimmt der Kanton einen Teil der Prämie (individuelle Prämienverbilligung, IPV). Prüfe früh, ob dir das zusteht — das kann die Kosten deutlich senken.' },
    step4Link: 'Anspruch auf Verbilligung prüfen',
    asylTitle: 'Im Asylverfahren',
    asylText: { sie: 'Befinden Sie sich im Asylverfahren oder sind Sie vorläufig aufgenommen, wird die Krankenkasse meist von der Behörde oder dem Kanton bestimmt — Sie müssen sich nicht selbst darum kümmern. Die Grundversicherung ist trotzdem gewährleistet.', du: 'Befindest du dich im Asylverfahren oder bist du vorläufig aufgenommen, wird die Krankenkasse meist von der Behörde oder dem Kanton bestimmt — du musst dich nicht selbst darum kümmern. Die Grundversicherung ist trotzdem gewährleistet.' },
    asylLink: 'Orientierung im Asylverfahren',
    footerAufnahme: { sie: 'Für die Grundversicherung gilt die Aufnahmepflicht: jede Kasse muss Sie aufnehmen, unabhängig von Alter oder Gesundheit. Zusatzversicherungen sind freiwillig und können abgelehnt werden.', du: 'Für die Grundversicherung gilt die Aufnahmepflicht: jede Kasse muss dich aufnehmen, unabhängig von Alter oder Gesundheit. Zusatzversicherungen sind freiwillig und können abgelehnt werden.' },
  },
  tresorLock: {
  ...
  common: {
    ...
    settingsDisplay: 'Anzeige & Sprache',
  ...
  nav: {
    ...
    sub: {
      ...
      fuehrerausweis: 'Umtausch, Kontrolle ab 75, Probezeit',
      iv: 'Lohn, IV, Existenz, Entlastung',
      pflege: 'Gutschrift, Entschädigung, Entlastung',
      ...
      eo: 'Mutterschaft, Vaterschaft, Adoption, Betreuung',
    ...
    crosslink: {
      ...
      ipvFromIncome: 'IPV-Anspruch prüfen',
      sozialhilfeHint: { sie: 'Orientierung: Was steht Ihnen gemäss SKOS zu?', du: 'Orientierung: Was steht Dir gemäss SKOS zu?' },
      budgetHint: 'Budget im Überblick',
      vorsorgeHint: 'Rente berechnen',
      praemienHint: 'Prämie vergleichen',
      // Die Nachricht («Ihr Kanton hat einen Mindestlohn») stand bis 21.09.2026 in der
    // Knopfbeschriftung. Sie ist aber keine Wiederholung des Feldes darüber, sondern
    // etwas, das man womöglich nicht weiss — darum ein Hinweis, kein Knopftext.
    mindestlohnNews: { sie: 'Ihr Kanton hat einen gesetzlichen Mindestlohn.', du: 'Dein Kanton hat einen gesetzlichen Mindestlohn.' },
    mindestlohnHint: 'Lohn prüfen',
      cantonTaxHint: 'Steuern schätzen',
      cantonSozialhilfeHint: 'Sozialhilfe-Orientierung',
      kkModelHint: 'Alternativen vergleichen',
      notfallkarteHint: 'Notfallkarte erstellen',
      ...
      taxFromBehoerdenHint: 'Steuerbelastung abschätzen',
  ...
  anspruch: {
    ...
    intro: { sie: 'Vieles steht einem zu, ohne dass man davon weiss. Hier alle möglichen Ansprüche auf einen Blick — unverbindlich, ohne Bewertung. Tippen Sie einen an, um mehr zu erfahren.', du: 'Vieles steht einem zu, ohne dass man davon weiss. Hier alle möglichen Ansprüche auf einen Blick — unverbindlich, ohne Bewertung. Tippe einen an, um mehr zu erfahren.' },
    gruppen: {
      einkommen: { label: 'Nach Einkommen', desc: 'Hängt davon ab, wie viel monatlich hereinkommt.' },
      lebenslage: { label: 'Nach Lebenslage', desc: { sie: 'Hängt an Ihrer persönlichen Situation.', du: 'Hängt an deiner persönlichen Situation.' } },
    ...
    items: {
      ...
      beistandschaft: { label: 'Vorsorgeauftrag & Beistandschaft', sub: { sie: 'Wer entscheidet, wenn Sie es nicht mehr können', du: 'Wer entscheidet, wenn du es nicht mehr kannst' } },
      alv: { label: 'Arbeitslosenentschädigung (ALV)', sub: 'Nach dem Verlust der Anstellung' },
      eo: { label: 'Erwerbsersatz (EO)', sub: 'Mutterschaft, Vaterschaft, Adoption oder Betreuung' },
    ...
    footNote: { sie: 'Diese Übersicht bewertet nichts und verspricht nichts — sie zeigt nur, was Sie betreffen könnte. Ob wirklich ein Anspruch besteht, klärt die jeweilige Stelle.', du: 'Diese Übersicht bewertet nichts und verspricht nichts — sie zeigt nur, was dich betreffen könnte. Ob wirklich ein Anspruch besteht, klärt die jeweilige Stelle.' },
  },
  ...
  anspruchCheck: {
    ...
    stepOverview: { sie: 'Ihr Überblick', du: 'Dein Überblick' },
    weiter: 'Weiter zu den Lebenslagen',
    weiterOverview: 'Weiter zum Überblick',
    zurueck: 'Zurück',
    fertig: 'Fertig — zur Übersicht',
    resultIntro: { sie: 'Zusammengefasst aus Ihren Angaben — was Sie betreffen könnte.', du: 'Zusammengefasst aus deinen Angaben — was dich betreffen könnte.' },
    resultIncomeHeader: { sie: 'Nach Einkommen (aus Ihrem Profil)', du: 'Nach Einkommen (aus deinem Profil)' },
    resultSituationHeader: { sie: 'Nach Ihren Lebenslagen', du: 'Nach deinen Lebenslagen' },
    resultEmptyIncome: { sie: 'Tragen Sie in Schritt 1 Ihr Einkommen ein (den Kanton hinterlegen Sie im Profil) — dann erscheint hier, was zusteht.', du: 'Trag in Schritt 1 dein Einkommen ein (den Kanton hinterlegst du im Profil) — dann erscheint hier, was zusteht.' },
    resultEmptySituation: { sie: 'Wählen Sie in Schritt 2 Ihre Lebenslagen — dann erscheinen sie hier.', du: 'Wähle in Schritt 2 deine Lebenslagen — dann erscheinen sie hier.' },
  ...
  glossar: {
    // K-Glossar 20.09.2026 · vier Begriffe aus den Hinweis-Sätzen, damit die Erklärung
    // am Wort hängt statt in einem Kasten darüber.
    nettolohn: 'Nettolohn — der Lohn nach Abzug der Sozialversicherungsbeiträge (AHV/IV/EO, ALV, Pensionskasse, Unfallversicherung), aber vor den Steuern. Die Steuern werden in der Schweiz meist separat nach der Veranlagung bezahlt — ausser bei Quellensteuer.',
    taxpunktwert: 'Taxpunktwert — der Frankenbetrag je Taxpunkt einer ärztlichen Leistung. Er wird je Kanton vereinbart und genehmigt; dieselbe Behandlung kostet deshalb je nach Kanton unterschiedlich viel. Grundlage: KVG Art. 43 ff.',
    bundessteuer: 'Bundessteuer — die direkte Bundessteuer auf dem Einkommen. Ein Tarif für die ganze Schweiz, unabhängig vom Wohnkanton; Kantons- und Gemeindesteuer kommen separat dazu. Grundlage: DBG Art. 36.',
    veranlagung: 'Veranlagung — der Entscheid der Steuerbehörde für ein Steuerjahr. Darin stehen das steuerbare Einkommen und Vermögen und der geschuldete Betrag.',
  ...
  arztkoffer: {
    ...
    faecher: {
      kvg: { title: 'Leistungen & Franchise', desc: { sie: 'Was die Grundversicherung zahlt und wie Ihre Franchise wirkt.', du: 'Was die Grundversicherung zahlt und wie deine Franchise wirkt.' } },
  ...
  notfallEinstieg: {
    ...
    vorlesekarteTitle: { sie: 'Im Ernstfall: was Sie am Telefon sagen', du: 'Im Ernstfall: was du am Telefon sagst' },
    vorlesekarteSub: { sie: 'Die Vorlesekarte führt Sie durch den Anruf und zeigt Ihre wichtigsten Angaben', du: 'Die Vorlesekarte führt dich durch den Anruf und zeigt deine wichtigsten Angaben' },
    unfall: {
      title: 'Unfall',
  ...
  dashboard: {
    ...
    quickCheckAllLeistungen: 'Alle Leistungen prüfen',
  ...
  chapters: {
    basis: {
      ...
      fields: {
        ...
        email: 'E-Mail',
        ahv: 'AHV-Nummer',
        maritalStatus: { label: 'Zivilstand', options: { single: 'Ledig', married: 'Verheiratet', registeredPartnership: 'Eingetragene Partnerschaft', cohabiting: 'Konkubinat', divorced: 'Geschieden', widowed: 'Verwitwet', dissolvedPartnership: 'Aufgelöste Partnerschaft' } },
    ...
    finanzen: {
      ...
      fields: {
        ...
        pension3aBalance: '3. Säule A — Guthaben (Kontostand) CHF',
        pension3bBalance: '3. Säule B — Guthaben (Kontostand) CHF',
      ...
      hints: {
        ...
        sideEmployer: 'Nur nötig, wenn aus dem Nebenerwerb ein Brief werden soll.',
        sideEmployerAddress: 'Für den Briefkopf — Strasse, PLZ und Ort, wie auf dem Lohnausweis.',
        sideHoursPerWeek: 'Nötig für den Mindestlohn-Check des Nebenjobs: ohne Stunden lässt sich kein Stundenlohn berechnen.',
        employerAddress: 'Für Briefe an den Arbeitgeber — Strasse, PLZ und Ort.',
        ...
        pension3aBalance: { sie: 'Der gesamte bisher angesparte Betrag auf Ihrem 3a-Konto — nicht die Jahreseinzahlung.', du: 'Der gesamte bisher angesparte Betrag auf deinem 3a-Konto — nicht die Jahreseinzahlung.' },
        pension3bBalance: { sie: 'Der aktuelle Wert Ihrer freien Vorsorge 3b (Sparkonto, Lebensversicherung, Wertschriften).', du: 'Der aktuelle Wert deiner freien Vorsorge 3b (Sparkonto, Lebensversicherung, Wertschriften).' },
      },
      docs: {
  ...
  legal: {
    ...
    support: {
      ...
      howTitle: { sie: 'So können Sie beitragen', du: 'So kannst du beitragen' },
    ...
    privacy: {
      ...
      local3: 'Nach dem ersten Laden funktioniert die Anwendung auch offline — in der Regel in den Bereichen, die schon einmal geöffnet wurden.',
      ...
      sensitive2: { sie: 'Diese Angaben bleiben auf Ihrem Gerät. Sie werden nicht an uns und nicht an einen Server übertragen. Die automatischen Schnappschüsse im Browser sind nicht verschlüsselt. Tragen Sie solche Felder nur ein, wenn Ihnen das recht ist — und schützen Sie das Gerät mit einem Code.', du: 'Diese Angaben bleiben auf Deinem Gerät. Sie werden nicht an uns und nicht an einen Server übertragen. Die automatischen Schnappschüsse im Browser sind nicht verschlüsselt. Trag solche Felder nur ein, wenn Dir das recht ist — und schütz das Gerät mit einem Code.' },
      hostingTitle: 'Hosting',
      hosting1: 'Die statische Webanwendung (ohne Nutzerdaten) wird bei Infomaniak Network SA (Rue Eugène-Marziano 25, 1227 Les Acacias / Genf, Schweiz) gehostet — einem Schweizer Anbieter mit Rechenzentren in der Schweiz. Beim Abruf der Webseite verarbeitet Infomaniak als Auftragsbearbeiterin (Art. 9 nDSG) technische Daten: IP-Adresse, Zeitpunkt, aufgerufene Datei, Browsertyp und Betriebssystem. Zweck: Auslieferung der Seite und Betriebssicherheit. Die Zugriffs- und Fehlerlogs bewahrt Infomaniak nach eigener Angabe mindestens 7 Tage auf.',
      hostingSource: 'Quelle der Aufbewahrungsfrist: Infomaniak Support-FAQ 1926 (Angabe des Anbieters, abgerufen am 23.09.2026).',
      ...
      contact1: { sie: 'Wenn Sie uns an info@malojaplana.ch schreiben, bearbeiten wir Ihre E-Mail-Adresse, den Inhalt der Nachricht und allfällige Anhänge, um zu antworten. Das Postfach liegt bei Infomaniak in der Schweiz. Wir behalten die Korrespondenz so lange, wie die Anfrage und übliche Nachfragen es brauchen, danach löschen wir sie. Eine Weitergabe an Dritte findet nicht statt, ausser sie ist gesetzlich geschuldet.', du: 'Wenn Du uns an info@malojaplana.ch schreibst, bearbeiten wir Deine E-Mail-Adresse, den Inhalt der Nachricht und allfällige Anhänge, um zu antworten. Das Postfach liegt bei Infomaniak in der Schweiz. Wir behalten die Korrespondenz so lange, wie die Anfrage und übliche Nachfragen es brauchen, danach löschen wir sie. Eine Weitergabe an Dritte findet nicht statt, ausser sie ist gesetzlich geschuldet.' },
      backupTitle: 'Backups',
      ...
      rights4: 'Fragen zu den Hosting-Logs oder zu E-Mails an uns: info@malojaplana.ch',
    ...
    terms: {
      ...
      availability1: 'Maloja Plana ist eine offline-fähige Webanwendung. Nach dem ersten Laden funktioniert sie auch ohne Internetverbindung — in der Regel in den Bereichen, die schon einmal geöffnet wurden. Es gibt keine Server-Abhängigkeit und kein SLA.',
    ...
    imprint: {
      ...
      project1: 'Maloja Plana ist ein unabhängiges Open-Source-Projekt von Stebler Studios in aktiver Entwicklung. Die Nutzung der App ist kostenlos, der Quellcode ist öffentlich einsehbar (AGPL-3.0). Für White-Label und andere kommerzielle Nutzung gibt es auf Anfrage eine separate Lizenz.',
      hostingTitle: 'Hosting & Domain',
      hosting1: 'Hosting und Domain werden von Infomaniak Network SA (Genf, Schweiz) bereitgestellt — einem Schweizer Anbieter mit Rechenzentren in der Schweiz, nach Angaben des Anbieters betrieben mit erneuerbarem Strom.',
    ...
    license: {
      ...
      thirdParty1: 'React (MIT), three.js (MIT), Vite (MIT), QRCode.js (MIT), jsQR (Apache-2.0), Capacitor (MIT, nur in der iOS-Hülle, nicht in der Web-App). Schriften: Lexend, Hanken Grotesk, Atkinson Hyperlegible (SIL Open Font License 1.1). Alle Lizenzen sind mit AGPL-3.0 kompatibel.',
    },
    ethics: {
      ...
      sustain2: 'Hosting bei Infomaniak Network SA (Genf, Schweiz): Rechenzentren in der Schweiz, betrieben mit zertifiziertem erneuerbarem Strom (Wasserkraft und weitere lokale erneuerbare Quellen).',
      sustain3: 'Infomaniak ist nach ISO 14001 zertifiziert und kompensiert nach eigenen Angaben seine CO₂-Emissionen über Projekte der Stiftung myclimate.',
      sustainSource: 'Quelle der Angaben zu Infomaniak: https://www.infomaniak.com/en/about, https://www.infomaniak.com/en/ecology, https://www.infomaniak.com/en/ecology/certificates-rewards (Angaben des Anbieters, abgerufen am 17.09.2026).',
      sustain4: 'Offline-fähig: Nach dem ersten Laden läuft die App auch ohne Netz weiter — in der Regel in den Bereichen, die schon einmal geöffnet wurden.',
      contactTitle: 'Spenden & Mitmachen',
      contact1: { sie: 'Maloja Plana ist ein Open-Source-Projekt. Wenn Sie helfen möchten — mit Code, Übersetzungen, Feedback oder einer Spende — melden Sie sich gerne.', du: 'Maloja Plana ist ein Open-Source-Projekt. Wenn Du helfen möchtest — mit Code, Übersetzungen, Feedback oder einer Spende — melde Dich gerne.' },
    ...
    resources: {
      ...
      petition2: { name: 'petition.ch', url: 'https://petition.ch', desc: 'Schweizerische Petitionsplattform' },
      ...
      heartfeltIntroAffiliate: { sie: 'Dienste und Projekte, die wir persönlich schätzen. Die meisten empfehlen wir unbezahlt; mit „Affiliate" markierte Links bringen Maloja eine kleine Provision — ohne dass es Sie etwas kostet.', du: 'Dienste und Projekte, die wir persönlich schätzen. Die meisten empfehlen wir unbezahlt; mit „Affiliate" markierte Links bringen Maloja eine kleine Provision — ohne dass es dich etwas kostet.' },
  ...
  orientation: {
    ...
    saeule3b: { sie: 'Säule 3b ist freie Vorsorge: nicht steuerbegünstigt, aber jederzeit verfügbar (Sparkonto, Lebensversicherung, Wertschriften) — im Gegensatz zur gebundenen Säule 3a.', du: 'Säule 3b ist freie Vorsorge: nicht steuerbegünstigt, aber jederzeit verfügbar (Sparkonto, Lebensversicherung, Wertschriften) — im Gegensatz zur gebundenen Säule 3a.' },
    ...
    familienzulagen: 'Für Kinder gibt es in der Schweiz Familienzulagen. Die Höhe unterscheidet sich je nach Kanton — mindestens CHF 215 pro Kind und Monat, für Kinder in Ausbildung mindestens CHF 268 (FamZG Art. 5).',
  ...
  budgetSync: {
    ...
    benchmark: { sie: 'Zur Orientierung: ein vergleichbarer Haushalt gibt hier rund {amount} aus (BFS 2020/21). Ihrer kann gut abweichen.', du: 'Zur Orientierung: ein vergleichbarer Haushalt gibt hier rund {amount} aus (BFS 2020/21). Deiner kann gut abweichen.' },
    ...
    skosClaim: { sie: 'Ihr Einkommen liegt unter dem Unterstützungsbudget (≈ {amount}/Mt.) — Sozialhilfe könnte relevant sein.', du: 'Dein Einkommen liegt unter dem Unterstützungsbudget (≈ {amount}/Mt.) — Sozialhilfe könnte relevant sein.' },
    skosNoClaim: { sie: 'Sozialhilfe ist hier voraussichtlich nicht relevant — Ihr Einkommen liegt über dem, was sie decken würde (≈ {amount}/Mt.).', du: 'Sozialhilfe ist hier voraussichtlich nicht relevant — dein Einkommen liegt über dem, was sie decken würde (≈ {amount}/Mt.).' },
  },
  ...
  premium: {
    ...
    feldImProfil: { sie: 'Wird auch in Ihrem Profil gespeichert und gilt dort überall.', du: 'Wird auch in Deinem Profil gespeichert und gilt dort überall.' },
    ...
    schnellcheckGerechnet: 'Gerechnet mit den Zahlen aus dem Schnellcheck',
    schnellcheckProfilBleibt: { sie: 'Ihr Profil bleibt unverändert, solange Sie die Zahlen nicht übernehmen.', du: 'Dein Profil bleibt unverändert, solange Du die Zahlen nicht übernimmst.' },
    schnellcheckUebernehmen: 'Ins Profil übernehmen',
    schnellcheckUebernommen: 'Ins Profil übernommen',
    ...
    doc2: 'Lohnabrechnungen der letzten 3 Monate',
    permitTitle: 'Anspruch & Aufenthaltsbewilligung',
    permitText: 'Anspruch besteht meist bei Wohnsitz im Kanton, obligatorischer Krankenversicherung und einer Bewilligung von mindestens 3 Monaten — auch eine Kurzaufenthaltsbewilligung (Ausweis L) kann berechtigen. Die genauen Regeln und Einkommensgrenzen unterscheiden sich je Kanton; im Zweifel hilft die kantonale IPV-Stelle weiter. Für den Antrag braucht es meist die Lohnabrechnungen der letzten 3 Monate und die Police mit der Prämie.',
    permitTodoAdd: 'Unterlagen für den Antrag merken',
    permitTodoAdded: 'Auf der Merkliste',
    permitTodoText: 'IPV-Antrag: Police und Lohnabrechnungen der letzten 3 Monate bereitlegen',
  ...
  sozialhilfe: {
    ...
    assetLimitNote: 'Sozialhilfe setzt voraus, dass Vermögen bis auf einen Freibetrag aufgebraucht ist ({basis}: {freibetrag} für diesen Haushalt). Das erfasste Vermögen liegt rund {ueberschuss} darüber — dieser Teil muss in der Regel zuerst eingesetzt werden. Orientierung, keine verbindliche Auskunft.',
    ...
    efbEntscheidet: { sie: 'Mit dem Einkommensfreibetrag wäre ein Anspruch möglich. Ob er schon bei der Prüfung des Anspruchs zählt, regelt der Kanton: Die SKOS empfiehlt es, Zürich zum Beispiel zählt ihn dabei nicht. Gerechnet ist deshalb vorsichtig ohne ihn — der Sozialdienst weiss, wie es in Ihrer Gemeinde gilt.', du: 'Mit dem Einkommensfreibetrag wäre ein Anspruch möglich. Ob er schon bei der Prüfung des Anspruchs zählt, regelt der Kanton: Die SKOS empfiehlt es, Zürich zum Beispiel zählt ihn dabei nicht. Gerechnet ist deshalb vorsichtig ohne ihn — der Sozialdienst weiss, wie es in deiner Gemeinde gilt.' },
    erwerbsunkostenOffen: 'Mehrkosten für die Arbeit, etwa auswärtige Verpflegung oder der Arbeitsweg, sind hier nicht eingerechnet. Sie erhöhen den Bedarf — im Rechner unten lassen sie sich eintragen.',
    efbGeschaetzt: 'Einkommensfreibetrag geschätzt: ein Drittel des Erwerbseinkommens, höchstens 400 Franken (Regel von Basel-Stadt). Die SKOS nennt 400 bis 700 Franken pro Monat für eine Vollzeitstelle, den Betrag legt der Kanton fest.',
    erwerbsunkostenNichtEingerechnet: 'Mehrkosten für die Arbeit (etwa auswärtige Verpflegung oder der Arbeitsweg) sind nicht eingerechnet. Sie erhöhen den Bedarf.',
    ...
    repaymentRechnerIntro: { sie: 'Angenommen, Sie kommen zu Vermögen (z. B. durch eine Erbschaft) — was läge über dem Freibetrag?', du: 'Angenommen, du kommst zu Vermögen (z. B. durch eine Erbschaft) — was läge über dem Freibetrag?' },
    repaymentAnfallLabel: 'Vermögenszuwachs / Erbschaft (CHF)',
    repaymentRechnerOver: { sie: 'Rund {ueber} liegen über dem Freibetrag ({freibetrag}). Dieser Teil könnte zurückgefordert werden — höchstens so viel, wie Sie an Sozialhilfe bezogen haben, und je nach Kanton.', du: 'Rund {ueber} liegen über dem Freibetrag ({freibetrag}). Dieser Teil könnte zurückgefordert werden — höchstens so viel, wie du an Sozialhilfe bezogen hast, und je nach Kanton.' },
  ...
  lohnEinordnung: {
    ...
    geschaetztAusNetto: 'Aus Netto CHF {netto} geschätzt — der Balken zeigt das ungefähre Brutto (die Mindestlohn-Prüfung greift nur mit echtem Bruttolohn).',
  ...
  tax: {
    ...
    inputs: 'Eingaben',
    taxCanton: 'Steuerkanton',
    wohnkantonFrage: { sie: 'Wohnen Sie auch im Kanton {canton}? Dann übernehmen wir ihn als Wohnkanton — das wirkt auch auf Prämienverbilligung und Sozialhilfe.', du: 'Wohnst du auch im Kanton {canton}? Dann übernehmen wir ihn als Wohnkanton — das wirkt auch auf Prämienverbilligung und Sozialhilfe.' },
    wohnkantonJa: 'Ja, übernehmen',
    wohnkantonNein: 'Nein, nur Steuerkanton',
    wohnkantonUebernommen: 'Wohnkanton übernommen: {canton}.',
    grossIncome: { sie: 'Ihr eigener Nettolohn pro Jahr', du: 'Dein eigener Nettolohn pro Jahr' },
    ...
    married: 'Verheiratet oder in eingetragener Partnerschaft',
    children: 'Kinder',
    elterntarifConfirm: 'Die Kinder leben in meinem Haushalt, und ich komme zur Hauptsache für ihren Unterhalt auf.',
    elterntarifHint: { sie: 'Trifft das zu, gilt der Elterntarif (DBG Art. 36 Abs. 2bis): der Tarif für Verheiratete, abzüglich CHF {value} je Kind. Ohne Bestätigung rechnet Maloja vorsichtig mit dem Grundtarif ohne diesen Abzug — Ihre Steuer kann dann tiefer sein als hier gezeigt.', du: 'Trifft das zu, gilt der Elterntarif (DBG Art. 36 Abs. 2bis): der Tarif für Verheiratete, abzüglich CHF {value} je Kind. Ohne Bestätigung rechnet Maloja vorsichtig mit dem Grundtarif ohne diesen Abzug — deine Steuer kann dann tiefer sein als hier gezeigt.' },
    childDeduction: 'Abzug vom Steuerbetrag je Kind (Bundessteuer)',
    ...
    taxableIncomeEstimated: 'Steuerbares Einkommen (geschätzt nach den Standardabzügen der ESTV)',
    taxableEstimatedHint: { sie: 'Nettolohn abzüglich der Standardabzüge, die der Steuerrechner der ESTV verwendet: Berufsauslagen (3 %, mindestens CHF 2 000, höchstens CHF 4 000 — oder Ihre erfassten Berufskosten), Versicherungsabzug, Abzug für Verheiratete und für Kinder, dazu Ihre erfassten Abzüge. Mit diesem Wert rechnet Maloja die Bundessteuer und liest die Kantons- und Gemeindesteuer.', du: 'Nettolohn abzüglich der Standardabzüge, die der Steuerrechner der ESTV verwendet: Berufsauslagen (3 %, mindestens CHF 2 000, höchstens CHF 4 000 — oder deine erfassten Berufskosten), Versicherungsabzug, Abzug für Verheiratete und für Kinder, dazu deine erfassten Abzüge. Mit diesem Wert rechnet Maloja die Bundessteuer und liest die Kantons- und Gemeindesteuer.' },
    taxableEnteredHint: { sie: 'Von Ihnen eingetragen (Wert für die direkte Bundessteuer). Mit diesem Wert rechnet Maloja die Bundessteuer und liest die Kantons- und Gemeindesteuer.', du: 'Von dir eingetragen (Wert für die direkte Bundessteuer). Mit diesem Wert rechnet Maloja die Bundessteuer und liest die Kantons- und Gemeindesteuer.' },
    federalNotCheckedBrutto: { sie: 'Für diese Situation zeigt Maloja hier keine Bundessteuer: Ihr Lohn ist als Bruttolohn erfasst, und die Abzüge bis zum steuerbaren Einkommen kennt Maloja nicht genau. Mit dem Nettolohn oder dem steuerbaren Einkommen aus der Veranlagung erscheint eine Schätzung. Den genauen Betrag berechnet der Steuerrechner der ESTV.', du: 'Für diese Situation zeigt Maloja hier keine Bundessteuer: Dein Lohn ist als Bruttolohn erfasst, und die Abzüge bis zum steuerbaren Einkommen kennt Maloja nicht genau. Mit dem Nettolohn oder dem steuerbaren Einkommen aus der Veranlagung erscheint eine Schätzung. Den genauen Betrag berechnet der Steuerrechner der ESTV.' },
    federalNotCheckedPartner: 'Für diese Situation zeigt Maloja hier keine Bundessteuer: Bei Verheirateten werden beide Einkommen zusammengerechnet, mit einem eigenen Abzug für Zweiverdiener; bei nicht verheirateten Eltern kann der Kinderabzug zwischen beiden aufgeteilt werden. Mit dem steuerbaren Einkommen aus der Veranlagung erscheint eine Schätzung. Den Betrag berechnet der Steuerrechner der ESTV.',
    noTaxFigure: 'keine Schätzung — Steuerrechner der ESTV',
    // R4 (16.09.2026): Steuer-Annahmen — Rentner/Selbständige, Partnereinkommen offen, 13. Monatslohn
    ohneZahlRente: { sie: "Für diese Situation zeigt Maloja keine Steuerschätzung: Sie sind im Profil als pensioniert erfasst. Die Standardabzüge, mit denen Maloja rechnet, sind für Angestellte gemessen und gelten für Renten nicht so (zum Beispiel gibt es keine Berufsauslagen). Mit dem steuerbaren Einkommen aus der Veranlagung erscheint eine Schätzung. Den Betrag berechnet der Steuerrechner der ESTV.", du: "Für diese Situation zeigt Maloja keine Steuerschätzung: Du bist im Profil als pensioniert erfasst. Die Standardabzüge, mit denen Maloja rechnet, sind für Angestellte gemessen und gelten für Renten nicht so (zum Beispiel gibt es keine Berufsauslagen). Mit dem steuerbaren Einkommen aus deiner Veranlagung erscheint eine Schätzung. Den Betrag berechnet der Steuerrechner der ESTV." },
    ohneZahlSelbstaendig: { sie: "Für diese Situation zeigt Maloja keine Steuerschätzung: Sie sind im Profil als selbständig erwerbend erfasst. Steuerbar ist dann das Einkommen aus der selbständigen Tätigkeit nach Abzug der geschäftsmässig begründeten Kosten — nicht ein Nettolohn mit den Abzügen für Angestellte, mit denen Maloja rechnet. Mit dem steuerbaren Einkommen aus der Veranlagung erscheint eine Schätzung. Den Betrag berechnet der Steuerrechner der ESTV.", du: "Für diese Situation zeigt Maloja keine Steuerschätzung: Du bist im Profil als selbständig erwerbend erfasst. Steuerbar ist dann das Einkommen aus der selbständigen Tätigkeit nach Abzug der geschäftsmässig begründeten Kosten — nicht ein Nettolohn mit den Abzügen für Angestellte, mit denen Maloja rechnet. Mit dem steuerbaren Einkommen aus deiner Veranlagung erscheint eine Schätzung. Den Betrag berechnet der Steuerrechner der ESTV." },
    ohneZahlPartnerOffen: { sie: "Für diese Situation zeigt Maloja noch keine Steuerschätzung: Sie sind als verheiratet erfasst, und die Angabe zum Partnereinkommen fehlt. Bei Verheirateten werden beide Einkommen zusammengerechnet. Bitte das Partnereinkommen im Profil ergänzen (Persönliche Basis → «Nettolohn Partner/in»; hat die Partnerin oder der Partner kein eigenes Einkommen: 0 eintragen).", du: "Für diese Situation zeigt Maloja noch keine Steuerschätzung: Du bist als verheiratet erfasst, und die Angabe zum Partnereinkommen fehlt. Bei Verheirateten werden beide Einkommen zusammengerechnet. Ergänze bitte das Partnereinkommen im Profil (Persönliche Basis → «Nettolohn Partner/in»; hat die Partnerin oder der Partner kein eigenes Einkommen: 0 eintragen)." },
    ...
    annahmeEinzeln: { sie: "Gerechnet für Sie allein: Im Konkubinat wird jede Person einzeln besteuert, das Einkommen Ihrer Partnerin oder Ihres Partners zählt hier nicht. Zusammengerechnet werden nur die Einkommen von Ehepaaren und eingetragenen Partnerschaften (DBG Art. 9).", du: "Gerechnet für dich allein: Im Konkubinat wird jede Person einzeln besteuert, das Einkommen deiner Partnerin oder deines Partners zählt hier nicht. Zusammengerechnet werden nur die Einkommen von Ehepaaren und eingetragenen Partnerschaften (DBG Art. 9)." },
    annahmeKinderabzugKonkubinat: { sie: "Gerechnet mit dem ganzen Kinderabzug bei Ihnen. Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind erhält jeder Elternteil den halben Kinderabzug (ESTV, Kreisschreiben Nr. 30, Ziff. 14.8.1, direkte Bundessteuer) — die Bundessteuer fällt dann gleich hoch oder höher aus. Die kantonale Regel ist je Kanton nachgelesen; wo der Kanton hälftig teilt, zeigt Maloja keine Kantonszahl.", du: "Gerechnet mit dem ganzen Kinderabzug bei dir. Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind erhält jeder Elternteil den halben Kinderabzug (ESTV, Kreisschreiben Nr. 30, Ziff. 14.8.1, direkte Bundessteuer) — die Bundessteuer fällt dann gleich hoch oder höher aus. Die kantonale Regel ist je Kanton nachgelesen; wo der Kanton hälftig teilt, zeigt Maloja keine Kantonszahl." },
    // K62.4: Steuerrechner, Finanzübersicht und Dossier — dieselbe Regel, kein Widerspruch
    bandPartnerOffenDirekt: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: Gemessen ist sie nur für Ehepaare mit einem Einkommen, und die Angabe zum Partnereinkommen fehlt. Die Bundessteuer oben rechnet mit dem eingetragenen Wert — Maloja nimmt an, dass es das gemeinsame steuerbare Einkommen aus der Veranlagung ist. Hat die Partnerin oder der Partner kein eigenes Einkommen: im Profil 0 eintragen (Persönliche Basis → «Nettolohn Partner/in»).",
    bandKonkubinat: { sie: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: In diesem Kanton rechnet der Steuerrechner der ESTV Personen im Konkubinat anders als alleinstehende Personen (gemessen für 2026: im Konkubinat höher). Die Tabelle von Maloja gilt nur für alleinstehende Personen. Die Bundessteuer oben gilt, sie wird für jede Person einzeln gerechnet. Den Betrag für Ihre Gemeinde berechnet der Steuerrechner der ESTV (Zivilstand «Konkubinat»).", du: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: In diesem Kanton rechnet der Steuerrechner der ESTV Personen im Konkubinat anders als alleinstehende Personen (gemessen für 2026: im Konkubinat höher). Die Tabelle von Maloja gilt nur für alleinstehende Personen. Die Bundessteuer oben gilt, sie wird für jede Person einzeln gerechnet. Den Betrag für deine Gemeinde berechnet der Steuerrechner der ESTV (Zivilstand «Konkubinat»)." },
    // K117: Konkubinat mit Kindern, Partnereinkommen im Profil nie beantwortet.
    bandKonkubinatKinderOffen: { sie: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: Im Konkubinat mit Kindern braucht Maloja dafür die Angabe zum Einkommen Ihrer Partnerin oder Ihres Partners, und sie fehlt noch. Die Bundessteuer oben gilt weiterhin.", du: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: Im Konkubinat mit Kindern braucht Maloja dafür die Angabe zum Einkommen deiner Partnerin oder deines Partners, und sie fehlt noch. Die Bundessteuer oben gilt weiterhin." },
    bandKonkubinatKinderabzugHaelftig: { sie: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind teilt dieser Kanton den Kinderabzug zwischen den Eltern hälftig auf; eine Ausnahme für den Fall, dass nur eine Person verdient, nennt die amtliche Quelle nicht. Die Tabelle von Maloja und der Steuerrechner der ESTV rechnen mit dem ganzen Abzug bei Ihnen und zeigten die Steuer deshalb zu tief. Den verbindlichen Betrag nennt die Veranlagung; Auskunft gibt die kantonale Steuerverwaltung.", du: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind teilt dieser Kanton den Kinderabzug zwischen den Eltern hälftig auf; eine Ausnahme für den Fall, dass nur eine Person verdient, nennt die amtliche Quelle nicht. Die Tabelle von Maloja und der Steuerrechner der ESTV rechnen mit dem ganzen Abzug bei dir und zeigten die Steuer deshalb zu tief. Den verbindlichen Betrag nennt die Veranlagung; Auskunft gibt die kantonale Steuerverwaltung." },
    ...
    ohneZahlKinderDirekt: "Für diese Situation zeigt Maloja keine Steuerschätzung: Das eingetragene steuerbare Einkommen gehört zur Kinderzahl im Profil. Für eine andere Kinderzahl rechnet Maloja nicht damit. Zum Ausprobieren das Häkchen «Diesen Wert als Basis verwenden» entfernen — dann schätzt Maloja aus dem Nettolohn.",
    gemeinsamDirektHinweis: "Maloja nimmt an, dass der eingetragene Wert das gemeinsame steuerbare Einkommen des Ehepaars aus der Veranlagung ist. Die Zeile mit dem Nettolohn enthält nur das eigene Einkommen — darum zeigt Maloja hier keinen Steuersatz und kein Nettoeinkommen nach Steuern.",
    ansageHinweis: "Statt einer Zahl steht jetzt ein Hinweis bei: {teile}.",
    ansageZahlen: "Die Schätzung zeigt wieder Zahlen.",
    ...
    taxableIncomeDirectHint: 'Bekannt aus der Steuerveranlagung? Direkt eintragen — dann rechnet die Übersicht damit statt aus dem Nettolohn. Gemeint ist der Wert für die direkte Bundessteuer (die Veranlagung nennt Bund und Kanton getrennt). Bei Verheirateten nimmt Maloja eine gemeinsame Veranlagung an: dann der gemeinsame Wert beider Ehegatten.',
    ...
    saeulen: {
      ...
      einzelnPending: 'Verheiratet, einzeln (Individualbesteuerung): am 8. März 2026 angenommen, soll 2032 in Kraft treten (Entscheid des Bundesrats vom 19. August 2026). Sobald der neue Tarif gilt, kommt hier eine belegte Zahl.',
      ...
      konkubinatPartner: "Im Konkubinat zeigt Maloja hier keinen Vergleich: Nach einer Heirat würden beide Einkommen zusammengerechnet (DBG Art. 9), mit einem eigenen Abzug für Zweiverdiener. Gemessen ist nur das Ehepaar mit einem Einkommen. Den Vergleich mit zwei Einkommen berechnet der Steuerrechner der ESTV.",
      konkubinatPartnerOffen: { sie: "Im Konkubinat hängt der Vergleich vom Einkommen Ihrer Partnerin oder Ihres Partners ab: Nach einer Heirat würden beide Einkommen zusammengerechnet. Die Angabe fehlt noch (Persönliche Basis → «Nettolohn Partner/in»; ohne eigenes Einkommen: 0 eintragen).", du: "Im Konkubinat hängt der Vergleich vom Einkommen deiner Partnerin oder deines Partners ab: Nach einer Heirat würden beide Einkommen zusammengerechnet. Die Angabe fehlt noch (Persönliche Basis → «Nettolohn Partner/in»; ohne eigenes Einkommen: 0 eintragen)." },
    },
  },
  ...
  schulden: {
    ...
    emptyDebts: 'Noch keine Schulden erfasst',
    emptyBetreibung: 'Keine Betreibungen',
    emptyVerlustschein: 'Keine Verlustscheine',
  ...
  briefe: {
    ...
    jobPicker: {
      title: 'Um welche Anstellung geht es?',
      intro: { sie: 'Sie haben einen Nebenerwerb erfasst. Der Brief geht an den gewählten Arbeitgeber — mit den Zahlen dieser Anstellung.', du: 'Du hast einen Nebenerwerb erfasst. Der Brief geht an den gewählten Arbeitgeber — mit den Zahlen dieser Anstellung.' },
      main: 'Hauptanstellung',
      side: 'Nebenerwerb',
    },
    kkReasonPicker: {
    ...
    leaseTermination: {
      ...
      closing: 'Freundliche Grüsse',
      legalNote: 'Hinweis: Mietkündigungen müssen gemäss OR Art. 266l Abs. 1 schriftlich erfolgen. Dient die Wohnung der Familie, braucht die Kündigung die ausdrückliche Zustimmung des Ehegatten bzw. der eingetragenen Partnerin oder des eingetragenen Partners (OR Art. 266m). Bitte beachten Sie die vertraglich vereinbarten Kündigungsfristen.',
    },
    taxExtension: {
    ...
    insuranceSwitch: {
      ...
      closing: 'Freundliche Grüsse',
      legalNote: 'Hinweis: Die Kündigung der Grundversicherung auf Ende Jahr muss gemäss KVG Art. 7 Abs. 2 (nach Mitteilung der neuen Prämie) bis spätestens 30. November beim Versicherer eingehen. Einschreiben empfohlen.',
    },
    kkReklamation: {
    ...
    wageClaim: {
      ...
      figuresDiff: 'Differenz pro Monat: rund CHF {amount}',
      body2request: 'Bitte prüfen Sie meine Einstufung und heben Sie meinen Lohn — falls er zu tief ist — auf den gesetzlichen Mindestlohn an, mit Nachzahlung der aufgelaufenen Differenz. Über eine Rückmeldung bis {frist} freue ich mich; für ein Gespräch stehe ich gerne zur Verfügung.',
      closing: 'Freundliche Grüsse',
      legalNote: 'Grundlage: Lohnpflicht des Arbeitgebers (OR Art. 322) sowie {gesetz} (Kanton {canton}). Bei ausbleibender Einigung kann die zuständige Stelle kontaktiert werden: {stelle}. Diese Vorlage ist eine Orientierungshilfe, keine Rechtsberatung. Einschreiben empfohlen.',
      gesetzFallback: 'der geltende gesetzliche Mindestlohn',
      stelleFallback: 'die zuständige kantonale Stelle',
      reminderTitle: 'Rückmeldung erwartet — Lohn-Nachfrage',
    },
    unpaidWage: {
      ...
      reminderTitle: 'Rückmeldung erwartet — ausstehender Lohn',
    },
    // ─── Lebensereignis-Briefe (26.09.2026) — Wortlaut geprüft an OR/SchKG (Stand 1.1.2026),
    // ZPO/ZGB (Stand 1.7.2026), lexfind-PDF. Der Brieftext ist immer «Sie» (an die Stelle);
    // Sie/Du gilt für die Hinweise in der App.
    angaben: {
      title: 'Angaben für diesen Brief',
      intro: 'Diese Angaben stehen nur im Brief und werden nicht gespeichert. Leere Felder bleiben im Brief als «[bitte ergänzen]» markiert.',
      betragErkannt: 'Im Brief steht: CHF {amount}',
      betragUnklar: 'Diesen Betrag können wir nicht sicher lesen — im Brief bleibt «[bitte ergänzen]». Bitte nur Ziffern, z. B. 1250.50 oder 1\'250.50.',
    },
    ablaufLink: {
      workReference: 'Brief: Arbeitszeugnis anfordern',
      dismissalObjection: 'Brief: Einsprache gegen die Kündigung',
      debtObjection: 'Brief: Rechtsvorschlag erheben',
      deathNotice: 'Brief: Todesfall einer Stelle melden',
    },
    workReference: {
      title: 'Arbeitszeugnis anfordern',
      description: 'Ein Zwischen- oder Schlusszeugnis — oder nur eine Arbeitsbestätigung — beim Arbeitgeber verlangen.',
      felder: {
        art: {
          label: { sie: 'Was möchten Sie?', du: 'Was möchtest du?' },
          voll: 'Arbeitszeugnis: Art und Dauer, Leistungen und Verhalten',
          bestaetigung: 'Arbeitsbestätigung: nur Art und Dauer',
        },
        zeitpunkt: {
          label: 'Zeitpunkt',
          zwischen: 'Zwischenzeugnis — die Anstellung läuft noch',
          schluss: 'Schlusszeugnis — die Anstellung endet oder ist beendet',
        },
      },
      hinweis: { sie: 'Ein Zeugnis können Sie jederzeit verlangen — während der Anstellung und danach (OR Art. 330a Abs. 1). Die Arbeitsbestätigung nennt nur Art und Dauer der Anstellung; sie wird auf Ihren ausdrücklichen Wunsch statt des Zeugnisses ausgestellt (Abs. 2).', du: 'Ein Zeugnis kannst du jederzeit verlangen — während der Anstellung und danach (OR Art. 330a Abs. 1). Die Arbeitsbestätigung nennt nur Art und Dauer der Anstellung; sie wird auf deinen ausdrücklichen Wunsch statt des Zeugnisses ausgestellt (Abs. 2).' },
      subject: {
        zwischen: 'Bitte um ein Zwischenzeugnis',
        schluss: 'Bitte um ein Arbeitszeugnis',
        bestaetigung: 'Bitte um eine Arbeitsbestätigung',
      },
      salutation: 'Sehr geehrte Damen und Herren,',
      body: {
        zwischen: 'hiermit bitte ich Sie um ein Zwischenzeugnis, das sich über die Art und Dauer meines Arbeitsverhältnisses sowie über meine Leistungen und mein Verhalten ausspricht.',
        schluss: 'hiermit bitte ich Sie um ein Arbeitszeugnis, das sich über die Art und Dauer meines Arbeitsverhältnisses sowie über meine Leistungen und mein Verhalten ausspricht.',
        bestaetigung: 'hiermit bitte ich Sie um eine Arbeitsbestätigung. Sie soll sich auf Angaben über die Art und Dauer meines Arbeitsverhältnisses beschränken.',
      },
      body2: 'Für die Zustellung danke ich Ihnen im Voraus. Für Rückfragen stehe ich gerne zur Verfügung.',
      closing: 'Freundliche Grüsse',
      legalNote: 'Grundlage: OR Art. 330a. Ein Zeugnis kann jederzeit verlangt werden. Diese Vorlage ist eine Orientierungshilfe, keine Rechtsberatung.',
    },
    dismissalObjection: {
      title: 'Einsprache gegen die Kündigung',
      description: 'Schriftliche Einsprache beim Arbeitgeber, wenn eine Kündigung missbräuchlich sein könnte — vor dem Ende der Kündigungsfrist.',
      felder: {
        kuendigungsdatum: { label: 'Datum des Kündigungsschreibens' },
        ende: { label: 'Ende des Arbeitsverhältnisses laut Kündigung (nur für die Fristen — steht nicht im Brief)' },
        begruendung: { label: 'Zugleich eine schriftliche Begründung der Kündigung verlangen (OR Art. 335 Abs. 2)' },
        einschaetzung: {
          label: { sie: 'Ihre Einschätzung (freiwillig)', du: 'Deine Einschätzung (freiwillig)' },
          hilfe: { sie: 'Erscheint im Brief ausdrücklich als Ihre Einschätzung, nicht als Tatsache. Sachlich und ohne Vorwurf formulieren; Namen und Anschuldigungen gehören nicht in diesen Brief. Leer lassen ist ebenso gültig — die Einsprache braucht keine Begründung.', du: 'Erscheint im Brief ausdrücklich als deine Einschätzung, nicht als Tatsache. Sachlich und ohne Vorwurf formulieren; Namen und Anschuldigungen gehören nicht in diesen Brief. Leer lassen ist ebenso gültig — die Einsprache braucht keine Begründung.' },
        },
      },
      frist: {
        title: 'Zwei Fristen',
        einsprache: { sie: 'Die Einsprache muss schriftlich und spätestens bis zum Ende der Kündigungsfrist beim Arbeitgeber sein (OR Art. 336b Abs. 1). Schicken Sie sie früh und eingeschrieben.', du: 'Die Einsprache muss schriftlich und spätestens bis zum Ende der Kündigungsfrist beim Arbeitgeber sein (OR Art. 336b Abs. 1). Schick sie früh und eingeschrieben.' },
        einspracheDatum: 'Ende laut Eingabe: {date} — die Einsprache muss spätestens an diesem Tag beim Arbeitgeber sein, besser deutlich früher.',
        klage: 'Einigen sich die Parteien nicht über die Fortsetzung, muss innert 180 Tagen nach dem Ende des Arbeitsverhältnisses eine Klage anhängig gemacht werden, sonst ist der Anspruch auf Entschädigung verwirkt (OR Art. 336b Abs. 2). Anhängig ist sie bereits mit dem Gesuch an die Schlichtungsbehörde (ZPO Art. 62 Abs. 1).',
        klageDatum: 'Letzter Tag nach unserer Rechnung: {date}. Verschiebt sich das Ende (etwa wegen Krankheit, OR Art. 336c), liegt die Frist später — wir rechnen bewusst ohne Verlängerung. Wurde während einer Krankheit, eines Unfalls oder einer Schwangerschaft gekündigt, kann die Kündigung sogar nichtig sein (OR Art. 336c Abs. 2) — dann lieber beraten lassen.',
        fristlos: 'Bei einer fristlosen Entlassung gelten andere Regeln — dann lieber zuerst beraten lassen.',
        beratung: 'Beratung bieten Gewerkschaften, Rechtsberatungsstellen und die Schlichtungsbehörde in Arbeitsrechtssachen des Kantons.',
      },
      subject: 'Einsprache gegen die Kündigung vom {date}',
      salutation: 'Sehr geehrte Damen und Herren,',
      body1: 'hiermit erhebe ich gegen die Kündigung meines Arbeitsverhältnisses vom {date} Einsprache im Sinne von Art. 336b OR. Ich bin mit der Kündigung nicht einverstanden.',
      einschaetzung: 'Nach meiner Einschätzung könnte die Kündigung mit Folgendem zusammenhängen: {text}',
      begruendung: 'Zugleich bitte ich Sie, mir die Kündigung schriftlich zu begründen (Art. 335 Abs. 2 OR).',
      body2: 'Ich bin gerne bereit, mit Ihnen über die Fortsetzung des Arbeitsverhältnisses zu sprechen.',
      closing: 'Freundliche Grüsse',
      legalNote: 'Grundlage: OR Art. 336b (Einsprache) und Art. 335 Abs. 2 (Begründung). Die Einsprache hebt die Kündigung nicht auf. Diese Vorlage ist eine Orientierungshilfe, keine Rechtsberatung. Einschreiben empfohlen.',
    },
    debtObjection: {
      title: 'Rechtsvorschlag erheben',
      description: 'Einen Zahlungsbefehl bestreiten — innert 10 Tagen nach der Zustellung, ohne Begründung.',
      felder: {
        betreibungsnummer: { label: 'Betreibungsnummer (steht auf dem Zahlungsbefehl)' },
        zustelldatum: { label: 'Tag der Zustellung des Zahlungsbefehls' },
        glaeubiger: { label: 'Betreibende Partei (steht auf dem Zahlungsbefehl)' },
        umfang: {
          label: { sie: 'Was bestreiten Sie?', du: 'Was bestreitest du?' },
          ganz: 'Die ganze Forderung',
          teil: 'Nur einen Teil der Forderung',
        },
        neuesVermoegen: { label: 'Nach einem früheren Konkurs: bestreiten, zu neuem Vermögen gekommen zu sein (SchKG Art. 75 Abs. 2)' },
        teilbetrag: {
          label: 'Bestrittener Betrag in CHF',
          hilfe: 'Den bestrittenen Betrag genau angeben — sonst gilt die ganze Forderung als bestritten (SchKG Art. 74 Abs. 2).',
        },
      },
      frist: {
        title: 'Frist: 10 Tage ab Zustellung',
        text: 'Der Rechtsvorschlag muss innert 10 Tagen nach der Zustellung des Zahlungsbefehls beim Betreibungsamt erklärt werden; der Tag der Zustellung zählt nicht mit (SchKG Art. 74 Abs. 1, Art. 31 i. V. m. ZPO Art. 142 Abs. 1).',
        muendlich: 'Es geht auch ohne Brief: sofort mündlich bei der Person, die den Zahlungsbefehl überbringt, oder innert der Frist mündlich beim Betreibungsamt.',
        post: { sie: 'Schriftlich genügt es, wenn der Brief spätestens am letzten Tag der Frist der Schweizerischen Post übergeben ist (SchKG Art. 31, ZPO Art. 143 Abs. 1). Senden Sie ihn eingeschrieben — die Quittung ist Ihr Beleg.', du: 'Schriftlich genügt es, wenn der Brief spätestens am letzten Tag der Frist der Schweizerischen Post übergeben ist (SchKG Art. 31, ZPO Art. 143 Abs. 1). Sende ihn eingeschrieben — die Quittung ist dein Beleg.' },
        datum: 'Letzter Tag nach unserer Rechnung: {date}. Wochenende, Feiertage und Betreibungsferien können die Frist verlängern — wir rechnen bewusst ohne; früher ist nie falsch.',
        vorbei: { sie: 'Nach unserer Rechnung ist die Frist möglicherweise am {date} abgelaufen. Wochenende, Feiertage oder Betreibungsferien können sie verlängert haben. Fragen Sie sofort beim Betreibungsamt nach und erheben Sie den Rechtsvorschlag im Zweifel trotzdem.', du: 'Nach unserer Rechnung ist die Frist möglicherweise am {date} abgelaufen. Wochenende, Feiertage oder Betreibungsferien können sie verlängert haben. Frag sofort beim Betreibungsamt nach und erheb den Rechtsvorschlag im Zweifel trotzdem.' },
        ohne: { sie: 'Tragen Sie unten den Tag der Zustellung ein, dann zeigen wir den letzten Tag der Frist.', du: 'Trag unten den Tag der Zustellung ein, dann zeigen wir den letzten Tag der Frist.' },
      },
      recipient: '[Betreibungsamt — die Adresse steht auf dem Zahlungsbefehl]',
      subject: 'Rechtsvorschlag — Betreibung Nr. {number}',
      salutation: 'Sehr geehrte Damen und Herren,',
      body1: 'in der Betreibung Nr. {number} wurde mir am {date} ein Zahlungsbefehl zugestellt. Betreibende Partei: {creditor}.',
      ganz: 'Hiermit erhebe ich Rechtsvorschlag gegen die ganze Forderung.',
      teil: 'Hiermit erhebe ich Rechtsvorschlag gegen einen Teil der Forderung. Bestritten ist ein Betrag von CHF {amount}.',
      neuesVermoegen: 'Zudem bestreite ich, zu neuem Vermögen gekommen zu sein (Art. 75 Abs. 2 SchKG).',
      bescheinigung: 'Ich bitte Sie, mir die Erhebung des Rechtsvorschlags zu bescheinigen (Art. 74 Abs. 3 SchKG).',
      closing: 'Freundliche Grüsse',
      legalNote: 'Grundlage: SchKG Art. 74 und 75. Der Rechtsvorschlag braucht keine Begründung. Nach einem früheren Konkurs gilt: Wer bestreitet, zu neuem Vermögen gekommen zu sein, muss das im Rechtsvorschlag ausdrücklich erklären (SchKG Art. 75 Abs. 2). Diese Vorlage ist eine Orientierungshilfe, keine Rechtsberatung. Einschreiben empfohlen.',
    },
    deathNotice: {
      title: 'Todesfall einer Stelle melden',
      description: 'Einer Versicherung, Bank, Vermietung oder einem Abo-Anbieter einen Todesfall mitteilen und nach dem weiteren Vorgehen fragen.',
      felder: {
        verstorben: { label: 'Name der verstorbenen Person' },
        todesdatum: { label: 'Todesdatum' },
        vertragsnummer: { label: 'Vertrags-, Kunden- oder Policennummer' },
      },
      erbe: {
        title: 'Wichtig, solange die Erbschaft offen ist',
        text: 'Wer sich vor Ablauf der Ausschlagungsfrist in die Angelegenheiten der Erbschaft einmischt, Handlungen vornimmt, die über die blosse Verwaltung hinausgehen, oder Erbschaftssachen an sich nimmt oder verheimlicht, kann die Erbschaft nicht mehr ausschlagen (ZGB Art. 571 Abs. 2) — zum Beispiel, wer Schulden aus dem Nachlass bezahlt, Forderungen anerkennt oder über Vermögen der verstorbenen Person verfügt. Was noch «blosse Verwaltung» ist, fragt man im Zweifel bei der Erbschaftsbehörde. Die Frist beträgt drei Monate; für gesetzliche Erben beginnt sie in der Regel, wenn sie vom Tod erfahren, für eingesetzte Erben mit der amtlichen Mitteilung (ZGB Art. 567).',
        brief: { sie: 'Dieser Brief ist deshalb eine reine Mitteilung mit Fragen. Ergänzen Sie ihn nicht um eine Zahlungszusage, eine Kündigung oder eine Weisung — im Zweifel zuerst bei der Erbschaftsbehörde oder einer Fachstelle nachfragen.', du: 'Dieser Brief ist deshalb eine reine Mitteilung mit Fragen. Ergänze ihn nicht um eine Zahlungszusage, eine Kündigung oder eine Weisung — im Zweifel zuerst bei der Erbschaftsbehörde oder einer Fachstelle nachfragen.' },
        miete: 'Mietvertrag: Die Erben können mit der gesetzlichen Frist auf den nächsten gesetzlichen Termin kündigen (OR Art. 266i). Dabei handeln die Erben in der Regel gemeinsam (ZGB Art. 602 Abs. 2). Ob und wann das vor dem Entscheid über die Erbschaft ratsam ist, klärt man besser vorher mit der Erbschaftsbehörde oder einer Fachstelle — diese Vorlage kündigt deshalb nicht.',
      },
      subject: 'Mitteilung eines Todesfalls — {name}',
      salutation: 'Sehr geehrte Damen und Herren,',
      body1: 'ich teile Ihnen mit, dass {name} am {date} verstorben ist.',
      reference: 'Vertrags- bzw. Kundennummer: {number}',
      body2: 'Bitte teilen Sie mir mit, welche Unterlagen Sie benötigen und wie der Vertrag beendet werden kann. Zudem bitte ich Sie um eine Aufstellung über den Stand per Todestag (etwa einen Kontoauszug) bzw. um eine allfällige Schlussabrechnung.',
      vorbehalt: 'Dieses Schreiben ist eine Mitteilung. Es enthält keine Kündigung, keine Erklärung zur Erbschaft und keine Anerkennung von Forderungen.',
      closing: 'Freundliche Grüsse',
      legalNote: 'Hinweis: reine Mitteilung — keine Zahlungszusage, keine Kündigung, keine Verfügung über Vermögen (ZGB Art. 571 Abs. 2). Diese Vorlage ist eine Orientierungshilfe, keine Rechtsberatung.',
    },
    wageReminder: {
      title: 'Frist im Kalender festhalten',
      text: { sie: 'Wir können den Rückmelde-Termin ({frist}, in {days} Tagen) in Ihren Kalender legen — mit Voralarm einen Tag vorher.', du: 'Wir können den Rückmelde-Termin ({frist}, in {days} Tagen) in deinen Kalender legen — mit Voralarm einen Tag vorher.' },
      cta: 'Frist in den Kalender legen',
      added: 'Im Kalender festgehalten',
      notesWageClaim: 'Falls keine Antwort: nächster Schritt bei der zuständigen kantonalen Stelle.',
      notesUnpaid: 'Falls keine Zahlung: Schlichtungsbehörde in Arbeitsrechtssachen / Arbeitsgericht am Arbeitsort, allenfalls Betreibung.',
    },
  },
  ...
  kkScanner: {
    ...
    nichtsGelesen: { sie: 'Auf dem Bild war nichts zu lesen. Ein schärferes Foto hilft — oder Sie geben die Daten von Hand ein.', du: 'Auf dem Bild war nichts zu lesen. Ein schärferes Foto hilft — oder du gibst die Daten von Hand ein.' },
  ...
  zipExport: {
    ...
    vorschau: {
      titelDatei: 'Das steht in der Datei',
      titelDruck: 'Das steht im Dokument',
      introDatei: { sie: 'Die Datei entsteht auf diesem Gerät. Sie verlässt es erst, wenn Sie sie selbst weitergeben.', du: 'Die Datei entsteht auf diesem Gerät. Sie verlässt es erst, wenn du sie selbst weitergibst.' },
      introDruck: { sie: 'Das Dokument öffnet sich in einem neuen Fenster, zum Drucken oder Speichern als PDF. Es verlässt Ihr Gerät erst, wenn Sie es weitergeben.', du: 'Das Dokument öffnet sich in einem neuen Fenster, zum Drucken oder Speichern als PDF. Es verlässt dein Gerät erst, wenn du es weitergibst.' },
      leer: 'Noch keine Angaben erfasst.',
      verschluesselt: { sie: 'Verschlüsselt mit Ihrem Passwort (AES-256). Ohne das Passwort lässt sich die Datei nicht öffnen.', du: 'Verschlüsselt mit deinem Passwort (AES-256). Ohne das Passwort lässt sich die Datei nicht öffnen.' },
      offen: 'Nicht verschlüsselt: Wer die Datei öffnet, kann sie lesen.',
      offenDruck: 'Nicht verschlüsselt: Wer das Dokument erhält, kann es lesen.',
      weiterDatei: 'Datei erstellen',
      weiterDruck: 'Dokument öffnen',
      zurueck: 'Zurück',
      kat: {
        weitere: 'Weitere Angaben aus Rechnern und Abläufen (Bereiche: {count})',
        ahv: 'AHV-Nummer',
        gesundheit: 'Gesundheitsangaben',
        dokumenteListe: { sie: 'Liste Ihrer Dokumente ({count}) — nur die Namen, ohne Inhalt', du: 'Liste deiner Dokumente ({count}) — nur die Namen, ohne Inhalt' },
        dokumenteInhalt: { sie: 'Ihre Dokumente ({count}) — mit Inhalt', du: 'Deine Dokumente ({count}) — mit Inhalt' },
        termine: 'Termine und Erinnerungen ({count})',
        kontakte: 'Kontakte ({count})',
        merkliste: 'Merkliste ({count})',
        einstellungen: 'Einstellungen (Sprache, Darstellung)',
        person: 'Angaben zur Person',
        adresse: 'Wohnadresse',
        berechnungen: 'Berechnungsergebnisse ({count})',
        name: { sie: 'Ihr Name', du: 'Dein Name' },
        kanton: 'Wohnkanton',
        versicherung: 'Angaben zur Krankenkasse',
        ...
        ausgaben: 'Monatliche Ausgaben nach Bereichen',
        schulden: 'Abzahlungen von Schulden',
        haushalt: 'Grösse des Haushalts (Erwachsene, Kinder)',
        kontakt: 'Telefon und E-Mail',
        persoenlich: 'Geburtsdatum, Nationalität, Zivilstand',
        beruf: 'Berufserfahrung',
        ausbildung: 'Ausbildung und Abschlüsse',
        sprachen: 'Sprachen',
        kalenderTermine: 'Offene Termine ({count}): Titel, Datum, Kategorie, Wiederholung',
      },
    },
    manifest: {
      ...
      securityTip2: { sie: 'Bewahren Sie die exportierten Dateien sicher auf (am besten als verschlüsselte Sicherung)', du: 'Bewahre die exportierten Dateien sicher auf (am besten als verschlüsselte Sicherung)' },
      securityTip3: { sie: 'Speichern Sie mehrere Kopien an unterschiedlichen Orten', du: 'Speichere mehrere Kopien an unterschiedlichen Orten' },
      securityTip4: { sie: 'Testen Sie regelmässig die Wiederherstellung', du: 'Teste regelmässig die Wiederherstellung' },
  ...
  expiryHints: {
    idCard: 'Identitätskarte: 10 Jahre gültig (unter 18: 5 Jahre)',
    ...
    passport: 'Pass: 10 Jahre gültig (unter 18: 5 Jahre)',
  ...
  debtRecommendations: {
    ...
    critical: 'Die Schuldenlage ist ernst. Eine Schuldenberatung kann jetzt helfen.',
  },
  ...
  budget: {
    ...
    ipvHintVerfuegungUnzugeordnet: { sie: 'Prämienverbilligung (IPV): CHF {amount}/Monat im Budget abgezogen — höchstens der Betrag Ihrer Verfügung, nie mehr als die Schätzung. Bei der Verfügung fehlen Kanton und Jahr; unter «Prämienverbilligung» können Sie sie zuordnen.', du: 'Prämienverbilligung (IPV): CHF {amount}/Monat im Budget abgezogen — höchstens der Betrag deiner Verfügung, nie mehr als die Schätzung. Bei der Verfügung fehlen Kanton und Jahr; unter «Prämienverbilligung» kannst du sie zuordnen.' },
  ...
  ipv: {
    ...
    annahmeOhneDreizehnten: 'Ohne 13. Monatslohn gerechnet — die Angabe fehlt noch. Mit 13. Monatslohn liegt das Jahreseinkommen höher und die Verbilligung tiefer — oder sie entfällt ganz. Angeben lässt sich das im Kapitel «Finanzen & Geld».',
    ohneDreizehntenKurz: 'ohne 13. Monatslohn gerechnet',
    annahmePartnerOhneDreizehnten: 'Das Einkommen der zweiten Person ist ohne 13. Monatslohn gerechnet — danach fragt Maloja nicht. Erhält sie einen, liegt die Verbilligung tiefer oder entfällt ganz.',
    ...
    vorbehaltSG: 'Im Kanton St.Gallen ist das Reineinkommen der Steuerperiode {basisjahr} die Grundlage — zwei Jahre vor dem Anspruchsjahr, nicht das heutige Einkommen. Verbilligt wird zudem die kantonale Referenzprämie der Prämienregion, nicht die tatsächlich bezahlte Prämie: liegt diese tiefer, kann der ausbezahlte Betrag tiefer ausfallen. Bei der SVA St.Gallen nachfragen.',
    sgKeinAnspruch: 'Nach dieser Rechnung besteht kein Anspruch: Die Referenzprämie liegt nicht über der Belastungsgrenze des massgebenden Einkommens. Der Kanton St.Gallen veröffentlicht dazu keine Einkommensgrenze als Zahl — sie ergibt sich erst aus der Rechnung.',
    sgUnterMindestbetrag: 'Nach dieser Rechnung bestünde ein Anspruch, er wird aber nicht ausgerichtet: Der Kanton St.Gallen zahlt keine Prämienverbilligung unter Fr. 100.– je Person und Jahr.',
    sgFristLaeuft: 'Für {jahr} läuft die Frist für einen ganzjährigen Anspruch bis zum 31. März {jahr}. Wer Ergänzungsleistungen bezieht, erhält die Verbilligung ohne Anmeldung.',
    sgFristFolgejahr: 'Die Frist für einen ganzjährigen Anspruch {jahr} lief bis zum 31. März {jahr} und ist vorbei. Der Betrag hier zeigt, worum es geht. Wie eine spätere Anmeldung behandelt wird und ab wann für {folgejahr} angemeldet werden kann, sagt die SVA St.Gallen — die Werte für {folgejahr} sind noch nicht beschlossen. Wer Ergänzungsleistungen bezieht, erhält die Verbilligung ohne Anmeldung.',
    // K31 LU (23.09.2026): Prämienverbilligungsgesetz SRL 866 §§ 7, 8a, 12; Verordnung SRL 866a § 7.
    vorbehaltLU: 'Im Kanton Luzern ist die letzte rechtskräftige Steuerveranlagung die Grundlage, nicht das heutige Einkommen. Haben sich die Verhältnisse seit dem 1. November des Vorjahres wesentlich verändert, wird die Prämienverbilligung auf Gesuch bei der WAS Ausgleichskasse Luzern oder von Amtes wegen angepasst. Ein Gesuch um Erhöhung ist spätestens am 31. Dezember des Jahres einzureichen, für das die Änderung gilt. Zu Unrecht ausgerichtete Beträge werden beim Krankenversicherer zurückgefordert, dem sie ausbezahlt wurden.',
    luKeinAnspruch: 'Nach dieser Rechnung besteht kein Anspruch: Die Richtprämie liegt nicht über dem eigenen Anteil am massgebenden Einkommen. Der Kanton Luzern veröffentlicht dazu keine Einkommensgrenze als Zahl — sie ergibt sich erst aus der Rechnung.',
  ...
  mietzinsView: {
    ...
    wfg_ja: 'Ja',
    wfg_nein: 'Nein',
    wfg_weissNicht: 'Weiss nicht',
    wfgHinweis: 'Das weiss die Verwaltung oder die Vermieterschaft. Die Antwort bleibt im Kapitel Wohnen gespeichert.',
    result_wfgNein: 'Mietzinsbeiträge gibt es in Zug nur für Wohnungen nach dem Wohnraumförderungsgesetz — für diese Wohnung also nicht. Andere Hilfen wie die Prämienverbilligung hängen nicht davon ab.',
    ...
    massgebendTiefer: 'Der Kanton rechnet mit dem massgeblichen Einkommen nach Abzügen (dazu 10 % des Vermögens über dem Freibetrag) — es liegt meist tiefer als der Lohn. Knapp über der Grenze lohnt sich die Prüfung trotzdem.',
    konkubinatPartner: 'Das Einkommen der zweiten erwachsenen Person ist nicht eingerechnet: Ohne Ehe zählt es je nach Kanton erst nach einigen Jahren Zusammenleben oder mit gemeinsamen Kindern. Mitgezählt läge das Haushaltseinkommen bei CHF {mit} — ob es zählt, klärt die kantonale Stelle.',
    konkubinatPartnerGrenze: 'Das Einkommen der zweiten erwachsenen Person ist nicht eingerechnet und die Grenze ohne sie gerechnet: Ohne Ehe zählt sie in Basel-Stadt erst mit gemeinsamen Kindern oder nach fünf Jahren Zusammenleben. Mitgezählt läge das Haushaltseinkommen bei CHF {mit}, die Grenze bei etwa CHF {grenze} — ob sie zählt, klärt das Amt für Sozialbeiträge.',
    partnerOffen: 'Gerechnet ohne Einkommen des Ehepartners oder der Ehepartnerin — die Angabe fehlt noch (Kapitel Persönliche Basis, Haushalt). Mit einem Einkommen liegt das Haushaltseinkommen höher.',
    referenzalterBS: 'Ab dem AHV-Referenzalter gibt es in Basel-Stadt keine Mietbeiträge mehr (Mietbeitragsgesetz § 4 Abs. 2). Bei einer Frühpensionierung kann ein Anspruch bestehen — das klärt das Amt für Sozialbeiträge.',
    kindOhneAlter: 'Bei mindestens einem Kind fehlt das Alter — gerechnet wie ein minderjähriges Kind. Ab 18 zählt es nur in Erstausbildung; das Alter lässt sich im Haushalt ergänzen.',
    mietbelastungZG: 'Zwischen CHF 50’000 und 60’000 gibt es in Zug nur einen Beitrag, wenn die Miete nach der Verbilligung mehr als 25 % des Einkommens ausmacht — hier liegt sie schon vorher darunter.',
    ...
    rentWithin: { sie: 'Ihre Miete liegt innerhalb der kantonalen Mietzins-Limite (CHF {limit}/Monat für {size} Pers.).', du: 'Deine Miete liegt innerhalb der kantonalen Mietzins-Limite (CHF {limit}/Monat für {size} Pers.).' },
    ...
    cantonNote_BS: 'Für Haushalte mit tiefem Einkommen. Grenze je Haushalt: Grundeinkommen plus CHF 36’000 — z. B. 1 Person bis etwa CHF 51’750, Paar bis etwa CHF 54’000, Paar mit einem Kind bis etwa CHF 76’000 (Merkblatt 01.2026). Gerechnet wird mit dem massgeblichen Einkommen inkl. eines Vermögensanteils. Mind. 2 Jahre Wohnsitz; ab AHV-Referenzalter kein Anspruch mehr.',
    cantonNote_BL: 'Nur für Haushalte mit mindestens einem minderjährigen oder in Erstausbildung stehenden Kind. Keine feste Einkommensgrenze: Die Wohngemeinde berechnet sie je Haushalt und zahlt aus. Mind. 2 Jahre Wohnsitz.',
    cantonNote_GE: 'Anspruch über die Mietbelastung (taux d’effort), nicht über eine feste Einkommensgrenze. Max. CHF 1’000 pro Zimmer, höchstens die halbe Miete. 2 Jahre ununterbrochen Wohnsitz in den letzten 5 Jahren; kein steuerbares Vermögen; nur HBM/HLM- oder vom Kanton anerkannte Wohnungen.',
    cantonNote_ZG: 'Nur für Wohnungen, die dem kantonalen Wohnraumförderungsgesetz unterstellt sind (bei der Verwaltung erfragen). Einkommen nach direkter Bundessteuer bis CHF 60’000 (+2’500 je minderjähriges Kind, +20’000 je volljährige Person ab der dritten); zwischen 50’000 und 60’000 nur bei Mietbelastung über 25 %. Reinvermögen bis CHF 144’000 (+16’900 je Kind). Mind. 3 Jahre Wohnsitz oder Arbeitsplatz im Kanton; der Beitrag geht an die Vermieterschaft.',
    ...
    docsTitle: { sie: 'Was Sie meist brauchen', du: 'Was du meist brauchst' },
    doc1: 'Mietvertrag',
  ...
  tour: {
    a11yLabel: 'Rundgang durch Maloja Plana',
    reopen: 'Rundgang neu starten',
    next: 'Weiter', back: 'Zurück', skip: 'Überspringen', later: 'Später', done: 'Fertig',
    welcome: { title: 'Willkommen bei Maloja Plana', text: { sie: 'Ihr ruhiger Ort für alles Schweizerische — Papiere, Budget, Versicherungen, Fristen. Ein kurzer Rundgang, jederzeit überspringbar.', du: 'Dein ruhiger Ort für alles Schweizerische — Papiere, Budget, Versicherungen, Fristen. Ein kurzer Rundgang, jederzeit überspringbar.' } },
    ...
    privacy: { title: 'Alles bleibt auf dem Gerät', text: { sie: 'Ihre Angaben bleiben auf diesem Gerät. Kein Konto, keine Cloud, kein Tracking.', du: 'Deine Angaben bleiben auf diesem Gerät. Kein Konto, keine Cloud, kein Tracking.' } },
    start: { title: { sie: 'Hier fangen Sie an', du: 'Hier fängst du an' }, text: 'Hier steht immer genau ein nächster Schritt. Alles andere hat Zeit.' },
    startAction: 'Mit «{name}» beginnen',
  },
  ...
  onboarding: {
    ...
    readyTitleGeneric: 'Alles ist eingerichtet.',
    ...
    readyNext: { sie: 'Auf der Übersicht wartet Ihr erster Schritt. Eins nach dem anderen.', du: 'Auf der Übersicht wartet dein erster Schritt. Eins nach dem anderen.' },
  ...
  behoerdenDossier: {
    ...
    jsonTexte: {
      ...
      annahmePartnerOhneDreizehnten: "Einkommen der zweiten Person ohne 13. Monatslohn gerechnet",
      annahmeAlleinverdiener: "Alleinverdiener-Ehepaar (Partnereinkommen 0)",
      annahmeEinzeln: "Konkubinat: für die Person allein gerechnet (Einzelbesteuerung)",
      annahmeKinderabzugKonkubinat: "Konkubinat mit Kindern: ganzer Kinderabzug bei der Person gerechnet (bei gemeinsamer elterlicher Sorge hälftig, ESTV-Kreisschreiben Nr. 30, Ziff. 14.8.1)",
      disclaimer: "Orientierung auf Grundlage der erfassten Angaben; ersetzt keine verbindliche Prüfung durch die zuständige Stelle.",
    },
  ...
  notfallkarte: {
    title: 'Notruf-Vorlesekarte',
    intro: { sie: 'Wenn etwas passiert, müssen Sie sich nichts merken. Diese Karte sagt Ihnen, was Sie sagen — und liest Ihre hinterlegten Angaben ab.', du: 'Wenn etwas passiert, musst du dir nichts merken. Diese Karte sagt dir, was du sagst — und liest deine hinterlegten Angaben ab.' },
    step1Title: 'Nummer wählen',
    step1Text: { sie: 'Tippen Sie auf eine Nummer, um anzurufen. Die 112 erreichen Sie mit dem Handy auch ohne Guthaben und über ein fremdes Netz — nicht aber ohne SIM-Karte.', du: 'Tippe auf eine Nummer, um anzurufen. Die 112 erreichst du mit dem Handy auch ohne Guthaben und über ein fremdes Netz — nicht aber ohne SIM-Karte.' },
    num_sani: 'Sanität',
    num_police: 'Polizei',
    num_fire: 'Feuerwehr',
    num_tox: 'Vergiftungen (Tox Info)',
    num_rega: 'Luftrettung (Rega)',
    num_euro: 'Europäischer Notruf',
    step1Note: { sie: 'Unsicher, welche? Rufen Sie 144 an — dort verbindet man Sie weiter.', du: 'Unsicher, welche? Ruf 144 — sie verbinden dich weiter.' },
    step2Title: { sie: 'Was Sie sagen', du: 'Was du sagst' },
    step2Text: { sie: 'Bleiben Sie ruhig. Sagen Sie es der Reihe nach:', du: 'Bleib ruhig. Sag es der Reihe nach:' },
    sayWhere: { sie: 'Wo sind Sie?', du: 'Wo bist du?' },
    sayWhereEmpty: { sie: 'sagen Sie, wo Sie sind', du: 'sag, wo du bist' },
    sayWhat: 'Was ist passiert?',
    sayHowMany: 'Wie viele Personen sind betroffen?',
    sayWho: { sie: 'Wer sind Sie?', du: 'Wer bist du?' },
    sayWhoEmpty: { sie: 'nennen Sie Ihren Namen und Ihre Nummer', du: 'nenn deinen Namen und deine Nummer' },
    step2Stay: { sie: 'Bleiben Sie am Telefon. Legen Sie erst auf, wenn die Leitstelle es sagt.', du: 'Bleib am Telefon. Leg erst auf, wenn die Leitstelle es sagt.' },
    locBtn: 'Adresse unsicher? Meinen Standort zeigen',
    locLoading: 'Standort wird ermittelt …',
    locAccuracy: 'Genauigkeit ±{m} m',
    locMapLink: 'In Karten-App öffnen',
    locNotStored: 'Wird nur jetzt geholt und nirgends gespeichert.',
    loc_denied: { sie: 'Standort-Freigabe abgelehnt — das ist ok. Sagen Sie einfach, wo Sie sind.', du: 'Standort-Freigabe abgelehnt — das ist ok. Sag einfach, wo du bist.' },
    loc_error: { sie: 'Standort liess sich nicht ermitteln. Sagen Sie einfach, wo Sie sind.', du: 'Standort liess sich nicht ermitteln. Sag einfach, wo du bist.' },
    loc_unsupported: { sie: 'Dieses Gerät kann den Standort hier nicht ermitteln. Sagen Sie einfach, wo Sie sind.', du: 'Dieses Gerät kann den Standort hier nicht ermitteln. Sag einfach, wo du bist.' },
    step3Title: { sie: 'Ihre Angaben zum Ablesen', du: 'Deine Angaben zum Ablesen' },
    step3Text: { sie: 'Sie müssen sich die Angaben nicht merken — lesen Sie sie ab, wenn Sie gefragt werden:', du: 'Du musst sie dir nicht merken — lies sie ab, wenn du gefragt wirst:' },
    step3Empty: 'Noch keine Notfall-Angaben hinterlegt. Schon Blutgruppe und ein Kontakt helfen.',
    step3EmptyLink: 'Notfall-Angaben ergänzen',
    dossierLink: 'Ganzes Notfall-Dossier (zum Ausdrucken)',
    footerCalm: { sie: 'Diese Karte liegt nur auf Ihrem Gerät — niemand sonst sieht sie.', du: 'Diese Karte liegt nur auf deinem Gerät — niemand sonst sieht sie.' },
  },
  notfallpass: {
    title: 'Notfallpass vorbereiten',
    intro: { sie: 'Das iPhone und manche Android-Telefone zeigen einen Notfallpass auf dem Sperrbildschirm — ohne Entsperren. Diese App kann ihn nicht selbst ausfüllen; Sie tragen die Angaben von Hand ein. Hier stehen sie dafür bereit, Feld für Feld.', du: 'Das iPhone und manche Android-Telefone zeigen einen Notfallpass auf dem Sperrbildschirm — ohne Entsperren. Diese App kann ihn nicht selbst ausfüllen; du trägst die Angaben von Hand ein. Hier stehen sie dafür bereit, Feld für Feld.' },
    datenschutz: { sie: 'Was im Notfallpass steht, kann lesen, wer Ihr Telefon in der Hand hält — ohne Code. Das ist gewollt: Im Notfall zählt, dass jemand die Angaben findet. Sie entscheiden, was Sie eintragen und was nicht.', du: 'Was im Notfallpass steht, kann lesen, wer dein Telefon in der Hand hält — ohne Code. Das ist gewollt: Im Notfall zählt, dass jemand die Angaben findet. Du entscheidest, was du einträgst und was nicht.' },
    angabenTitel: { sie: 'Ihre Angaben, Feld für Feld', du: 'Deine Angaben, Feld für Feld' },
    angabenText: { sie: 'Aus dem Kapitel Notfall übernommen, in der Reihenfolge der Apple-Hilfe. Übertragen Sie, was Sie möchten.', du: 'Aus dem Kapitel Notfall übernommen, in der Reihenfolge der Apple-Hilfe. Übertrag, was du möchtest.' },
    leer: { sie: 'Im Kapitel Notfall ist noch nichts erfasst. Sobald Sie dort etwas eintragen, steht es hier bereit.', du: 'Im Kapitel Notfall ist noch nichts erfasst. Sobald du dort etwas einträgst, steht es hier bereit.' },
    leerLink: 'Zum Kapitel Notfall',
    gruppe_profil: 'In den Gesundheitsinfos',
    gruppe_pass: 'Im Notfallpass',
    profilHinweis: { sie: 'Name und Geburtsdatum tragen Sie in der App «Health» ein: auf Ihr Bild tippen, dann «Gesundheitsprofil» und «Bearbeiten».', du: 'Name und Geburtsdatum trägst du in der App «Health» ein: auf dein Bild tippen, dann «Gesundheitsprofil» und «Bearbeiten».' },
    feld_name: 'Name',
    feld_geburtsdatum: 'Geburtsdatum',
    feld_erkrankungen: 'Erkrankungen',
    feld_medikamente: 'Medikamente',
    feld_allergien: 'Allergien',
    feld_blutgruppe: 'Blutgruppe',
    feld_kontaktName: 'Notfallkontakt: Name',
    feld_kontaktTelefon: 'Notfallkontakt: Telefon',
    nichtErfasst: 'noch nicht erfasst',
    kopieren: 'Kopieren',
    kopiertKurz: 'Kopiert',
    kopierenAria: '{feld} kopieren',
    kopiert: '{feld} kopiert.',
    kopierenFehler: { sie: 'Kopieren ging hier nicht. Sie können die Angabe markieren oder abschreiben.', du: 'Kopieren ging hier nicht. Du kannst die Angabe markieren oder abschreiben.' },
    iphoneTitel: 'Auf dem iPhone',
    iphone1: { sie: 'Öffnen Sie die App «Health», tippen Sie auf Ihr Bild und dann auf «Notfallpass».', du: 'Öffne die App «Health», tippe auf dein Bild und dann auf «Notfallpass».' },
    iphone2: { sie: 'Tippen Sie auf «Los gehts» oder «Bearbeiten» und tragen Sie die Angaben von oben ein.', du: 'Tippe auf «Los gehts» oder «Bearbeiten» und trag die Angaben von oben ein.' },
    iphone3: { sie: 'Unter «Notfallkontakte» auf «Notfallkontakt hinzufügen» tippen. Gewählt wird aus Ihren Kontakten — legen Sie die Person dort zuerst an, falls sie fehlt.', du: 'Unter «Notfallkontakte» auf «Notfallkontakt hinzufügen» tippen. Gewählt wird aus deinen Kontakten — leg die Person dort zuerst an, falls sie fehlt.' },
    iphone4: { sie: 'Nach unten scrollen, «Im Sperrzustand zeigen» einschalten und auf «Fertig» tippen.', du: 'Nach unten scrollen, «Im Sperrzustand zeigen» einschalten und auf «Fertig» tippen.' },
    iphoneSperr: 'So finden Helfende den Notfallpass: auf dem Sperrbildschirm nach oben streichen oder die Home-Taste drücken, «Notfall» tippen, dann «Notfallpass».',
    iphoneNotruf: 'Die Option «Notruf» teilt den Notfallpass während eines Notrufs automatisch — laut Apple nur in den USA und in Kanada.',
    iphoneLink: 'Apple-Hilfe: Notfallpass einrichten und anzeigen',
    iphoneUrl: 'https://support.apple.com/de-ch/guide/iphone/iph08022b192/ios',
    androidTitel: 'Auf Android',
    androidText: 'Nicht jedes Android-Telefon hat diese App. Wo es sie gibt (ab Android 12), heisst sie «Persönliche Sicherheit», in der App-Liste kurz «Sicherheit».',
    android1: { sie: 'Öffnen Sie die App «Sicherheit», melden Sie sich wenn nötig mit Ihrem Google-Konto an und tippen Sie auf «Meine Infos».', du: 'Öffne die App «Sicherheit», melde dich wenn nötig mit deinem Google-Konto an und tippe auf «Meine Infos».' },
    android2: 'Unter «Medizinische Daten» Blutgruppe, Allergien und Medikamente eintragen.',
    android3: { sie: 'Unter «Notfallkontakte» auf «Kontakt hinzufügen» tippen und die Person aus Ihren Kontakten wählen.', du: 'Unter «Notfallkontakte» auf «Kontakt hinzufügen» tippen und die Person aus deinen Kontakten wählen.' },
    android4: 'Unter «Zugriff auf Notfallinformationen» die Option «Anzeigen, wenn gesperrt» wählen.',
    androidLink: 'Android-Hilfe: Im Notfall Hilfe anfordern',
    androidUrl: 'https://support.google.com/android/answer/9319337?hl=de',
    dossierLink: 'Notfall-Dossier mit QR-Code (zum Ausdrucken)',
    dossierVerweis: 'Dieselben Angaben für den Notfallpass im Telefon vorbereiten',
    zurueck: 'Zurück zum Notfall',
    einstiegTitel: 'Notfallpass im Telefon vorbereiten',
    einstiegSub: { sie: 'Für den Sperrbildschirm: Ihre Angaben Feld für Feld zum Übertragen, mit den Schritten für iPhone und Android.', du: 'Für den Sperrbildschirm: deine Angaben Feld für Feld zum Übertragen, mit den Schritten für iPhone und Android.' },
    fussNichtsUebertragen: { sie: 'Dieses Blatt sendet nichts. Kopiert wird nur, wenn Sie auf «Kopieren» tippen.', du: 'Dieses Blatt sendet nichts. Kopiert wird nur, wenn du auf «Kopieren» tippst.' },
  },
  notfallDossier: {
    title: 'Notfall-Dossier',
  ...
  finanzUebersicht: {
    ...
    ipvVerfuegungOhneJahr: 'Verfügung ohne Jahr: höchstens der Verfügungsbetrag',
    ...
    tankEmpty: 'leer',
    tankFull: 'voll',
    tankOrientation: { sie: 'Sobald Ihre Ausgaben erfasst sind, zeigt die Tankanzeige, wie viele Monate Ihr Notgroschen trägt.', du: 'Sobald deine Ausgaben erfasst sind, zeigt die Tankanzeige, wie viele Monate dein Notgroschen trägt.' },
    tankReadoutEmpty: 'Noch kein Notgroschen erfasst — empfohlen sind {recommend} Monatsausgaben.',
  ...
  kvg: {
    ...
    mammografieSynthese: { sie: 'Die Grundversicherung deckt diesen Rhythmus. Ob Ihr Wohnkanton ein organisiertes Programm mit persönlicher Einladung hat, ist unterschiedlich — mehr dazu unten.', du: 'Die Grundversicherung deckt diesen Rhythmus. Ob dein Wohnkanton ein organisiertes Programm mit persönlicher Einladung hat, ist unterschiedlich — mehr dazu unten.' },
    ...
    mammoGeoCheck: 'Aktuelle Liste pro Kanton bei',
    ...
    tpwNote: 'Taxpunktwert variiert je nach Kanton. In den meisten Kantonen sind die Werte 2026 provisorisch festgesetzt — sie ändern sich, sobald ein Kanton den definitiven Tarif festlegt. Für {kantone} liegt (noch) kein belegter Wert 2026 vor; die App zeigt dort den Stand 2025.',
    ...
    tpwQuelleSZ: "Ärztegesellschaften; 0.85 für santéservices, vormals tarifsuisse; 0.86 für CSS und HSK",
    tpwQuelleGE: "gilt für CSS",
    tpwQuelleVD: "gilt für santéservices, vormals tarifsuisse",
    tpwQuelleLU: "gilt für santéservices, vormals tarifsuisse",
    tpwQuelleUR: "gilt für HSK",
    tpwQuelleStand: "Stand {datum}",
    tpwQuelleSeiten: "Amtl. Gesetzessammlung S. {seiten}",
    tpwErgebnisGruppe: "Belegt für Versicherte von {gruppe}; bei anderen Kassen kann der Wert abweichen.",
    tpwErgebnisGruppeSZ: "Belegt für Versicherte von santéservices; für CSS und HSK gilt in SZ 0.86.",
    tpwOhneKanton: "Ohne Kanton rechnet die App nicht — der Taxpunktwert ist je Kanton verschieden.",
    tpwOhneKantonProfil: "Ohne Wohnkanton im Profil rechnet die App hier nicht — der Taxpunktwert ist je Kanton verschieden.",
  ...
  po: {
    ...
    kreuzAchse: 'Gesundheitskosten pro Jahr',
    kreuzKosten: 'Kosten pro Jahr',
    kreuzLinie: 'Franchise {franchise}',
    kreuzBisher: 'bisher',
    kreuzHochrechnung: 'Hochrechnung',
    kreuzHochrechnungText: 'Hochgerechnet aufs ganze Jahr wären es rund CHF {value} — eine grobe Schätzung: Gesundheitskosten fallen oft ungleichmässig an.',
    kreuzOrientation: { sie: 'Sobald Sie Gesundheitskosten erfassen, zeigt ein Strich, wo Sie im Jahr stehen.', du: 'Sobald du Gesundheitskosten erfasst, zeigt ein Strich, wo du im Jahr stehst.' },
    kreuzTooltip: 'Bei CHF {c}: Franchise {low} ≈ CHF {tief} · Franchise {high} ≈ CHF {hoch}',
    kreuzAria: 'Gesamtkosten pro Jahr für Franchise {low} und {high}; die Linien kreuzen sich beim Break-even von CHF {be}.',
    ...
    compareFranchiseNote: 'Monatsprämien bei Franchise CHF {franchise} — günstigste zuerst. Für Details eine Kasse antippen.',
  ...
  instrumente: {
    ...
    tacho: 'Franchise-Kreuz',
    tachoSub: 'lohnt sich hoch oder tief?',
    kreuzPasst: { sie: 'Ihre Franchise passt (Schätzung)', du: 'Deine Franchise passt (Schätzung)' },
    kreuzPasstPolster: { sie: 'Ihre Franchise passt, Polster prüfen (Schätzung)', du: 'Deine Franchise passt, Polster prüfen (Schätzung)' },
    kreuzWechsel: 'Eher {franchise} (Schätzung, Prämien {jahr})',
    kreuzWechselPolster: 'Eher {franchise}, wenn das Polster reicht (Schätzung)',
  ...
  schutzschild: {
    ...
    bvgUnklar13: 'Pensionskasse: Pflicht ab einem Bruttojahreslohn von CHF {schwelle}. Mit einem 13. Monatslohn läge der Lohn darüber — die Angabe dazu fehlt noch (Kapitel Finanzen & Geld).',
  ...
  ipvStatus: {
    title: { sie: 'Ihr IPV-Weg', du: 'Dein IPV-Weg' },
    geschaetztLead: { sie: 'Die Zahl oben ist eine Schätzung. Wie die Verbilligung bei Ihnen läuft, hängt vom Kanton ab:', du: 'Die Zahl oben ist eine Schätzung. Wie die Verbilligung bei dir läuft, hängt vom Kanton ab:' },
    orientierungLead: { sie: 'Wie die Verbilligung bei Ihnen läuft, hängt vom Kanton ab:', du: 'Wie die Verbilligung bei dir läuft, hängt vom Kanton ab:' },
    wayAuto: { sie: 'Automatisch: Viele Kantone berechnen die Verbilligung aus Ihrer Steuererklärung — Sie müssen nichts tun, sondern nur auf die Verfügung achten.', du: 'Automatisch: Viele Kantone berechnen die Verbilligung aus deiner Steuererklärung — du musst nichts tun, sondern nur auf die Verfügung achten.' },
    wayApply: { sie: 'Antrag: In anderen Kantonen beantragen Sie sie selbst (siehe die Links unten).', du: 'Antrag: In anderen Kantonen beantragst du sie selbst (siehe die Links unten).' },
    markApplied: 'Ich habe beantragt',
    markConfirmed: 'Verfügung erhalten',
    appliedLabel: 'Beantragt',
    appliedLead: { sie: 'Sie haben die Verbilligung beantragt. Wenn die Verfügung kommt, halten Sie den bestätigten Betrag hier fest.', du: 'Du hast die Verbilligung beantragt. Wenn die Verfügung kommt, halte den bestätigten Betrag hier fest.' },
    stamp: 'bestätigt',
    confirmedLead: { sie: 'Das ist der Betrag aus Ihrer Verfügung — nicht mehr unsere Schätzung.', du: 'Das ist der Betrag aus deiner Verfügung — nicht mehr unsere Schätzung.' },
    betragPrompt: { sie: 'Tragen Sie den Betrag aus der Verfügung ein.', du: 'Trag den Betrag aus der Verfügung ein.' },
    betragLabel: 'Betrag laut Verfügung (CHF / Monat)',
    reminderTitle: 'Prämienverbilligung fürs nächste Jahr prüfen',
    renewLead: { sie: 'Die Verbilligung gilt pro Jahr. Sollen wir Sie nächstes Jahr ruhig daran erinnern?', du: 'Die Verbilligung gilt pro Jahr. Sollen wir dich nächstes Jahr ruhig daran erinnern?' },
    renewAdd: 'Jährlich erinnern',
    renewAdded: 'Erinnerung gesetzt',
    reset: 'Zurücksetzen',
    ohneJahrLead: 'Bei dieser Verfügung sind Kanton und Jahr nicht gespeichert. Bis sie zugeordnet ist, ziehen Budget und Finanzübersicht höchstens den Verfügungsbetrag ab — und nie mehr als die Schätzung.',
    zuordnenFrage: 'Gilt diese Verfügung für {kanton} {jahr}?',
    zuordnenJa: 'Ja, für {kanton} {jahr}',
    giltNicht: 'Verfügung für {kanton} {jahr} — gilt nicht für {aktKanton} {aktJahr}. Darum wird sie im Budget nicht abgezogen.',
    jahrLabel: 'Verfügung für das Jahr',
  },
  barKurz: { ipv: 'IPV', soz: 'Soz.' },
  beleg: {
    praemie: 'Prämie',
    ...
    verfuegungOhneJahr: 'Verfügung ohne Jahr',
    orientierung: 'Orientierung · ohne Betrag',
  ...
  schnellcheck: {
    ...
    intro: { sie: 'Ein Satz Angaben — was könnte Ihnen zustehen? Vieles steht Menschen zu, ohne dass sie davon wissen. Ihre Angaben aus dem Profil sind vorbelegt; Sie können sie hier frei anpassen, um durchzuspielen.', du: 'Ein Satz Angaben — was könnte dir zustehen? Vieles steht Menschen zu, ohne dass sie davon wissen. Deine Angaben aus dem Profil sind vorbelegt; du kannst sie hier frei anpassen, um durchzuspielen.' },
    income: 'Monatseinkommen (brutto)',
    rent: 'Miete / Monat',
    kk: 'Krankenkassen-Prämie / Monat',
    contextCanton: 'Kanton {canton} · Haushalt {size} Person(en).',
    contextNoCanton: 'Noch kein Kanton hinterlegt — für Prämienverbilligung und Sozialhilfe nötig.',
    adjustProfile: 'im Profil anpassen',
    ...
    ipvOhneBetragNote: 'Prüfenswert — ob ein Anspruch besteht und wie hoch er ist, legt der Kanton fest.',
    sozNote: 'Deckt die Lücke zum Existenzminimum (SKOS).',
    el: 'Ergänzungsleistungen (EL)',
    elNote: 'Bei AHV- oder IV-Rente, die nicht zum Leben reicht.',
    pruefen: 'prüfen',
    noResult: 'Mit diesen Angaben zeigt der Schnellcheck keinen klaren Geld-Anspruch — die Wege unten decken mehr ab, das meiste ist nicht allein vom Einkommen abhängig.',
    noResultNoCanton: { sie: 'Für Prämienverbilligung und Sozialhilfe fehlt der Kanton — tragen Sie ihn im Profil ein.', du: 'Für Prämienverbilligung und Sozialhilfe fehlt der Kanton — trag ihn im Profil ein.' },
    enterIncome: { sie: 'Tragen Sie Ihr Monatseinkommen ein, um zu sehen, was möglich ist.', du: 'Trag dein Monatseinkommen ein, um zu sehen, was möglich ist.' },
    kompassLeistungen: 'Leistungen',
    kompassWege: 'weitere Wege',
    kompassIdle: { sie: 'Geben Sie ein Einkommen ein, dann zeigt der Kompass, was Ihnen zusteht.', du: 'Gib ein Einkommen ein, dann zeigt der Kompass, was dir zusteht.' },
    kompassFound: '{n} mögliche Wege gefunden — stärkster: {top}.',
    kompassFoundOne: 'Ein möglicher Weg: {top}.',
    kompassNone: 'Über das Einkommen nichts Direktes — aber es gibt weitere Wege.',
    moreWays: 'Weitere Wege',
    lageTitle: 'Lage-abhängige Leistungen',
    lageIntro: 'Diese hängen nicht am Einkommen, sondern an einer Lebenslage:',
    lageIv: 'Invalidenversicherung (IV) — bei Krankheit oder Behinderung',
    lageAlv: 'Arbeitslosengeld (ALV) — bei Stellenverlust',
    lageEo: 'Erwerbsersatz (EO) — bei Dienst oder Mutterschaft',
    lageFamilienzulagen: 'Familienzulagen — mit Kindern',
    waySituationen: 'Lebenssituationen — versteckte Berechtigungen',
    wayStipendien: 'Stipendien & Ausbildungsbeiträge',
    wayMietzins: 'Mietzins-Beiträge prüfen',
    disclaimer: { sie: 'Grobe Orientierung, keine Zusicherung. Der genaue Anspruch hängt vom Kanton und Ihrer Situation ab — die verlinkten Rechner und Stellen prüfen im Detail.', du: 'Grobe Orientierung, keine Zusicherung. Der genaue Anspruch hängt vom Kanton und deiner Situation ab — die verlinkten Rechner und Stellen prüfen im Detail.' },
  },
  vr: {
    ...
    tabZukunft: 'Zukunft',
    zukunftIntro: { sie: 'Wie Ihr Vorsorge-Vermögen bis zur Pensionierung wachsen könnte — 2. Säule, 3a und 3b zusammen. Beträge aus «Finanzen», Rendite als Annahme.', du: 'Wie dein Vorsorge-Vermögen bis zur Pensionierung wachsen könnte — 2. Säule, 3a und 3b zusammen. Beträge aus «Finanzen», Rendite als Annahme.' },
    zukunftIkTitle: { sie: 'AHV-Grundlage: Ihre IK-Historie', du: 'AHV-Grundlage: deine IK-Historie' },
    zukunftIkAktiv: { sie: 'Diese Projektion nutzt Ihre erfasste IK-Historie als AHV-Fundament — {jahre} Beitragsjahre, Ø CHF {eink}.', du: 'Diese Projektion nutzt deine erfasste IK-Historie als AHV-Fundament — {jahre} Beitragsjahre, Ø CHF {eink}.' },
    zukunftIkInaktiv: { sie: 'Die AHV-Fläche im Graph beruht noch auf einer Schätzung. Erfassen Sie Ihre IK-Historie für eine genauere Grundlage.', du: 'Die AHV-Fläche im Graph beruht noch auf einer Schätzung. Erfasse deine IK-Historie für eine genauere Grundlage.' },
    zukunftIkEdit: 'IK-Historie bearbeiten',
    zukunftIkHide: 'IK-Historie ausblenden',
    zukunftIkJump: 'Im AHV-Reiter öffnen',
    ...
    altersHilfenTitle: { sie: 'Was Sie im Alter entlastet', du: 'Was dich im Alter entlastet' },
    altersHilfenIntro: { sie: 'Bei tiefer Rente steht Ihnen oft mehr zu, als viele wissen — hier lohnt sich ein Blick.', du: 'Bei tiefer Rente steht dir oft mehr zu, als viele wissen — hier lohnt sich ein Blick.' },
    altersHilfenRegional: 'Regional gibt es weitere Vergünstigungen — vergünstigte Tageskarten, Kultur- und Freizeitangebote (etwa über die KulturLegi) oder Ermässigungen der Gemeinde. Am besten bei Gemeinde und Kanton nachfragen.',
    altersHilfenCheck: 'Ansprüche durchspielen',
    altersKostenTitle: { sie: 'Was im Alter auf Sie zukommt', du: 'Was im Alter auf dich zukommt' },
    altersKostenIntro: { sie: 'Grobe Übersicht der Posten, mit denen im Alter zu rechnen ist — keine Beträge, die Höhe hängt stark von Ihrer Situation und dem Kanton ab.', du: 'Grobe Übersicht der Posten, mit denen im Alter zu rechnen ist — keine Beträge, die Höhe hängt stark von deiner Situation und dem Kanton ab.' },
    altersKostenK1: 'Krankenkasse & Franchise — Prämien laufen weiter und steigen oft; Franchise und Selbstbehalt fallen jedes Jahr an.',
    altersKostenK2: 'Zahnbehandlungen — von der Grundversicherung nicht gedeckt und im Alter häufig teurer.',
    altersKostenK3: 'Wohnen — Miete oder Hypothek laufen weiter; dazu manchmal ein altersgerechter Umbau.',
    altersKostenK4: 'Pflege & Betreuung — Spitex oder ein Heim können zum grössten Posten werden; teils durch Ergänzungsleistungen und Hilflosenentschädigung gedeckt.',
    altersKostenK5: 'Steuern — auch die Rente wird besteuert; beim Kapitalbezug fällt einmalig eine Steuer an (siehe unten).',
    zukunftRente: 'Voraussichtliche Monatsrente',
    ...
    zukunftRenteKapitalHinweis: { sie: '3a und 3b sind Kapital — hier vereinfacht als Monatsrente gezeigt (gleichmässig verteilt bis Alter {le}). Die tatsächliche Auszahlung bestimmen Sie selbst.', du: '3a und 3b sind Kapital — hier vereinfacht als Monatsrente gezeigt (gleichmässig verteilt bis Alter {le}). Die tatsächliche Auszahlung bestimmst du selbst.' },
    lebenserwartung: 'Lebenserwartung',
    lebenserwartungHint: 'Statistisch, ab 65 (BFS). Vorbelegt, anpassbar.',
    zukunftRenteHinweis: 'Die 2. Säule zählt entweder als Kapital (oben) oder als monatliche Rente (hier) — nicht beides.',
    zukunftAhvFlaeche: { sie: 'Die AHV-Fläche ist der geschätzte Barwert Ihrer AHV-Rente (kapitalisiert bis Alter {le}) — so wird die 1. Säule als Fundament sichtbar und mit den anderen Säulen vergleichbar.', du: 'Die AHV-Fläche ist der geschätzte Barwert deiner AHV-Rente (kapitalisiert bis Alter {le}) — so wird die 1. Säule als Fundament sichtbar und mit den anderen Säulen vergleichbar.' },
    ...
    zukunftSzenarioTitle: { sie: 'Was Ihr Rücktrittsalter bedeutet', du: 'Was dein Rücktrittsalter bedeutet' },
    zukunftSzenarioFrueh: 'Frühpension: {dauer} vor dem Referenzalter ({referenzalter}).',
    zukunftSzenarioReferenz: 'Ordentlicher Rücktritt zum Referenzalter ({referenzalter}) — volle AHV, kein Ab- oder Zuschlag.',
    zukunftSzenarioAufschub: 'Aufschub: {dauer} über das Referenzalter ({referenzalter}) hinaus.',
    zukunftSzenarioAhvFrueh: 'AHV bei Bezug ab {alter}: {pct} lebenslang (frühestens ab 63 beziehbar).',
    zukunftSzenarioAhvAufschub: 'AHV-Aufschub bis {alter}: {pct} lebenslang.',
    zukunftSzenarioBridge: { sie: 'Die Jahre von {von} bis 63 überbrücken Sie ohne AHV — etwa aus BVG-Rente oder 3a-Kapital.', du: 'Die Jahre von {von} bis 63 überbrückst du ohne AHV — etwa aus BVG-Rente oder 3a-Kapital.' },
    zukunftSzenarioSaeulen: { sie: 'BVG-Rente ist ab 58 möglich, 3a-Kapital ab 60 — je nach Reglement Ihrer Pensionskasse.', du: 'BVG-Rente ist ab 58 möglich, 3a-Kapital ab 60 — je nach Reglement deiner Pensionskasse.' },
    zukunftSzenarioWeiter: { sie: 'BVG und 3a wachsen weiter, solange Sie einzahlen (3a längstens bis 70).', du: 'BVG und 3a wachsen weiter, solange du einzahlst (3a längstens bis 70).' },
    szenarioJahr: 'Jahr',
    szenarioJahre: 'Jahre',
    szenarioMonat: 'Monat',
    ...
    verheiratet: 'Verheiratet oder in eingetragener Partnerschaft',
    ...
    erziehungsgutschrift: 'Erziehungs-/Betreuungsgutschrift',
    ...
    umwandlungssatzEigen: { sie: 'Umwandlungssatz Ihrer Pensionskasse', du: 'Umwandlungssatz Deiner Pensionskasse' },
    umwandlungssatzHint: { sie: 'Steht auf Ihrem PK-Ausweis · leer = Mindestsatz 6,8 %', du: 'Steht auf Deinem PK-Ausweis · leer = Mindestsatz 6,8 %' },
    umwandlungssatzEigenMarker: { sie: '(Ihre Pensionskasse)', du: '(Deine Pensionskasse)' },
    umwandlungssatzMindest: '(BVG-Mindestsatz)',
    ...
    ikUse: 'Diese Historie für die Rentenschätzung verwenden',
    ikSummary: 'Aus der Historie berechnet',
    ikBeitragsjahre: 'Beitragsjahre',
    ikDurchschnitt: 'Ø massgebendes Einkommen',
    ikJugendGenutzt: 'Jugendjahre zur Lückenfüllung genutzt',
    ikLuecken: 'Beitragslücken',
    ikAlvHinweis: 'In {n} ALV-Jahr(en) lief die AHV weiter, aber ohne BVG-Alterssparen — das kann eine BVG-Lücke bedeuten.',
    ikEditHint: 'Eine Phase antippen, um einzelne Jahre zu ändern.',
    ikReset: 'Zurücksetzen',
    ikFromIk: 'aus IK-Auszug',
    ikDisclaimer: 'Schätzung — massgebend ist der echte IK-Auszug der Ausgleichskasse (kostenlos bestellbar).',
    ikYear: 'Jahr',
    ikIncome: 'Einkommen',
    ikTypErwerb: 'Erwerbstätigkeit',
    ikTypJugendjahre: 'Jugendjahre',
    ikTypAlv: 'Arbeitslosigkeit (ALV)',
    ikTypErziehung: 'Erziehungsjahre',
    ikTypBetreuung: 'Betreuung (Angehörige)',
    ikTypLuecke: 'Beitragslücke',
    // Kapitalbezugssteuer (Vorsorgekapital als Kapital statt Rente beziehen)
    kbTitle: 'Steuer beim Kapitalbezug',
    kbIntro: 'Wird die 2. Säule oder 3a als Kapital statt als Rente bezogen, fällt einmalig eine gesonderte Steuer an — getrennt vom übrigen Einkommen, zu einem reduzierten Tarif.',
    kbCanton: 'Kanton',
    kbCantonNone: 'Kanton wählen …',
    kbBasisHint: 'Schätzung am Kantonshauptort, ledig, ohne Kirchensteuer.',
    kbOnCapital: 'Auf dem voraussichtlichen Kapital von CHF {betrag}',
    kbEffective: 'effektiv {pct}%',
    kbExact: 'exakt',
    kbFederal: 'Bund',
    kbCantonal: 'Kanton + Gemeinde',
    kbNet: 'Netto nach Steuer',
    kbRange: 'Am günstigsten {minK}, am teuersten {maxK}.',
    kbPickCanton: 'Kanton wählen für die Gesamt-Schätzung — ohne Kanton ist nur der Bundesanteil sichtbar.',
    kbStaffelTitle: 'Gestaffelt beziehen',
    kbStaffelYears: 'über {n} Steuerjahre',
    kbStaffelResult: 'CHF {total} statt CHF {einmal} — Ersparnis rund CHF {ersparnis}.',
    kbStaffelNone: 'Bei diesem Betrag bringt die Staffelung kaum etwas.',
    kbStaffelHint: 'Weil der Tarif progressiv ist, senkt das Aufteilen des Bezugs auf mehrere Steuerjahre die Steuer — etwa über mehrere 3a-Konten oder 2. Säule und 3a in verschiedenen Jahren. Grenzen: meist sind nur wenige Konten sinnvoll, und einzelne Kantone zählen Bezüge desselben Jahres (auch die des Ehepartners) zusammen.',
    kbDisclaimer: 'Grobe Orientierung, keine verbindliche Berechnung. Massgebend ist der amtliche Steuerrechner des Kantons.',
    kbOfficialLink: 'Amtlicher ESTV-Steuerrechner',
    kbSource: 'Bund exakt nach [[DBG Art. 38|https://www.fedlex.admin.ch/eli/cc/1991/1184_1184_1184/de]] (ein Fünftel des Tarifs). Kantonswerte: finpension Kapitalbezugssteuer-Vergleich 2026, Hauptort, approximativ. Stand 2026.',
  },
  ...
  eo: {
    ...
    nettoHint: 'Das hinterlegte Einkommen ist als Netto markiert — für die EO bitte das Bruttojahreseinkommen eintragen.',
    ...
    hinweisBetreuung: 'Betreuung eines wegen Krankheit oder Unfall schwer beeinträchtigten Kindes: höchstens 98 Taggelder innerhalb von 18 Monaten (rund 14 Wochen Urlaub). Sind beide Eltern erwerbstätig, steht jedem höchstens die Hälfte zu (in der Regel 49), jeweils nach dem eigenen Einkommen — eine andere Aufteilung ist möglich. Das Total gilt für alle 98 Taggelder.',
    betreuungDauer: 'bis {n} Taggelder',
  ...
  sh: {
    ...
    erwachseneHint: 'Antragstellende Person und, bei Ehe oder eingetragener Partnerschaft, die Partnerin oder der Partner.',
    jungeErwachseneHint: 'Unter 25 kann der Grundbedarf je nach Kanton tiefer sein — bitte bei der Sozialbehörde nachfragen.',
    weiterePersonen: 'Weitere Personen im Haushalt',
    weiterePersonenHint: 'Wer mitwohnt, aber nicht mitunterstützt wird — z. B. im Konkubinat, in einer WG oder erwachsene Kinder.',
    wohnform: 'Wie wird der Haushalt geführt?',
    wohnformFamilienaehnlich: 'Gemeinsam — z. B. Konkubinat oder Familie',
    wohnformZweckWg: 'Getrennt — jede Person führt ihren Haushalt selbst (Wohngemeinschaft)',
    wohnformHint: 'Gemeinsam geführt: Grundbedarf als Anteil am ganzen Haushalt. Getrennt geführte WG: Grundbedarf der unterstützten Personen minus 10 %. In der Regel rechnet die Sozialbehörde mit «gemeinsam», die getrennte Haushaltsführung ist nachzuweisen — die Praxis ist kantonal verschieden.',
    mieteAnteilHint: 'Im geteilten Haushalt nur den eigenen Anteil an Miete und Nebenkosten eintragen.',
    gblAnteil: 'Anteil {einheit} von {haushalt} Pers.',
    gblZweckWg: '{einheit} Pers., WG −10 %',
    ...
    erwerbsunkostenHint: 'Belegte Kosten, die wegen der Arbeit anfallen: auswärtige Verpflegung (8–10 Franken pro Mahlzeit), der Arbeitsweg, soweit er über den Nahverkehr hinausgeht, ein Auto nur, wenn es mit dem öffentlichen Verkehr nicht zumutbar geht, Prämien der Unfallversicherung (UVG). Sie erhöhen den Bedarf (SKOS C.6.3).',
  ...
  dl: {
    ...
    shelfAmtlich: 'Amtliche Stellen & Anträge',
    shelfRat: 'Rat, Schutz & Mitwirkung',
    shelfPersoenlich: 'Persönlich',
    ...
    sicherTitle: 'Sichere Kanäle',
    mitredenTitle: 'Mitreden',
  ...
  langSkill: {
    ...
    level: 'Niveau',
    hint: 'Mehrere Sprachen mit ihrem Niveau erfassen (Europäischer Referenzrahmen).',
  ...
  alv: {
    title: "Arbeitslosenentschädigung",
    intro: { sie: "Eine Orientierung, was Ihnen bei Arbeitslosigkeit als Taggeld zustehen könnte. Verbindlich rechnet das RAV bzw. Ihre Arbeitslosenkasse.", du: "Eine Orientierung, was Dir bei Arbeitslosigkeit als Taggeld zustehen könnte. Verbindlich rechnet das RAV bzw. Deine Arbeitslosenkasse." },
    bruttolohn: "Bisheriger Bruttolohn pro Monat (CHF)",
    bruttolohnHint: { sie: "Ihr AHV-pflichtiger Bruttolohn der letzten 6 Monate. Versichert sind max. CHF 12’350/Monat.", du: "Dein AHV-pflichtiger Bruttolohn der letzten 6 Monate. Versichert sind max. CHF 12’350/Monat." },
    bruttoNettoHint: "Das hinterlegte Einkommen ist als Netto markiert — für die ALV bitte den Bruttolohn eintragen.",
    beitragsmonate: "Beitragsmonate",
    beitragsmonateHint: { sie: "Wie viele Monate haben Sie in den letzten 2 Jahren gearbeitet? Ab 12 Monaten besteht meist Anspruch.", du: "Wie viele Monate hast Du in den letzten 2 Jahren gearbeitet? Ab 12 Monaten besteht meist Anspruch." },
    ...
    enterBrutto: { sie: "Geben Sie Ihren bisherigen Bruttolohn ein, um die Orientierung zu sehen.", du: "Gib Deinen bisherigen Bruttolohn ein, um die Orientierung zu sehen." },
    ...
    resultTitle: { sie: "Ihre Orientierung", du: "Deine Orientierung" },
    ...
    anspruchUnklar: "Unter 12 Monaten Beitragszeit in den letzten zwei Jahren meist kein Anspruch. Es gibt Ausnahmen: Wer wegen Trennung, Scheidung, Invalidität oder Tod der Ehepartnerin oder des Ehepartners (auch in eingetragener Partnerschaft) eine Stelle suchen muss und damals in der Schweiz wohnte, kann von der Beitragszeit befreit sein — bis zu 90 Taggelder, wenn das Ereignis höchstens ein Jahr zurückliegt (AVIG Art. 14 Abs. 2, Art. 27 Abs. 4). Befreiungen gibt es auch nach Ausbildung, Krankheit oder Wegfall einer IV-Rente. Die Arbeitslosenkasse klärt es ab.",
    gedeckeltHint: "Verdienst über CHF {max}/Monat wird auf das Maximum gedeckelt.",
    disclaimer: { sie: "Orientierung ohne Gewähr. Verbindlich rechnet das RAV bzw. die Arbeitslosenkasse — abhängig von Ihrer konkreten Situation.", du: "Orientierung ohne Gewähr. Verbindlich rechnet das RAV bzw. die Arbeitslosenkasse — abhängig von Deiner konkreten Situation." },
    ravTitle: { sie: "Wo Sie sich anmelden", du: "Wo Du Dich anmeldest" },
    ravBody: { sie: "Melden Sie sich so früh wie möglich beim RAV (Regionales Arbeitsvermittlungszentrum) — am besten am ersten Tag der Arbeitslosigkeit. Der Anspruch beginnt nicht rückwirkend.", du: "Melde Dich so früh wie möglich beim RAV (Regionales Arbeitsvermittlungszentrum) — am besten am ersten Tag der Arbeitslosigkeit. Der Anspruch beginnt nicht rückwirkend." },
    cantonLink: { sie: "Ihr Kanton: {canton} → RAV und Anlaufstellen finden", du: "Dein Kanton: {canton} → RAV und Anlaufstellen finden" },
  },
  alimentInfo: {
