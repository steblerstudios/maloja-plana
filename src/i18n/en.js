export default {
  ...
  tax: {
    ...
    disclaimer: 'This calculation shows only the direct federal tax (DBG Art. 36). Cantonal and municipal taxes are additional. Please check with your cantonal tax authority for exact amounts.',
