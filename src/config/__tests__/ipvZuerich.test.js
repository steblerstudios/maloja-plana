...
// Erweitert 20.09.2026 um BE und VD (zweiter und dritter Kanton mit eigenem Modell):
// unverändert bleiben jetzt 23 der 26 Kantone, nicht mehr 25 oder 24.
const EIGENES_MODELL = ['ZH', 'BE', 'VD'];

describe('K31 Regression: alle Kantone ausser ZH, BE und VD rechnen exakt wie v0.1.37-beta', () => {
  const haushalte = [
