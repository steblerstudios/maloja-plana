export default {
  ...
  kvg: {
    ...
    gynaekoEmpfehlung: 'International recommendation (WHO, 2021): an HPV test every 5–10 years from age 30 — i.e. less often than Swiss practice. Basic insurance covers screening at the recommended interval.',
    gynaekoQuelle: 'Source: WHO guideline on cervical cancer screening, 2021.',
    ...
    mammografieEmpfehlung: 'International recommendation (WHO/EU): every 2 years for women aged 50–74. Basic insurance covers this interval.',
    mammografieQuelle: 'Source: WHO / EU guidelines on breast cancer screening.',
    darmkrebs: 'Colorectal cancer screening',
    darmkrebsNote: 'Colonoscopy from age 50, every 10 years.',
    darmkrebs10j: 'Every 10 years',
    darmkrebsEmpfehlung: 'International recommendation (EU): a stool test every 2 years or a colonoscopy every 10 years (ages 50–74). Basic insurance covers this interval.',
