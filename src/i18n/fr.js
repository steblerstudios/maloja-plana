export default {
  ...
  todesfall: {
    ...
    step3Text: 'Annoncez le décès à la caisse de compensation AVS et à la caisse de pension — les survivants ont souvent droit à une rente de veuve, de veuf ou d’orphelin. Informez aussi la caisse maladie, l’assurance-vie et la banque. Beaucoup de cela dispose de quelques semaines.',
    step3Link: 'Voir la prévoyance',
  ...
  heirat: {
    ...
    step1Text: 'Avant le mariage, l’office de l’état civil mène une procédure préparatoire. Annoncez-vous tôt et tenez prêts pièces d’identité, attestation de domicile et, selon l’origine, d’autres documents. Pour les ressortissants étrangers, cela peut prendre plus de temps.',
    ...
    step3Title: '3 · Impôts',
    step3Text: 'Les couples mariés et les partenaires enregistrés sont taxés en commun — pour toute l’année dès l’année du mariage. Cela peut modifier la charge fiscale. Qui est imposé à la source devrait faire adapter son barème.',
