...
**ACHTUNG:** Die "Family feedback (domain expert)"-Einträge F-008 bis F-013 könnten von Mutter stammen (BVG-Kontinuität, UVG/KTG, Selbständigkeit, Retirement, AHV-Admin). Das ist aber nicht explizit zugeordnet. Sophie muss klären, ob das Mutter-Feedback ist oder von einer anderen Person.
...
Sophie muss das Feedback von Mutter manuell rekonstruieren und in feedback-log.md eintragen. Ohne das fehlt eine der wichtigsten Feedback-Quellen.
...
```
WP-1 (Mutter-Feedback)     → Sofort (Sophie, manuell)
...
| 5 | Export-Richtung | product-memory-registry.md listet "PDF, JSON, YAML, CSV, DOCX, ZIP, LaTeX" als Formate. Sophie sagt "kein Sackmesser". Widerspruch zwischen Format-Breite und Calm-Export. |
