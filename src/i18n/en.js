export default {
  ...
  legal: {
    ...
    ethics: {
      ...
      sustainSource: 'Source for the Infomaniak information: infomaniak.com/en/about, infomaniak.com/en/ecology, infomaniak.com/en/ecology/certificates-rewards (the provider\'s own information, retrieved 17.09.2026).',
  ...
  kvg: {
    ...
    tpwNote: 'Tax point value varies by canton. The 2026 values are provisional almost everywhere — they change once a canton sets the definitive tariff. For {kantone} there is (still) no officially documented 2026 value; the app shows the 2025 level there.',
