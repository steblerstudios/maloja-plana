export default {
  ...
  ipvStatus: {
    title: 'Tia via da reducziun da premis',
    geschaetztLead: 'La cifra survart è ina stima. Co che la reducziun funcziunescha per tai dependa dal chantun:',
    wayAuto: 'Automatic: blers chantuns quintan la reducziun a partir da tia decleraziun da taglia — ti na stos far nagut, mabain mo spetgar la decisiun.',
    wayApply: 'Dumonda: en auters chantuns la dumondas ti sez (guarda ils links sutvart).',
    markApplied: 'Jau hai fatg la dumonda',
    markConfirmed: 'Decisiun retschavida',
    appliedLabel: 'Dumandà',
    appliedLead: 'Ti has dumandà la reducziun. Cur che la decisiun arriva, nota qua la summa confermada.',
    stamp: 'confermà',
    confirmedLead: 'Quai è la summa da tia decisiun — betg pli nossa stima.',
    betragPrompt: 'Endatescha la summa da la decisiun.',
    betragLabel: 'Summa tenor la decisiun (CHF / mais)',
    reminderTitle: 'Controllar la reducziun da premis per l’onn proxim',
    renewLead: 'La reducziun vala per in onn. Vulains nus ta regordar cun calma l’onn proxim?',
  ...
  schnellcheck: {
    ...
    ipvSubsumed: 'La reducziun da premis (~{amount}) è gia includida qua — ella vegn retratga l’emprim.',
