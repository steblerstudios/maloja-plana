  ...
  return [
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'residenceType', label: fl(t, 'wohnen', 'residenceType'), type: 'select', options: opts(t, 'wohnen', 'residenceType'), secondary: true },
      ],
      docs: [
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'monthlyTax', label: fl(t, 'finanzen', 'monthlyTax'), type: 'currency', hint: hn(t, 'finanzen', 'monthlyTax'), section: t('sections.finanzen.budgetLight') },
        ...
        { k: 'debtPayments', label: fl(t, 'finanzen', 'debtPayments'), type: 'currency', hint: hn(t, 'finanzen', 'debtPayments'), section: t('sections.finanzen.obligations') },
