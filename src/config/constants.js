  ...
  return [
    {
      ...
      fields: [
        { k: 'firstName', label: fl(t, 'basis', 'firstName'), type: 'text', required: true, section: t('sections.basis.person'), sectionIntro: si(t, 'basis', 'person') },
        ...
        { k: 'phone', label: fl(t, 'basis', 'phone'), type: 'tel', placeholder: ph(t, 'basis', 'phone'), section: t('sections.basis.contact'), sectionIntro: si(t, 'basis', 'contact') },
    ...
    },
    {
      ...
      fields: [
        { k: 'address', label: fl(t, 'wohnen', 'address'), type: 'text', section: t('sections.wohnen.address'), sectionIntro: si(t, 'wohnen', 'address') },
    ...
    },
    {
      ...
      fields: [
        { k: 'monthlyIncome', label: fl(t, 'finanzen', 'monthlyIncome'), type: 'currency', hint: hn(t, 'finanzen', 'monthlyIncome'), section: t('sections.finanzen.income'), sectionIntro: si(t, 'finanzen', 'income'), orientation: or(t, 'einkommen') },
    ...
    },
    {
      ...
      fields: [
        { k: 'kkInsurer', label: fl(t, 'versicherungen', 'kkInsurer'), type: 'text', placeholder: ph(t, 'versicherungen', 'kkInsurer'), section: t('sections.versicherungen.basic'), sectionIntro: si(t, 'versicherungen', 'basic'), orientation: or(t, 'kvg') },
    ...
    },
    {
      ...
      fields: [
        { k: 'cantoneOfTaxation', label: fl(t, 'behoerden', 'cantoneOfTaxation'), type: 'select', options: cantonOptions(t), section: t('sections.behoerden.taxes'), sectionIntro: si(t, 'behoerden', 'taxes'), orientation: or(t, 'steuerverwaltung') },
    ...
    },
    {
      ...
      fields: [
        { k: 'emergencyContact', label: fl(t, 'notfall', 'emergencyContact'), type: 'text', required: true, section: t('sections.notfall.contact'), sectionIntro: si(t, 'notfall', 'contact') },
