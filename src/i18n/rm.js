export default {
  ...
  kvg: {
    ...
    mammoGeoNote: 'Betg dapertut envida il chantun per brev a la mammografia e surpiglia ils custs (senza franchisa e quota da partiziun). Nua ch’i n’exista nagin program, s’organisescha la prevenziun sez — suenter ina prescripziun medicinala.',
    ...
    mammoGeoWandel: 'La situaziun sa mida — Lucerna, per exempel, ha dapi il 2026 in nov program.',
