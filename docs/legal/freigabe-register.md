...
| 12 | **KVG-Leistungen, Franchise, Selbstbehalt** — `KVGLeistungen.jsx`, Franchise-Tacho → `src/data/kvgLeistungen.js` | keine dokumentiert | KVG Art. 25–31, Art. 64 (Abs. 6), KLV (`:1–2, :146`) | `KVG_DATA_VERSION = '2026-06'`; Taxpunktwerte «Stand 2025» (`:39`); Mammografie «Stand 07.2026» (`:148`) · `0b90af1` 12.07.2026 | Taxpunktwert je Kanton; Mammografie-Programm 18 Kantone mit, 8 ohne | ⚠️ Taxpunktwerte 2025; ⚠️ Generika-Selbstbehalt nicht belegt (`voll-review…:87–88`) |
