export default {
  ...
  pflege: {
    ...
    step1Text: 'Wer regelmässig nahe Angehörige pflegt, kann eine Betreuungsgutschrift erhalten — sie hebt die spätere AHV-Rente (gleicher Betrag wie die Erziehungsgutschrift). Wichtig: jährlich bei der Ausgleichskasse anmelden, sonst verfällt sie.',
    ...
    entl: {
      ...
      month: 'Monat',
      year: 'Jahr',
      rateNote: 'gerechnet mit ca. CHF 37.90/h',
  ...
  iv: {
    ...
    step2Text: { sie: 'Zeichnet sich ab, dass die Einschränkung länger dauert, melden Sie sich früh bei der IV (Früherfassung). Die IV setzt zuerst auf Eingliederung — „Eingliederung vor Rente“. Je früher die Anmeldung, desto besser; die IV zahlt frühestens sechs Monate danach.', du: 'Zeichnet sich ab, dass die Einschränkung länger dauert, melde dich früh bei der IV (Früherfassung). Die IV setzt zuerst auf Eingliederung — „Eingliederung vor Rente“. Je früher die Anmeldung, desto besser; die IV zahlt frühestens sechs Monate danach.' },
  ...
  bewilligung: {
    ...
    step3Text: { sie: 'Adresswechsel, Stellenwechsel oder eine Heirat müssen Sie dem Migrationsamt melden — das gehört zu den Pflichten der Bewilligung. Eine späte Meldung kann Probleme machen.', du: 'Adresswechsel, Stellenwechsel oder eine Heirat musst du dem Migrationsamt melden — das gehört zu den Pflichten der Bewilligung. Eine späte Meldung kann Probleme machen.' },
    step3Link: 'Umzug-Ablauf ansehen',
    step4Title: '4 · Weiterdenken: C-Bewilligung',
    step4Text: { sie: 'Nach fünf bis zehn Jahren ununterbrochenem Aufenthalt können Sie je nach Nationalität die Niederlassungsbewilligung (C) beantragen — sie ist unbefristet und sicherer. Wichtig sind dabei die Integrationskriterien wie Sprache, Arbeit und keine Sozialhilfeabhängigkeit. Gut zu wissen: Die Prämienverbilligung (IPV) ist eine normale Unterstützung, keine Sozialhilfe — sie zählt nicht gegen Ihre Bewilligung. Lassen Sie aus Sorge kein Geld liegen, das Ihnen zusteht.', du: 'Nach fünf bis zehn Jahren ununterbrochenem Aufenthalt kannst du je nach Nationalität die Niederlassungsbewilligung (C) beantragen — sie ist unbefristet und sicherer. Wichtig sind dabei die Integrationskriterien wie Sprache, Arbeit und keine Sozialhilfeabhängigkeit. Gut zu wissen: Die Prämienverbilligung (IPV) ist eine normale Unterstützung, keine Sozialhilfe — sie zählt nicht gegen deine Bewilligung. Lass aus Sorge kein Geld liegen, das dir zusteht.' },
  ...
  fuehrerausweis: {
    ...
    step4Text: 'Wer die Fahrprüfung besteht, bekommt den Führerausweis zuerst auf Probe — für drei Jahre. In dieser Zeit gehört ein Weiterbildungskurs (WAB) dazu; danach wird der Ausweis unbefristet. Wird der Kurs versäumt, verfällt der Ausweis.',
  ...
  kind: {
    ...
    step4Text: { sie: 'Mütter haben Anspruch auf 14 Wochen Mutterschaftsentschädigung, der andere Elternteil auf 2 Wochen — beides über die EO. Denken Sie früh an die Kinderbetreuung (Kita, Tagesfamilie) und an die Steuerabzüge dafür.', du: 'Mütter haben Anspruch auf 14 Wochen Mutterschaftsentschädigung, der andere Elternteil auf 2 Wochen — beides über die EO. Denk früh an die Kinderbetreuung (Kita, Tagesfamilie) und an die Steuerabzüge dafür.' },
  ...
  pensionierung: {
    ...
    step1Text: { sie: 'Die AHV-Rente kommt nicht automatisch — Sie müssen sie bei Ihrer Ausgleichskasse anmelden, idealerweise drei bis sechs Monate vor der Pensionierung. Das Referenzalter liegt bei 65 Jahren; ein Vorbezug ist möglich, kürzt die Rente aber lebenslang.', du: 'Die AHV-Rente kommt nicht automatisch — du musst sie bei deiner Ausgleichskasse anmelden, idealerweise drei bis sechs Monate vor der Pensionierung. Das Referenzalter liegt bei 65 Jahren; ein Vorbezug ist möglich, kürzt die Rente aber lebenslang.' },
  ...
  notfallkarte: {
    ...
    step1Text: { sie: 'Tippen Sie auf eine Nummer, um anzurufen. 112 funktioniert auch ohne Guthaben oder SIM-Karte.', du: 'Tippe auf eine Nummer, um anzurufen. 112 funktioniert auch ohne Guthaben oder SIM-Karte.' },
    num_sani: 'Sanität',
    num_police: 'Polizei',
    num_fire: 'Feuerwehr',
