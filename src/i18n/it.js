export default {
  ...
  po: {
    ...
    noInsurerHint: 'Inserisci la tua cassa malati alla voce «Assicurazioni» per vedere il tuo premio di riferimento.',
    insurerNotFound: '«{name}» non riconosciuto',
    insurerNotFoundHint: 'Il nome non corrisponde a nessun assicuratore autorizzato. Verifica l\'ortografia.',
    comparison: 'Confronto premi',
    yourPremium: 'Il tuo premio: CHF {amount}/mese',
    refPremium: 'Premio di riferimento UFSP (franchigia {franchise}): CHF {amount}/mese',
    premiumAbove: 'Il tuo premio supera il riferimento di CHF {diff}. Valuta modelli alternativi.',
    premiumBelow: 'Il tuo premio è inferiore al riferimento di CHF {diff}.',
    ...
    disclaimer: 'Solo premi di riferimento. I premi effettivi possono variare — fa fede la polizza del tuo assicuratore.',
  },
  ...
  vr: {
    ...
    saeule3aHint: 'Inserisci il tuo avere 3a e il versamento annuale sotto Finanze → Previdenza.',
    totalMitSaeule3a: 'Totale 1° + 2° + 3a pilastro',
    einkommenEingeben: 'Inserisci il tuo reddito annuo per stimare la rendita.',
    ...
    fzTitle: 'Cosa succede al tuo LPP quando cambi lavoro?',
    fzIntro: 'Quando lasci il tuo impiego, il tuo avere previdenziale non viene versato — viene trasferito su un conto di libero passaggio fino al prossimo impiego.',
    fzScenarioJob: 'Nuovo impiego entro 30 giorni',
    fzScenarioJobText: 'Il tuo avere viene trasferito automaticamente alla nuova cassa pensione. Non devi fare nulla.',
    fzScenarioGap: 'Interruzione tra due impieghi',
    fzScenarioGapText: 'Il tuo avere va su un conto di libero passaggio (banca o assicurazione). Scegli tu il fornitore. Dopo 6 mesi senza notizie, la cassa trasferisce all\'Istituto collettore.',
    fzScenarioSelf: 'Attività indipendente',
    fzScenarioSelfText: 'Puoi prelevare il tuo avere in contanti entro 1 anno — ma solo con attestazione di indipendenza (conferma AVS).',
  ...
  eo: {
    ...
    einkommenEingeben: 'Inserisci il tuo reddito annuo per calcolare l\'indennità.',
    erklaerung: 'Il calcolatore mostra la tua indennità giornaliera e l\'indennità totale per maternità (14 settimane), paternità (2 settimane), adozione (2 settimane) e congedo di assistenza (14 settimane).',
  ...
  alv: {
    ...
    intro: "Un orientamento su quanto potresti ricevere come indennità giornaliera in caso di perdita del lavoro. Il calcolo vincolante è fatto dall'URC e dalla tua cassa di disoccupazione.",
    bruttolohn: "Salario lordo mensile precedente (CHF)",
    bruttolohnHint: "Il tuo salario lordo soggetto all'AVS degli ultimi 6 mesi. Massimo assicurato: CHF 12’350/mese.",
  ...
  stip: {
    ...
    checkScopeQ: "La tua formazione",
    checkStatusOnlyEducation: "In Svizzera solo per la formazione",
    checkScopeOther: "Altro / formazione continua",
    resultEligible: "Soddisfi i requisiti di base armonizzati. Presenta la domanda all'ufficio borse del tuo cantone di domicilio (o di quello dei genitori) — il cantone fissa gli importi e i limiti esatti.",
    ...
    resultScopeOther: "Per le seconde formazioni e la formazione continua valgono regole più severe. Chiarisci il tuo caso direttamente con l'ufficio cantonale delle borse.",
    ...
    where: 'Presenta una domanda formale all’ufficio borse di studio del tuo cantone — di norma è competente il cantone di domicilio dei tuoi genitori.',
    cantonalLink: 'Uffici cantonali borse di studio (elenco CDPE)',
    yourCanton: 'Il tuo cantone: {canton}',
