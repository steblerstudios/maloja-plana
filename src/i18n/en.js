export default {
  ...
  tax: {
    ...
    bandKonkubinatKinderabzugHaelftig: "Maloja shows no amount for cantonal and municipal tax here: with joint parental custody and no maintenance payments for the child, this canton splits the child deduction equally between the parents, even if only one of them earns. Maloja's table and the FTA tax calculator put the whole deduction with you and would therefore show the tax too low. The binding amount is in the tax assessment; the cantonal tax administration can advise.",
