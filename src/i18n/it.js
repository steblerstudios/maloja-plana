export default {
  ...
  legal: {
    ...
    privacy: {
      ...
      backupTitle: 'Backup',
      backup1: { sie: 'I backup vengono salvati localmente nel browser. Può esportare i Suoi dati come file in qualsiasi momento (JSON o CSV, crittografato se desiderato). Questo file lascia il Suo dispositivo solo se lo condivide attivamente.', du: 'I backup vengono salvati localmente nel browser. Puoi esportare i tuoi dati come file in qualsiasi momento (JSON o CSV, crittografato se desiderato). Questo file lascia il tuo dispositivo solo se lo condividi attivamente.' },
    ...
    faq: {
      ...
      a1: 'Tutti i dati restano sul tuo dispositivo nella memoria del browser (localStorage). Nulla viene inviato a un server. Se cancelli la memoria del browser, i dati vengono persi — salvali quindi regolarmente in un file (Strumenti → Esportazione).',
      ...
      a5: 'Sì. Sotto Strumenti → Esportazione puoi scaricare i tuoi dati in qualsiasi momento come file (JSON o CSV, crittografato se desiderato). Il backup contiene tutti i capitoli, documenti e impostazioni.',
      ...
      a7: 'Crea un backup sotto Strumenti → Esportazione (JSON o crittografato) e importalo sul nuovo dispositivo. Non c\'è sincronizzazione automatica per scelta — richiederebbe un server.',
