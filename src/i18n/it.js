export default {
  ...
  dashboard: {
    ...
    highlightSozialhilfeSub: { sie: 'CHF 1\'031/mese fabbisogno base (1 persona) — dove si trova?', du: 'CHF 1\'031/mese fabbisogno base (1 persona) — dove ti trovi?' },
  ...
  legal: {
    ...
    resources: {
      ...
      ombuds1: 'Ombudsman dell\'assicurazione malattia — om-kv.ch — Mediazione gratuita per controversie con la cassa malati.',
  ...
  stip: {
    ...
    private: {
      ...
      culturalpromotion: 'culturalpromotion.ch — Ufficio federale della cultura & Percento culturale Migros',
      fundraiso: 'Fundraiso.ch — banca dati di fondazioni (Pro CHF 290/anno)',
      stipendiumch: 'stipendium.ch — supporto personale alla ricerca (CHF 78 per richiesta)',
    },
