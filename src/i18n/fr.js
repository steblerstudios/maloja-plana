export default {
  ...
  tax: {
    ...
    disclaimer: 'Cette orientation montre l\'impôt fédéral direct (LIFD art. 36). Les impôts cantonaux et communaux s\'y ajoutent. Les montants exacts se trouvent auprès de votre administration fiscale cantonale.',
  ...
  zipExport: {
    ...
    manifest: {
      header: 'ORDNUNG & RUHE — SAUVEGARDE DES DONNÉES',
