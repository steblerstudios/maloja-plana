    ...
    abschnitte: [
      {
        titel: 'Provider',
        absaetze: [
          'Sophie Stebler / Stebler Studios<br>[Strasse Nr.], [PLZ] Basel, Switzerland<br>Email: <a href="mailto:info@malojaplana.ch">info@malojaplana.ch</a>',
          'Maloja Plana — Swiss life folder. An open-source project under AGPL-3.0. The app is free to use; for white-label and other commercial use, a separate licence is available on request. Information pursuant to Art. 3 para. 1 lit. s of the Swiss Unfair Competition Act.',
        ],
      },
      {
        titel: 'Disclaimer',
