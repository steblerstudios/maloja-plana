export default {
  ...
  pflege: {
    ...
    step1Text: 'If you regularly care for close relatives, you may receive a caregiving credit — it raises your later AHV pension (same amount as the child-rearing credit). Important: register with the compensation office each year, otherwise it lapses.',
    ...
    entl: {
      ...
      month: 'month',
      year: 'year',
      rateNote: 'calculated at approx. CHF 37.90/h',
  ...
  bewilligung: {
    ...
    step4Text: 'After five to ten years of uninterrupted residence you can, depending on nationality, apply for a settlement permit (C) — it is unlimited and more secure. Integration criteria such as language, work and not relying on social assistance matter here. Good to know: premium reduction (IPV) is ordinary support, not social assistance — claiming it does not count against your permit. Don’t leave money on the table out of worry.',
  ...
  fuehrerausweis: {
    ...
    step4Text: 'After passing the driving test, you first receive the licence on probation — for three years. During this time a further-training course (WAB) is required; afterwards the licence becomes permanent. If the course is missed, the licence lapses.',
  ...
  notfallkarte: {
    ...
    step1Text: 'Tap a number to call. 112 works even without credit or a SIM card.',
    num_sani: 'Ambulance',
    num_police: 'Police',
