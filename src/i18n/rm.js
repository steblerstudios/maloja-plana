export default {
  ...
  ipv: {
    ...
    sgFristLaeuft: 'En il chantun Son Gagl sto la sbassada da premias vegnir dumandada mintga onn da nov. Per {jahr} dura il termin fin ils 31 da mars {jahr}. Tgi che survegn prestaziuns cumplementaras la survegn senza annunzia.',
    sgFristFolgejahr: 'Il termin per {jahr} è scadì ils 31 da mars {jahr} — ina annunzia pli tarda vegn quintada pir a partir dal mais da l’annunzia. Per {folgejahr} è la fanestra dentant gia averta: annunzias vegnan acceptadas tranter il 1. da settember {jahr} ed ils 31 da mars {folgejahr}. L’import qua mussa da tge ch’i va. Tgi che survegn prestaziuns cumplementaras la survegn senza annunzia.',
