export default {
  ...
  kvg: {
    ...
    gynaekoEmpfehlung: 'Recommandation internationale (OMS, 2021) : un test HPV tous les 5–10 ans dès 30 ans — donc moins souvent que la pratique suisse. L’assurance de base couvre le dépistage au rythme recommandé.',
    gynaekoQuelle: 'Source : ligne directrice de l’OMS sur le dépistage du cancer du col de l’utérus, 2021.',
    ...
    mammografieEmpfehlung: 'Recommandation internationale (OMS/UE) : tous les 2 ans pour les femmes de 50 à 74 ans. L’assurance de base couvre ce rythme.',
    mammografieQuelle: 'Source : lignes directrices OMS / UE sur le dépistage du cancer du sein.',
    darmkrebs: 'Dépistage cancer colorectal',
    darmkrebsNote: 'Coloscopie dès 50 ans, tous les 10 ans.',
    darmkrebs10j: 'Tous les 10 ans',
    darmkrebsEmpfehlung: 'Recommandation internationale (UE) : un test de selles tous les 2 ans ou une coloscopie tous les 10 ans (50–74 ans). L’assurance de base couvre ce rythme.',
