export default {
  ...
  dashboard: {
    welcome: 'Verifica i tuoi diritti. Organizza la tua vita.',
    ...
    highlightSozialhilfeSub: 'CHF 1\'031/mese fabbisogno base (1 persona) — dove ti trovi?',
    highlightNotfall: 'Prepara la scheda d\'emergenza',
    highlightNotfallSub: 'Pronta in 2 minuti — sul tuo dispositivo.',
    highlightPrivacy: '100% sul tuo dispositivo',
    quickCheckTitle: 'Verifica rapida: hai diritto alla riduzione dei premi?',
