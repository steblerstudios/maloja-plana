...
export const VALID_VIEWS = new Set([
  ...
  'notfalleinstieg', 'briefe', 'stipendien', 'alv', 'asyl', 'kvg', 'kvgwechsel', 'zusatzwechsel', 'umzug', 'unfallkrankheit', 'neuerjob', 'stelleverloren', 'kkerst', 'pensionierung', 'betreibung', 'selbstaendigkeit', 'heirat', 'kind', 'trennung', 'bewilligung', 'flyer', 'merkliste', 'search',
