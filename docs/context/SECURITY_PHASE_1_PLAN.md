...
Wege (Entscheidung von Sophie, siehe unten):
...
## Mikro-Entscheidungen für Phase 1 (Sophie)
...
2. **Infomaniak-Node-Umgebung (recherchiert 2026-07-07):** euer heutiges Hosting ist
   ...
   - **Empfehlung (korrigiert 2026-07-07): gemanagte Umgebung, NICHT roher VPS.**
     „Am sichersten" = kleinste Fläche, die Sophie selbst absichern muss → OS-Patching an
...
## Provisioning-Checkliste (Sophie, im Infomaniak-Account)
...
> Claude hat **keinen** Account-Zugriff — diese Schritte macht Sophie selbst; die genauen
...
Deploy bleibt (wie beim Frontend) Sophies Aktion — Claude schreibt/prüft Code lokal,
Sophie deployt.
