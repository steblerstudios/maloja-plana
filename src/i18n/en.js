export default {
  ...
  legal: {
    ...
    privacy: {
      ...
      backupTitle: 'Backups',
      backup1: 'Backups are stored locally in your browser. You can export your data as a file at any time (JSON or CSV, encrypted if you wish). This file only leaves your device if you actively share it.',
    ...
    faq: {
      ...
      a1: 'All data stays on your device in browser storage (localStorage). Nothing is sent to a server. If you clear browser storage, the data is gone — so back it up regularly as a file (Tools → Export).',
      ...
      a5: 'Yes. Under Tools → Export you can download your data as a file at any time (JSON or CSV, encrypted if you wish). The backup contains all chapters, documents and settings.',
      ...
      a7: 'Create a backup under Tools → Export (JSON or encrypted) and import it on the new device. There is no automatic sync by design — that would require a server.',
  ...
  budget: {
    ...
    ipvHintOhneBetrag: 'Based on your details, you are probably entitled to a premium reduction (IPV). The canton sets the amount — please check with the canton.',
  ...
  ipv: {
    ...
    orientierungWahrscheinlich: 'Based on your details, you are probably entitled to a reduction. The canton sets the amount — please check with the canton.',
    orientierungOffen: 'Whether a premium reduction is possible, and how much, is decided by the canton — please check with the canton.',
    statusWahrscheinlich: 'Probably entitled · the canton sets the amount',
  ...
  schnellcheck: {
    ...
    ipvOhneBetragNote: 'Probably an entitlement — the canton sets the amount.',
  ...
  sh: {
    ...
    source: 'Calculation based on [[SKOS guidelines|skos.ch]] (1.1.2025). Not legally binding.',
  },
  dl: {
    lang: 'en',
