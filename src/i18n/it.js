export default {
  ...
  todesfall: {
    ...
    step3Text: 'Annunciate il decesso alla cassa di compensazione AVS e alla cassa pensioni — i superstiti hanno spesso diritto a una rendita per vedove, vedovi o orfani. Informate anche la cassa malati, l’assicurazione sulla vita e la banca. Molto di questo ha qualche settimana di tempo.',
    step3Link: 'Vedi la previdenza',
  ...
  heirat: {
    ...
    step1Text: 'Prima delle nozze, l’ufficio dello stato civile svolge una procedura preparatoria. Annunciatevi per tempo e tenete pronti documenti d’identità, attestato di domicilio e, secondo l’origine, altri documenti. Per cittadini stranieri può richiedere più tempo.',
    ...
    step3Text: 'I coniugi e i partner registrati sono tassati congiuntamente — per tutto l’anno a partire dall’anno del matrimonio. Questo può cambiare il carico fiscale. Chi è tassato alla fonte dovrebbe far adeguare la tariffa.',
