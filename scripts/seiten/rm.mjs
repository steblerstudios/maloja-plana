    ...
    abschnitte: [
      {
        titel: 'Purschidra',
        absaetze: [
          'Sophie Stebler / Stebler Studios<br>[Strasse Nr.], [PLZ] Basilea, Svizra<br>E-mail: <a href="mailto:info@malojaplana.ch">info@malojaplana.ch</a>',
          'Maloja Plana — classeur da vita svizzer. In project da funtauna averta sut AGPL-3.0. L’utilisaziun da l’applicaziun è gratuita; per white-label ed autras utilisaziuns commerzialas datti sin dumonda ina licenza separada. Indicaziuns tenor l’art. 3 al. 1 lit. s LCSL.',
        ],
      },
      {
