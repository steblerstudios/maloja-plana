export default {
  ...
  todesfall: {
    ...
    step3Text: 'Annunziai il mortori a la cassa da cumpensaziun AVS ed a la cassa da pensiun — survivents han savens dretg ad ina renta da vaivas, vaivs u orfens. Infurmai era la cassa da malsauns, l’assicuranza da vita e la banca. Bler da quai ha intginas emnas temp.',
  ...
  bewilligung: {
    ...
    step4Text: 'Suenter tschintg fin diesch onns da dimora ininterrutta pos ti, tenor naziunalitad, dumandar l’autorisaziun da domicil (C) — ella è illimitada e pli segira. Impurtants èn ils criteris d’integraziun sco lingua, lavur e nagina dependenza da l’agid social.',
  ...
  heirat: {
    ...
    step1Text: 'Avant la maridaglia maina l’uffizi da stadi civil ina procedura da preparaziun. Annunziai vus baud e tegnai pronts documents d’identitad, attestaziun da domicil e, tenor derivanza, ulteriurs documents. Per burgais esters po quai durar pli ditg.',
    ...
    step3Text: 'Maridads e partenaris registrads vegnan taxads cuminaivlamain — per tut l’onn a partir da l’onn da la maridaglia. Quai po midar la grevezza fiscala. Tgi che vegn taxà a la funtauna duess laschar adattar la tariffa.',
  ...
  kind: {
    ...
    step3Text: 'Per mintga uffant datti in supplement per uffants, pli tard in supplement da scolaziun. El vegn dumandà via il patrun u la cassa da cumpensaziun — el na vegn betg automaticamain. Era persunas senza activitad pon avair dretg.',
  ...
  trennung: {
    ...
    step3Text: 'Cun uffants van avant la chüra e la responsabladad — il bainstar dals uffants stat en il center. Il mantegniment dals uffants ed eventualmain dal conjugal vegn reglà; en cas da dischaccord gida l’APMA u la dretgira. Prendai vus temp, betg tut sto vegnir decidì immediat.',
    step4Title: '4 · Finanzas & taglias',
    step4Text: 'Dapi la separaziun vegnis vus taxads separadamain. Separai contos cuminaivels e procuras e fai vus ina survista. En cas d’in divorzi vegn ultra da quai la cassa da pensiun dals onns da maridaglia partida (gulivaziun da la prevenziun).',
  ...
  selbstaendigkeit: {
    ...
    step2Text: 'Resta l’independenza in supplement sper in plaz (gudogn accessoric) u vegn ella tes gudogn principal? Quai influenzeschia tes contributs AVS, tia prevenziun e sche ti stos t’assecurar cunter la perdita da gudogn. Sco gudogn principal croda la rait da segirezza dal patrun dal tut davent.',
