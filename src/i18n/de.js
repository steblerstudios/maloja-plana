export default {
  ...
  trennung: {
    ...
    step4Text: { sie: 'Ab der Trennung werden Sie getrennt besteuert — der Verheirateten-Tarif fällt weg, Sie werden zum Alleinstehenden- oder, mit Kindern, zum Elterntarif veranlagt, der geschuldete Betrag ändert sich also. Trennen Sie gemeinsame Konten und Vollmachten und verschaffen Sie sich einen Überblick. Bei einer Scheidung wird das AHV-Einkommen der Ehejahre hälftig auf beide aufgeteilt (AHV-Splitting), Erziehungsgutschriften werden geteilt, und die Pensionskasse für diese Jahre wird ebenfalls geteilt (Vorsorgeausgleich).', du: 'Ab der Trennung werdet ihr getrennt besteuert — der Verheirateten-Tarif fällt weg, du wirst zum Alleinstehenden- oder, mit Kindern, zum Elterntarif veranlagt, der geschuldete Betrag ändert sich also. Trennt gemeinsame Konten und Vollmachten und verschafft euch einen Überblick. Bei einer Scheidung wird das AHV-Einkommen der Ehejahre hälftig auf beide aufgeteilt (AHV-Splitting), Erziehungsgutschriften werden geteilt, und die Pensionskasse für diese Jahre wird ebenfalls geteilt (Vorsorgeausgleich).' },
