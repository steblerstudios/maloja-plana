export default {
  ...
  ipvStatus: {
    title: 'Il tuo percorso di riduzione dei premi',
    geschaetztLead: 'La cifra qui sopra è una stima. Come funziona la riduzione per te dipende dal cantone:',
    wayAuto: 'Automatica: molti cantoni calcolano la riduzione dalla tua dichiarazione d’imposta — non devi fare nulla, basta attendere la decisione.',
    wayApply: 'Richiesta: in altri cantoni la richiedi tu stesso (vedi i link qui sotto).',
    markApplied: 'Ho fatto la richiesta',
    markConfirmed: 'Decisione ricevuta',
    appliedLabel: 'Richiesta',
    appliedLead: 'Hai richiesto la riduzione. Quando arriva la decisione, annota qui l’importo confermato.',
    stamp: 'confermata',
    confirmedLead: 'Questo è l’importo della tua decisione — non più la nostra stima.',
    betragPrompt: 'Inserisci l’importo indicato nella decisione.',
    betragLabel: 'Importo secondo la decisione (CHF / mese)',
    reminderTitle: 'Verificare la riduzione dei premi per l’anno prossimo',
    renewLead: 'La riduzione vale per un anno. Vuoi che te lo ricordiamo con calma l’anno prossimo?',
  ...
  schnellcheck: {
    ...
    ipvSubsumed: 'La riduzione dei premi (~{amount}) è già compresa qui — viene percepita per prima.',
