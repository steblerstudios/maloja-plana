export default {
  ...
  chapterView: {
    ...
    emptyState: 'Ancora vuoto — pochi dati e Maloja inizia a lavorare per te.',
    emptyStateHint: 'Puoi completare in qualsiasi momento. Niente deve essere fatto tutto insieme.',
  ...
  legal: {
    ...
    privacy: {
      ...
      rightsTitle: 'I tuoi diritti (nLPD)',
      rights1: 'Poiché tutti i dati sono archiviati localmente, hai accesso diretto a tutti i tuoi dati in qualsiasi momento — senza richiesta di informazioni.',
      rights2: 'Puoi cancellare i tuoi dati in qualsiasi momento (nell\'app o tramite i dati del browser). Non esistono copie lato server.',
      rights3: 'Puoi esportare i tuoi dati come file ZIP leggibile da macchina (diritto alla consegna dei dati, art. 28 nLPD).',
      securityTitle: 'Sicurezza dei dati',
      security1: 'I dati utente non lasciano mai il tuo dispositivo. Tutte le connessioni al sito sono crittografate con HTTPS. Il codice sorgente è accessibile pubblicamente.',
      security2: 'Poiché tutti i dati vengono archiviati localmente, la sicurezza è una tua responsabilità: proteggi il tuo dispositivo con una password e crea backup regolari.',
      cookiesTitle: 'Cookie',
      cookies1: 'Maloja Plana non utilizza alcun cookie — né propri né di terze parti.',
      notificationsTitle: 'Notifiche del browser',
      notifications1: 'Maloja Plana può utilizzare le notifiche del browser per i promemoria delle scadenze. Queste richiedono il tuo consenso esplicito e vengono elaborate interamente in locale.',
    ...
    ethics: {
      ...
      values3: '→ La privacy non è negoziabile. I tuoi dati appartengono a te.',
