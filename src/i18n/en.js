export default {
  ...
  kvg: {
    ...
    mammografieSynthese: 'Basic insurance covers this interval — but not every canton has an organised programme: LU, NW, OW and UR don’t (there only after a referral).',
