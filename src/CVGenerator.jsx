  ...
  return React.createElement('div', { style: { maxWidth: '720px', background: palette.surface, padding: '20px', borderRadius: '8px', border: '1px solid ' + palette.border } },
    ...
    React.createElement('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '12px', marginBottom: '16px' } },
      React.createElement('div', { style: { padding: '12px', background: palette.up, borderRadius: '6px' } },
        React.createElement('div', { style: { fontSize: '11px', color: palette.mid, marginBottom: '4px' } }, '◎ ' + t('cv.name')),
        React.createElement('div', { style: { fontWeight: '600' } }, cv.header.name)
      ),
      React.createElement('div', { style: { padding: '12px', background: palette.up, borderRadius: '6px' } },
        React.createElement('div', { style: { fontSize: '11px', color: palette.mid, marginBottom: '4px' } }, '○ ' + t('cv.phone')),
        React.createElement('div', { style: { fontWeight: '600', fontSize: '12px' } }, cv.header.phone)
      ),
      React.createElement('div', { style: { padding: '12px', background: palette.up, borderRadius: '6px' } },
        React.createElement('div', { style: { fontSize: '11px', color: palette.mid, marginBottom: '4px' } }, '◇ ' + t('cv.profession')),
        React.createElement('div', { style: { fontWeight: '600', fontSize: '12px' } }, cv.experience.current.title || '—')
      ),
      React.createElement('div', { style: { padding: '12px', background: palette.up, borderRadius: '6px' } },
        React.createElement('div', { style: { fontSize: '11px', color: palette.mid, marginBottom: '4px' } }, '✦ ' + t('cv.qualification')),
        React.createElement('div', { style: { fontWeight: '600', fontSize: '12px' } }, cv.education.highest || '—')
      )
    ),
    ...
    React.createElement('div', { style: { display: 'flex', gap: '8px', marginBottom: '16px' } },
      ...
      React.createElement('button', {
        ...
        style: { flex: 1, padding: '10px', background: palette.sage, color: '#000', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: '600', fontSize: '12px' }
      }, '↙ ' + t('cv.downloadHtml'))
    ),
