export default {
  ...
  todesfall: {
    ...
    step3Text: 'Report the death to the AHV compensation office and the pension fund — survivors are often entitled to a widow’s, widower’s or orphan’s pension. If such a pension does not cover living costs, supplementary benefits (EL) can top it up. Also inform the health insurer, life insurance and bank. Much of this has a few weeks’ time.',
    step3Link: 'View pension',
    step3LinkSituation: 'If a parent died: the “half-orphan” situation',
    step4Title: '4 · Inheritance & estate',
