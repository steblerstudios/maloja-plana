...
> **ACHTUNG:** Diese 5 Einträge sind als „Family feedback (domain expert)" erfasst. **Es ist unklar, ob dies Mutter oder eine andere Person ist.** Sophie muss das klären und ggf. den Quellennamen korrigieren.
...
>
> **Alle folgenden Einträge sind Platzhalter.** Sophie muss das Feedback manuell rekonstruieren.
...
- **Nächste Aktion:** Sophie: Bitte rekonstruieren, was Mutter konkret zum Budget gesagt hat.

### Mutter-Feedback — Rekonstruktions-Template

> Sophie, bitte fülle die folgenden Fragen aus, soweit du dich erinnern kannst.
