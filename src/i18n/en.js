export default {
  ...
  ipv: {
    ...
    sgFristLaeuft: 'In the canton of St. Gallen the premium reduction has to be applied for afresh every year. For {jahr} the deadline runs until 31 March {jahr}. Anyone receiving supplementary benefits gets it without applying.',
    sgFristFolgejahr: 'The deadline for {jahr} passed on 31 March {jahr} — a later application is only counted from the month it is submitted. For {folgejahr} the window is already open, though: applications are accepted between 1 September {jahr} and 31 March {folgejahr}. The amount here shows what is at stake. Anyone receiving supplementary benefits gets the reduction without applying.',
