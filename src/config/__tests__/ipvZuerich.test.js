...
// Erweitert 20.09.2026 um BE, AG und VD (die Kantone zwei bis vier mit eigenem Modell):
// unverändert bleiben jetzt 22 der 26 Kantone, nicht mehr 25.
const EIGENES_MODELL = ['ZH', 'BE', 'AG', 'VD'];

describe('K31 Regression: alle Kantone ausser ZH, BE, AG und VD rechnen exakt wie v0.1.37-beta', () => {
  const haushalte = [
