export default {
  ...
  finanzUebersicht: {
    ...
    povertyLineNote: { sie: 'Soglia di povertà per la Sua economia domestica: {amount}/mese (secondo la metodologia UST 2024). Il confronto si basa sul reddito disponibile: il netto, meno imposte, premi e deduzioni.', du: 'Soglia di povertà per la tua economia domestica: {amount}/mese (secondo la metodologia UST 2024). Il confronto si basa sul reddito disponibile: il netto, meno imposte, premi e deduzioni.' },
