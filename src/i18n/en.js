export default {
  ...
  sh: {
    ...
    wohnformZweckWg: 'Separately — flatshare to save on housing costs',
    wohnformHint: 'Run jointly: basic needs as a share of the whole household. Flatshare run separately: basic needs of the supported persons minus 10%. When in doubt, social services assume a joint household — a separately run household has to be shown.',
