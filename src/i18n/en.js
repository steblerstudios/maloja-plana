export default {
  ...
  legal: {
    ...
    privacy: {
      ...
      hosting1: 'The static web application (without user data) is hosted by Infomaniak Network SA (Geneva, Switzerland) — a Swiss provider with data centres in Switzerland. When accessing the website, technical data (IP address, browser type) is processed in server logs and deleted after the host\'s retention period.',
