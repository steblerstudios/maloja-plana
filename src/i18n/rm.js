export default {
  ...
  kvg: {
    ...
    mammografieSynthese: 'L’assicuranza da basa cuvra quest ritmus — ma betg mintga chantun ha in program organisà: LU, NW, OW ed UR betg (là mo suenter ina prescripziun medicinala).',
