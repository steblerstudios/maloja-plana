export default {
  ...
  kvg: {
    ...
    gynaekoEmpfehlung: 'Raccomandazione internazionale (OMS, 2021): un test HPV ogni 5–10 anni dai 30 anni — quindi meno spesso della prassi svizzera. L’assicurazione di base copre lo screening al ritmo raccomandato.',
    gynaekoQuelle: 'Fonte: linea guida OMS sullo screening del cancro cervicale, 2021.',
    ...
    mammografieEmpfehlung: 'Raccomandazione internazionale (OMS/UE): ogni 2 anni per le donne dai 50 ai 74 anni. L’assicurazione di base copre questo ritmo.',
    mammografieQuelle: 'Fonte: linee guida OMS / UE sullo screening del cancro al seno.',
    darmkrebs: 'Screening cancro colorettale',
    darmkrebsNote: 'Colonscopia dai 50 anni, ogni 10 anni.',
    darmkrebs10j: 'Ogni 10 anni',
    darmkrebsEmpfehlung: 'Raccomandazione internazionale (UE): un test delle feci ogni 2 anni o una colonscopia ogni 10 anni (50–74 anni). L’assicurazione di base copre questo ritmo.',
