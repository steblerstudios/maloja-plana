export default {
  ...
  alimentInfo: {
    ...
    summaryNA: "betrifft Dich aktuell nicht — antippen zum Erkunden",
  ...
  stip: {
    checkTitle: "Kurz-Check: Bist Du grundsätzlich berechtigt?",
    checkStatusQ: "Dein Aufenthaltsstatus",
    checkScopeQ: "Deine Ausbildung",
    checkStatusOnlyEducation: "Nur für die Ausbildung in der Schweiz",
    checkScopeOther: "Anderes / Weiterbildung",
    resultEligible: "Du erfüllst die harmonisierten Grundvoraussetzungen. Stelle den Antrag bei der Stipendienstelle Deines (bzw. des elterlichen) Wohnsitzkantons — Beträge und genaue Grenzen legt der Kanton fest.",
    ...
    resultScopeOther: "Für Zweitausbildungen und Weiterbildungen gelten engere Regeln. Kläre Deinen Fall direkt mit der kantonalen Stipendienstelle.",
    resultUnclear: "Deine Berechtigung ist nicht eindeutig. Kläre sie mit der kantonalen Stipendienstelle — die Erstprüfung ist kostenlos.",
