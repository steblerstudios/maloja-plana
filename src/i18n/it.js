export default {
  ...
  tresor: {
    ...
    sortByName: 'Nome (A-Z)',
    noDocuments: 'Il tuo raccoglitore è pronto',
    noDocumentsHint: 'Quando carichi un documento in un capitolo, apparirà qui — al sicuro e solo sul tuo dispositivo.',
    expired: 'Scaduto',
    expiryDate: 'Scadenza: {date}',
    uploadedInfo: 'Caricato: {date} · {size}',
    docCount: '{count} documenti',
    ordnerEmpty: 'Il tuo raccoglitore è pronto.',
    ordnerStarting: 'Un buon inizio.',
    ordnerGrowing: 'Il tuo raccoglitore si riempie.',
  ...
  budgetSync: {
    ...
    emptyNote: '{count} categorie puoi ancora completare — senza fretta, ogni passo conta.',
    emptyNoteSingle: 'Una categoria è ancora aperta — puoi completarla in qualsiasi momento.',
  ...
  premium: {
    ...
    enterIncome: 'Il tuo cantone è stato ripreso. Inserisci ora il tuo reddito mensile in "Finanze" per calcolare la riduzione dei premi.',
  ...
  sozialhilfe: {
    ...
    noEntitlementNote: 'Il tuo reddito copre il fabbisogno calcolato — è un buon punto di partenza.',
  ...
  tax: {
    ...
    disclaimer: 'Questo orientamento mostra l\'onere fiscale stimato (federale, cantonale, comunale). I valori cantonali sono basati sul capoluogo. Gli importi esatti si trovano presso l\'amministrazione fiscale del tuo cantone.',
    netIncomeNote: 'Proiezione basata sul tuo salario netto × 12. L\'onere fiscale effettivo può variare.',
  },

  schulden: {
    title: 'Debiti & fatture',
    intro: 'Fatture in sospeso e debiti sono più comuni di quanto si pensi. Questa panoramica ti aiuta a mantenere il controllo — passo dopo passo, senza giudizio.',
    overview: 'Panoramica',
    debts: 'Debiti',
