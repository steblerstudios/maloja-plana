    ...
    abschnitte: [
      {
        titel: 'Fournisseuse',
        absaetze: [
          'Sophie Stebler / Stebler Studios<br>[Strasse Nr.], [PLZ] Bâle, Suisse<br>Courriel : <a href="mailto:info@malojaplana.ch">info@malojaplana.ch</a>',
          'Maloja Plana — classeur de vie suisse. Un projet open source sous AGPL-3.0. L’utilisation de l’application est gratuite ; pour le white-label et tout autre usage commercial, une licence séparée est disponible sur demande. Indications selon l’art. 3 al. 1 let. s LCD.',
        ],
      },
      {
