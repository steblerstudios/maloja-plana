...
const FIELD_KEYS = {
  ...
  versicherungen: ['kkInsurer', 'kkModel', 'kkPremium', 'franchise', 'kkCardNumber', 'kkZusatz', 'bvgInsurer', 'bvgContribution', 'bvgBalance', 'uvg', 'ktg', 'liabilityInsurance', 'liabilityAmount', 'householdInsurance', 'householdInsuranceAmount', 'travelInsurance', 'cyberInsurance', 'autoInsurance', 'autoInsuranceAmount', 'ahvContribution'],
