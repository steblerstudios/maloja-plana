export default {
  ...
  kind: {
    ...
    step3Text: 'Per ogni figlio spetta un assegno per i figli, poi un assegno di formazione. Si richiede tramite il datore di lavoro o la cassa di compensazione — non arriva automaticamente. Anche chi non lavora può averne diritto.',
