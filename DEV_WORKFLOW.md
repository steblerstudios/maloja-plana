...
### Prod-Reviews immer über den GANZEN Code (Entscheid von Stebler Studios 2026-07-11)
...
- **Produktion:** `bash deploy.sh` von `main` (nur Stebler Studios; Rollback-Backup automatisch).
