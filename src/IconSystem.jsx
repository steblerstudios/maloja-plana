...
const _finanzen = () => React.createElement('svg', { viewBox: '0 0 48 48', fill: 'currentColor' },
  ...
  React.createElement('circle', { cx: '24', cy: '24', r: '19.5', fill: 'none', stroke: 'white', strokeWidth: '0.5', strokeDasharray: '1.2 1.6' }),
  ...
  React.createElement('path', { d: 'M 16 17 Q 16 15.5 18 15.5 L 30 15.5 Q 32 15.5 32 17 L 32 30 Q 32 32 30 33.5 L 24 37.5 L 18 33.5 Q 16 32 16 30 Z', fill: 'white' }),
  ...
  React.createElement('ellipse', { cx: '9', cy: '20', rx: '2.5', ry: '1', transform: 'rotate(-30 9 20)', fill: 'white', opacity: '0.8' }),
  React.createElement('ellipse', { cx: '8', cy: '26', rx: '2.5', ry: '1', transform: 'rotate(-20 8 26)', fill: 'white', opacity: '0.8' }),
  React.createElement('ellipse', { cx: '7.5', cy: '32', rx: '2.5', ry: '1', transform: 'rotate(-10 7.5 32)', fill: 'white', opacity: '0.8' }),
  React.createElement('ellipse', { cx: '39', cy: '20', rx: '2.5', ry: '1', transform: 'rotate(30 39 20)', fill: 'white', opacity: '0.8' }),
  React.createElement('ellipse', { cx: '40', cy: '26', rx: '2.5', ry: '1', transform: 'rotate(20 40 26)', fill: 'white', opacity: '0.8' }),
  React.createElement('ellipse', { cx: '40.5', cy: '32', rx: '2.5', ry: '1', transform: 'rotate(10 40.5 32)', fill: 'white', opacity: '0.8' }),
  React.createElement('text', { x: '24', y: '44.5', textAnchor: 'middle', fontSize: '5.5', fill: 'white', style: { fontFamily: 'Georgia, serif' } }, '2026'),
);
...
const _behoerden = () => React.createElement('svg', { viewBox: '0 0 48 48', fill: 'currentColor' },
  React.createElement('circle', { cx: '24', cy: '24', r: '22' }),
  React.createElement('circle', { cx: '24', cy: '24', r: '19.5', fill: 'none', stroke: 'white', strokeWidth: '0.5', strokeDasharray: '1.2 1.6' }),
  React.createElement('circle', { cx: '22', cy: '9', r: '4', fill: 'white' }),
  React.createElement('path', { d: 'M 21 6 L 20 4 M 22.5 5.5 L 23 3 M 24.5 6.5 L 26 4.5', stroke: 'white', strokeWidth: '1', strokeLinecap: 'round' }),
  React.createElement('path', { d: 'M 17 13 Q 22 12 25 14 L 27 20 L 28 26 L 30 40 L 23 40 L 22 28 L 18 40 L 11 40 L 16 26 L 17 20 Z', fill: 'white' }),
  React.createElement('path', { d: 'M 17 14 L 13 19 Q 11 22 14 21 L 17 18', fill: 'white' }),
  React.createElement('line', { x1: '13', y1: '5', x2: '13', y2: '40', stroke: 'white', strokeWidth: '1.2', strokeLinecap: 'round' }),
  React.createElement('path', { d: 'M 11.5 5.5 L 13 3.5 L 14.5 5.5', stroke: 'white', strokeWidth: '1', fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round' }),
  React.createElement('path', { d: 'M 30 27 Q 30 25 32 25 L 37 25 Q 39 25 39 27 L 39 34 Q 39 36 37 37.5 L 35 39.5 L 32.5 37.5 Q 30 36 30 34 Z', fill: 'white' }),
  React.createElement('rect', { x: '33.5', y: '28', width: '3', height: '8.5', fill: 'currentColor' }),
  React.createElement('rect', { x: '31.5', y: '31', width: '7', height: '3', fill: 'currentColor' }),
);
