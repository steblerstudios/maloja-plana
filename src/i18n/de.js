export default {
  ...
  zipExport: {
    ...
    manifest: {
      ...
      securityTip2: 'Bewahren Sie die exportierten Dateien sicher auf (am besten als verschlüsselte Sicherung)',
  ...
  vr: {
    ...
    tabZukunft: 'Zukunft',
    zukunftIntro: 'Wie Ihr Vorsorge-Vermögen bis zur Pensionierung wachsen könnte — 2. Säule, 3a und 3b zusammen. Beträge aus «Finanzen», Rendite als Annahme.',
