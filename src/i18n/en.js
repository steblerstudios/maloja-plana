export default {
  ...
  stelleVerloren: {
    ...
    step1Text: 'Unemployment benefits start only from the day you register — not retroactively. So register with your municipality or the RAV at the latest on your first day without a job. Already during the notice period you should apply for jobs and document your efforts.',
    step1Link: 'Estimate benefits',
    step2Title: '2 · Insurances — the invisible gap',
    step2Text: 'Accident cover through your former employer ends 31 days after you leave. After that you must include accidents in your health insurance (or take out a supplementary agreement). Basic insurance continues as normal.',
  ...
  todesfall: {
    ...
    step4Text: 'Depending on the situation the estate needs a certificate of inheritance; a will is opened by the court. Important: if the estate is over-indebted, the inheritance can be declined within three months — otherwise the debts are inherited too. If unsure, seek advice early.',
  ...
  iv: {
    ...
    step2Text: 'If it becomes clear the impairment will last, register with the IV early (early detection). The IV focuses first on reintegration — “integration before pension”. The earlier you register, the better; the IV pays at the earliest six months afterwards.',
    step2Button: 'Save deadline “Check IV registration” ({date})',
  ...
  bewilligung: {
    ...
    step3Text: 'You must report a change of address, job or marriage to the migration office — this is part of your permit obligations. Reporting late can cause problems.',
  ...
  heirat: {
    ...
    step1Button: 'Save deadline “Register the marriage” ({date})',
    step1Done: 'Deadline saved to your calendar.',
    step1CalendarLink: 'View in calendar',
  ...
  kind: {
    ...
    step1Text: 'The birth is registered with the civil registry office — usually the hospital does this. If the parents are not married, the father’s paternity must be acknowledged (before or after the birth, at the registry office). This settles the name and parental responsibility.',
    ...
    step4Text: 'Mothers are entitled to 14 weeks of maternity benefit, the other parent to 2 weeks — both through the EO. Think early about childcare (daycare, day families) and the related tax deductions.',
  ...
  selbstaendigkeit: {
    ...
    step1Button: 'Save deadline “Register with AHV” ({date})',
    step1Done: 'Deadline saved to your calendar.',
    step1CalendarLink: 'View in calendar',
  ...
  betreibung: {
    ...
    step1Text: 'The payment order starts a 10-day deadline. Within it you can file a “Rechtsvorschlag” (objection) at the debt-collection office — verbally at the counter or in writing, without giving a reason. This halts the collection for now. You lose nothing by objecting, even if the claim turns out to be valid.',
  ...
  pensionierung: {
    ...
    step1Text: 'The AHV pension is not paid automatically — you must register with your compensation office, ideally three to six months before retirement. The reference age is 65; drawing it early is possible but reduces the pension for life.',
