export default {
  ...
  kvg: {
    ...
    mammoGeoNote: 'Tous les cantons n’invitent pas par courrier à la mammographie et n’en prennent pas les coûts en charge (hors franchise et quote-part). Là où il n’y a pas de programme, on organise le dépistage soi-même — sur prescription médicale.',
    ...
    mammoGeoWandel: 'La situation évolue — Lucerne, par exemple, dispose d’un nouveau programme depuis 2026.',
