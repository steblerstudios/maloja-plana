export default {
  ...
  legal: {
    ...
    terms: {
      ...
      dataLoss1: 'Tutti i tuoi dati sono memorizzati esclusivamente nel tuo browser (localStorage e IndexedDB). Maloja Plana non ha accesso ai tuoi dati.',
    ...
    faq: {
      ...
      a1: 'Tutti i dati restano sul tuo dispositivo nella memoria del browser (localStorage e IndexedDB). Nulla viene inviato a un server. Se cancelli la memoria del browser, i dati vengono persi — salvali quindi regolarmente in un file (Strumenti → Esportazione).',
      ...
      a5: 'Sì. Sotto Strumenti → Esportazione puoi scaricare i tuoi dati in qualsiasi momento come file: come backup, crittografato con password per impostazione predefinita (senza crittografia se lo scegli), oppure non crittografati in JSON o CSV. Il backup contiene tutti i capitoli, documenti e impostazioni.',
      ...
      a7: "Crea un backup sotto Strumenti → Esportazione (crittografato per impostazione predefinita, senza crittografia se lo scegli) e importalo sul nuovo dispositivo. Sul vecchio dispositivo puoi poi eliminare tutto in Impostazioni → «Dati su questo dispositivo». Non c'è sincronizzazione automatica per scelta — richiederebbe un server.",
