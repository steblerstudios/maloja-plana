export default {
  ...
  pflege: {
    ...
    step2Title: '2 · Caregiving compensation (EO)',
    ...
    step3Title: '3 · Helplessness allowance of the person cared for',
  ...
  vr: {
    ...
    achseAlter: 'Age',
    zukunftGraphHinweis: 'Drag the marker (or use arrow keys) to change the retirement age.',
