export default {
  ...
  tax: {
    ...
    wohnkantonFrage: 'Habitez-vous aussi dans ce canton ({canton}) ? Nous le reprenons alors comme canton de domicile — cela se répercute aussi sur la réduction de primes et l\'aide sociale.',
