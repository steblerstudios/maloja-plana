...
export const VALID_VIEWS = new Set([
  ...
  'notfalleinstieg', 'notfallkarte', 'gesundheit', 'briefe', 'stipendien', 'situationen', 'alv', 'asyl', 'kvg', 'kvgwechsel', 'zusatzwechsel', 'umzug', 'unfallkrankheit', 'neuerjob', 'stelleverloren', 'kkerst', 'pensionierung', 'betreibung', 'selbstaendigkeit', 'heirat', 'kind', 'trennung', 'bewilligung', 'todesfall', 'iv', 'flyer', 'merkliste', 'search',
