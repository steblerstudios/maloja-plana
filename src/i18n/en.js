export default {
  ...
  legal: {
    ...
    resources: {
      ...
      helpTitle: 'Helplines',
      help1: { name: 'The Samaritans (Die Dargebotene Hand) · Tel. 143', url: 'tel:143', desc: '24/7, free, anonymous.' },
      help2: { name: 'Pro Juventute · Tel. 147', url: 'tel:147', desc: 'Counselling for children and young people.' },
