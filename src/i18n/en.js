export default {
  ...
  trennung: {
    ...
    step3Text: 'With children, care and responsibility continue — the children’s wellbeing comes first. Child and possibly spousal support are arranged; if you disagree, the child-protection authority (KESB) or court helps. Take your time, not everything has to be decided at once.',
    step4Title: '4 · Finances & taxes',
    step4Text: 'From separation you are taxed separately. Separate joint accounts and powers of attorney and get an overview. In a divorce, the pension fund for the years of marriage is also split (pension equalisation).',
