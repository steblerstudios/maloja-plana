export default {
  ...
  ipvStatus: {
    title: 'Dein IPV-Weg',
    geschaetztLead: 'Die Zahl oben ist eine Schätzung. Wie die Verbilligung bei dir läuft, hängt vom Kanton ab:',
    wayAuto: 'Automatisch: Viele Kantone berechnen die Verbilligung aus deiner Steuererklärung — du musst nichts tun, sondern nur auf die Verfügung achten.',
    wayApply: 'Antrag: In anderen Kantonen beantragst du sie selbst (siehe die Links unten).',
    markApplied: 'Ich habe beantragt',
    markConfirmed: 'Verfügung erhalten',
    appliedLabel: 'Beantragt',
    appliedLead: 'Du hast die Verbilligung beantragt. Wenn die Verfügung kommt, halte den bestätigten Betrag hier fest.',
    stamp: 'bestätigt',
    confirmedLead: 'Das ist der Betrag aus deiner Verfügung — nicht mehr unsere Schätzung.',
    betragPrompt: 'Trag den Betrag aus der Verfügung ein.',
    betragLabel: 'Betrag laut Verfügung (CHF / Monat)',
    reminderTitle: 'Prämienverbilligung fürs nächste Jahr prüfen',
    renewLead: 'Die Verbilligung gilt pro Jahr. Sollen wir dich nächstes Jahr ruhig daran erinnern?',
  ...
  schnellcheck: {
    ...
    ipvSubsumed: 'Die Prämienverbilligung (~{amount}) ist darin schon enthalten — sie wird zuerst bezogen.',
