...
// Fundament), Neben-/Haupterwerb (Weichenstellung), Versicherungslücken (UVG/KTG/BVG),
// Steuern/MwSt zurücklegen. Kein Rat — Orientierung, keine Rechts-/Steuerberatung.
...
export const Selbstaendigkeit = ({ palette, t, onNavigate }) => {
  ...
  return React.createElement(AblaufContainer, {
    ...
    // Schritt 2 — Neben- oder Haupterwerb? (Weichenstellung)
