export default {
  ...
  bewilligung: {
    ...
    step4Text: 'After five to ten years of uninterrupted residence you can, depending on nationality, apply for a settlement permit (C) — it is unlimited and more secure. Integration criteria such as language, work and not relying on social assistance matter here.',
