...
export const MeineUnterlagen = ({ palette, t, onNavigate }) => {
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement(PageTitle, { palette, icon: React.createElement(Icon, { name: 'documents', size: 22 }), style: { marginBottom: space.md + 'px' } }, t('unterlagen.title')),
      React.createElement('div', {
    ...
    React.createElement(DossierCard, {
      ...
      status: t('behoerdenDossier.openDossier'),
      icon: 'legal',
    ...
    React.createElement(DossierCard, {
      palette,
      title: t('unterlagen.dossier.briefe.title'),
      description: t('unterlagen.dossier.briefe.description'),
