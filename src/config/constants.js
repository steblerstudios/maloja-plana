  ...
  return [
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'rentAmount', label: fl(t, 'wohnen', 'rentAmount'), type: 'currency', section: t('sections.wohnen.costs') },
        ...
        { k: 'mortgageStatus', label: fl(t, 'wohnen', 'mortgageStatus'), type: 'select', options: opts(t, 'wohnen', 'mortgageStatus'), section: t('sections.wohnen.property') },
    ...
    },
    {
      ...
      fields: [
        { k: 'monthlyIncome', label: fl(t, 'finanzen', 'monthlyIncome'), type: 'currency', hint: hn(t, 'finanzen', 'monthlyIncome'), section: t('sections.finanzen.income') },
        ...
        { k: 'pension3a', label: fl(t, 'finanzen', 'pension3a'), type: 'currency', section: t('sections.finanzen.provision') },
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'organDonor', label: fl(t, 'notfall', 'organDonor'), type: 'select', options: opts(t, 'notfall', 'organDonor'), section: t('sections.notfall.provision') },
