    ...
    abschnitte: [
      {
        titel: 'Fornitrice',
        absaetze: [
          'Sophie Stebler / Stebler Studios<br>[Strasse Nr.], [PLZ] Basilea, Svizzera<br>E-mail: <a href="mailto:info@malojaplana.ch">info@malojaplana.ch</a>',
          'Maloja Plana — raccoglitore di vita svizzero. Un progetto open source sotto AGPL-3.0. L’utilizzo dell’applicazione è gratuito; per il white label e altri usi commerciali è disponibile su richiesta una licenza separata. Indicazioni secondo l’art. 3 cpv. 1 lett. s LCSl.',
        ],
      },
      {
