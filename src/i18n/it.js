export default {
  ...
  tax: {
    ...
    bandOutside: 'Per questo reddito imponibile Maloja non mostra qui alcun importo. La tabella del calcolatore d’imposta dell’AFC va da CHF {min} a CHF {max} (capoluogo, anno fiscale {year}); al di fuori Maloja non la estende. Il calcolatore d’imposta dell’AFC calcola l’importo per il tuo comune.',
    bandNotChecked: 'Per questa situazione Maloja non mostra qui alcun importo. L’imposta cantonale e comunale è stata misurata per persone nubili o celibi e coniugate con al massimo tre figli; per le persone non coniugate, solo se i figli vivono nella stessa economia domestica (conferma alla tariffa per genitori). Il calcolatore d’imposta dell’AFC calcola l’importo per il tuo comune.',
    ...
    taxableEstimatedHint: 'Salario netto meno le deduzioni standard usate dal calcolatore d’imposta dell’AFC: spese professionali (3 %, almeno CHF 2 000, al massimo CHF 4 000 — oppure le spese professionali registrate), deduzione per assicurazioni, deduzioni per persone coniugate e per figli, più le deduzioni registrate. Con questo importo Maloja calcola l’imposta federale e legge l’imposta cantonale e comunale.',
    taxableEnteredHint: 'Inserito da te (importo per l’imposta federale diretta). Con questo importo Maloja calcola l’imposta federale e legge l’imposta cantonale e comunale.',
    federalNotCheckedBrutto: 'Per questa situazione Maloja non mostra qui l’imposta federale: il salario è registrato come lordo e Maloja non conosce con esattezza le deduzioni fino al reddito imponibile. Con il salario netto o il reddito imponibile della tassazione appare una stima. Il calcolatore d’imposta dell’AFC calcola l’importo esatto.',
  ...
  finanzUebersicht: {
    ...
    tankEmpty: 'vuoto',
    tankFull: 'pieno',
    tankOrientation: 'Non appena le tue spese sono registrate, l\'indicatore mostra quanti mesi copre la tua riserva.',
    tankReadoutEmpty: 'Nessuna riserva registrata finora — si consigliano {recommend} mesi di spese.',
    tankReadout: 'La tua riserva (CHF {savings}) copre circa {months} mesi. Se ne consigliano {recommend}.',
  ...
  po: {
    ...
    tachoReadoutBelow: 'Finora CHF {costs} quest\'anno. Sotto il break-even (CHF {be}), la franchigia alta (CHF {high}) conviene di più.',
    ...
    tachoOrientation: 'Non appena registri le spese sanitarie, la lancetta mostra a che punto sei quest\'anno.',
  ...
  gepaeck: {
    ...
    intro: 'Ogni ambito della vita è un attrezzo nello zaino. Disfa il bagaglio, apri un oggetto — dentro ci sono i percorsi della vita. Un percorso porta al suo iter guidato.',
  ...
  schnellcheck: {
    ...
    kompassIdle: 'Inserisci un reddito e la bussola mostra a cosa potresti avere diritto.',
