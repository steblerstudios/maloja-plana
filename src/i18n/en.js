export default {
  ...
  heirat: {
    ...
    step1Text: 'Before the wedding, the civil registry office runs a preparation procedure. Register early and have ID, proof of residence and, depending on origin, further documents ready. For foreign nationals it can take longer.',
    ...
    step3Title: '3 · Taxes',
    step3Text: 'Married couples and registered partners are taxed jointly — for the whole year from the year of marriage. This can change your tax burden. If you are taxed at source, have your rate adjusted.',
