  ...
  briefe: {
    ...
    dismissalObjection: {
      ...
      felder: {
        ...
        einschaetzung: {
          ...
          hilfe: { sie: 'Erscheint im Brief ausdrücklich als Ihre Einschätzung, nicht als Tatsache. Leer lassen ist ebenso gültig — die Einsprache braucht keine Begründung.', du: 'Erscheint im Brief ausdrücklich als deine Einschätzung, nicht als Tatsache. Leer lassen ist ebenso gültig — die Einsprache braucht keine Begründung.' },
        },
      },
      frist: {
        title: 'Zwei Fristen',
        ...
        einspracheDatum: 'Ende laut Eingabe: {date} — die Einsprache muss vorher beim Arbeitgeber eintreffen.',
        ...
        klageDatum: 'Letzter Tag nach unserer Rechnung: {date}. Verschiebt sich das Ende (etwa wegen Krankheit, OR Art. 336c), liegt die Frist später — wir rechnen bewusst ohne Verlängerung.',
    ...
    debtObjection: {
      ...
      frist: {
        ...
        text: 'Der Rechtsvorschlag muss innert 10 Tagen nach der Zustellung des Zahlungsbefehls beim Betreibungsamt erklärt werden; der Tag der Zustellung zählt nicht mit (SchKG Art. 74 Abs. 1, ZPO Art. 142 Abs. 1).',
        ...
        vorbei: { sie: 'Nach unserer Rechnung ist die Frist am {date} abgelaufen. Wenden Sie sich sofort an das Betreibungsamt oder eine Schuldenberatung und fragen Sie, was noch möglich ist.', du: 'Nach unserer Rechnung ist die Frist am {date} abgelaufen. Wende dich sofort an das Betreibungsamt oder eine Schuldenberatung und frag, was noch möglich ist.' },
    ...
    deathNotice: {
      ...
      erbe: {
        ...
        text: 'Wer sich vor Ablauf der Ausschlagungsfrist in die Erbschaft einmischt — etwas aus dem Nachlass bezahlt, Schulden anerkennt, über Vermögen der verstorbenen Person verfügt oder Dinge an sich nimmt —, kann sie nicht mehr ausschlagen (ZGB Art. 571 Abs. 2). Die Frist beträgt drei Monate (ZGB Art. 567).',
      ...
      vorbehalt: 'Dieses Schreiben ist eine Mitteilung. Es enthält keine Erklärung zur Erbschaft und keine Anerkennung von Forderungen.',
      closing: 'Freundliche Grüsse',
