export default {
  ...
  tax: {
    ...
    annahmeKinderabzugKonkubinat: { sie: "Gerechnet mit dem ganzen Kinderabzug bei Ihnen. Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind erhält jeder Elternteil den halben Kinderabzug (ESTV, Kreisschreiben Nr. 30, Ziff. 14.8.1, direkte Bundessteuer) — die Bundessteuer fällt dann gleich hoch oder höher aus. Wie der Kanton den Abzug aufteilt, ist nicht geprüft.", du: "Gerechnet mit dem ganzen Kinderabzug bei dir. Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind erhält jeder Elternteil den halben Kinderabzug (ESTV, Kreisschreiben Nr. 30, Ziff. 14.8.1, direkte Bundessteuer) — die Bundessteuer fällt dann gleich hoch oder höher aus. Wie der Kanton den Abzug aufteilt, ist nicht geprüft." },
    ...
    bandKonkubinatKinderabzugHaelftig: { sie: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind teilt dieser Kanton den Kinderabzug zwischen den Eltern hälftig auf, auch wenn nur eine Person verdient. Die Tabelle von Maloja und der Steuerrechner der ESTV rechnen mit dem ganzen Abzug bei Ihnen und zeigten die Steuer deshalb zu tief. Den verbindlichen Betrag nennt die Veranlagung; Auskunft gibt die kantonale Steuerverwaltung.", du: "Für die Kantons- und Gemeindesteuer zeigt Maloja hier keinen Betrag: Bei gemeinsamer elterlicher Sorge und ohne Unterhaltsbeiträge für das Kind teilt dieser Kanton den Kinderabzug zwischen den Eltern hälftig auf, auch wenn nur eine Person verdient. Die Tabelle von Maloja und der Steuerrechner der ESTV rechnen mit dem ganzen Abzug bei dir und zeigten die Steuer deshalb zu tief. Den verbindlichen Betrag nennt die Veranlagung; Auskunft gibt die kantonale Steuerverwaltung." },
