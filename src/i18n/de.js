export default {
  ...
  dashboard: {
    ...
    highlightTax: 'Bundessteuer unverbindlich schätzen',
    highlightTaxSub: 'Eine erste Orientierung in 30 Sekunden — verbindlich ist erst die Veranlagung.',
  ...
  mietzinsView: {
    ...
    cantonNote_GE: 'Anspruch über die Mietbelastung (taux d’effort), nicht über eine feste Einkommensgrenze. Max. CHF 1’000 pro Zimmer und Jahr, höchstens die halbe Miete. 2 Jahre ununterbrochen Wohnsitz in den letzten 5 Jahren; kein steuerbares Vermögen; nur HBM/HLM- oder vom Kanton anerkannte Wohnungen.',
  ...
  instrumente: {
    ...
    kreuzPasst: { sie: 'Ihre Franchise passt', du: 'Deine Franchise passt' },
    kreuzWechsel: 'Vorschlag: {franchise} ab 1. Januar',
    kreuzWechselPolster: 'Vorschlag: {franchise}, wenn das Polster reicht',
