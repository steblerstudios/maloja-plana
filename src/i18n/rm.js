export default {
  ...
  stip: {
    checkTitle: "Test svelt: has ti per principi dretg?",
    checkStatusQ: "Tes status da dimora",
    checkScopeQ: "Tia furmaziun",
    checkStatusOnlyEducation: "En Svizra mo per la furmaziun",
    checkScopeOther: "Auter / furmaziun cuntinuanta",
    resultEligible: "Ti accompleschas las premissas da basa harmonisadas. Inoltrescha la dumonda tar l'uffizi da stipendis da tes chantun da domicil (u da quel dals geniturs) — il chantun fixescha ils imports e las limitas exactas.",
    ...
    resultScopeOther: "Per segundas furmaziuns e furmaziun cuntinuanta valan reglas pli strictas. Clerescha tes cas directamain cun l'uffizi chantunal da stipendis.",
    resultUnclear: "Tes dretg n'è betg cler. Clerescha el cun l'uffizi chantunal da stipendis — l'emprima examinaziun è gratuita.",
    ...
    where: 'Inoltra ina dumonda formala tar l’uffizi da stipendis da tes chantun — savens è cumpetent il chantun da domicil da tes geniturs.',
    cantonalLink: 'Uffizis chantunals da stipendis (register CDEP)',
    yourCanton: 'Tes chantun: {canton}',
    formTitle: 'Stipendi u mutg?',
    formNote: 'Stipendis na stos ti betg pajar enavos, mutgs gia. Blers chantuns combineschan omadus.',
