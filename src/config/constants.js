  ...
  return [
    {
      ...
      fields: [
        { k: 'fullName', label: fl(t, 'basis', 'fullName'), type: 'text', required: true },
        ...
        { k: 'canton', label: fl(t, 'basis', 'canton'), type: 'select', options: CANTONS.map(c => ({ value: c, label: c })) },
        { k: 'phone', label: fl(t, 'basis', 'phone'), type: 'tel', placeholder: ph(t, 'basis', 'phone') },
        ...
        { k: 'maritalStatus', label: fl(t, 'basis', 'maritalStatus'), type: 'select', options: opts(t, 'basis', 'maritalStatus') },
    ...
    },
    {
      ...
      fields: [
        { k: 'address', label: fl(t, 'wohnen', 'address'), type: 'text' },
        ...
        { k: 'rentAmount', label: fl(t, 'wohnen', 'rentAmount'), type: 'currency' },
        { k: 'utilities', label: fl(t, 'wohnen', 'utilities'), type: 'currency' },
        { k: 'landlord', label: fl(t, 'wohnen', 'landlord'), type: 'text' },
        { k: 'landlordPhone', label: fl(t, 'wohnen', 'landlordPhone'), type: 'tel' },
        { k: 'mortgageStatus', label: fl(t, 'wohnen', 'mortgageStatus'), type: 'select', options: opts(t, 'wohnen', 'mortgageStatus') },
        { k: 'propertyValue', label: fl(t, 'wohnen', 'propertyValue'), type: 'currency' },
        { k: 'buildingsInsurance', label: fl(t, 'wohnen', 'buildingsInsurance'), type: 'currency' },
        { k: 'residenceType', label: fl(t, 'wohnen', 'residenceType'), type: 'select', options: opts(t, 'wohnen', 'residenceType') },
      ],
      docs: [
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'savingsGoal', label: fl(t, 'finanzen', 'savingsGoal'), type: 'currency' },
        { k: 'savingsAccount', label: fl(t, 'finanzen', 'savingsAccount'), type: 'currency' },
        { k: 'bankName', label: fl(t, 'finanzen', 'bankName'), type: 'text' },
        { k: 'creditCard', label: fl(t, 'finanzen', 'creditCard'), type: 'select', options: opts(t, 'finanzen', 'creditCard') },
        { k: 'loans', label: fl(t, 'finanzen', 'loans'), type: 'currency' },
        { k: 'pension3a', label: fl(t, 'finanzen', 'pension3a'), type: 'currency' },
        { k: 'pension3b', label: fl(t, 'finanzen', 'pension3b'), type: 'select', options: opts(t, 'finanzen', 'pension3b') },
        { k: 'investmentFunds', label: fl(t, 'finanzen', 'investmentFunds'), type: 'select', options: opts(t, 'finanzen', 'investmentFunds') },
      ],
      docs: [
    ...
    },
    {
      ...
      fields: [
        { k: 'kkInsurer', label: fl(t, 'versicherungen', 'kkInsurer'), type: 'text', placeholder: ph(t, 'versicherungen', 'kkInsurer') },
    ...
    },
    {
      ...
      fields: [
        { k: 'schoolName', label: fl(t, 'ausbildung', 'schoolName'), type: 'text' },
        ...
        { k: 'employer', label: fl(t, 'ausbildung', 'employer'), type: 'text' },
        ...
        { k: 'languages', label: fl(t, 'ausbildung', 'languages'), type: 'textarea' },
      ],
      docs: [
    ...
    },
    {
      ...
      fields: [
        { k: 'cantoneOfTaxation', label: fl(t, 'behoerden', 'cantoneOfTaxation'), type: 'select', options: CANTONS.map(c => ({ value: c, label: c })) },
        ...
        { k: 'registryOffice', label: fl(t, 'behoerden', 'registryOffice'), type: 'text' },
        ...
        { k: 'legalRepresentative', label: fl(t, 'behoerden', 'legalRepresentative'), type: 'text' },
    ...
    },
    {
      ...
      fields: [
        { k: 'emergencyContact', label: fl(t, 'notfall', 'emergencyContact'), type: 'text', required: true },
        { k: 'emergencyPhone', label: fl(t, 'notfall', 'emergencyPhone'), type: 'tel', required: true },
        { k: 'bloodType', label: fl(t, 'notfall', 'bloodType'), type: 'select', options: opts(t, 'notfall', 'bloodType') },
        ...
        { k: 'doctor', label: fl(t, 'notfall', 'doctor'), type: 'text' },
