export default {
  ...
  ipv: {
    ...
    sgFristLaeuft: 'Die Prämienverbilligung muss im Kanton St.Gallen jedes Jahr neu beantragt werden. Für {jahr} läuft die Frist bis zum 31. März {jahr}. Wer Ergänzungsleistungen bezieht, erhält sie ohne Anmeldung.',
    sgFristFolgejahr: 'Die Frist für {jahr} ist am 31. März {jahr} abgelaufen — eine spätere Anmeldung wird erst ab dem Monat der Anmeldung gerechnet. Für {folgejahr} ist das Fenster aber bereits offen: Anmeldungen werden zwischen dem 1. September {jahr} und dem 31. März {folgejahr} entgegengenommen. Der Betrag hier zeigt, worum es geht. Wer Ergänzungsleistungen bezieht, erhält die Verbilligung ohne Anmeldung.',
