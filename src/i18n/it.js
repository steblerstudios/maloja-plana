export default {
  ...
  legal: {
    ...
    resources: {
      ...
      help1: { name: 'Telefono Amico · Tel. 143', url: 'tel:143', desc: '24/7, gratuito, anonimo.' },
      help2: { name: 'Pro Juventute · Tel. 147', url: 'tel:147', desc: 'Consulenza per bambini e giovani.' },
