export default {
  ...
  jobs: {
    ...
    sectionHint: 'La plupart des gens ont eu plus d’un emploi. Tu peux enregistrer ici d’autres postes ou des postes précédents.',
  ...
  asyl: {
    ...
    intro: "La procédure d'asile est complexe et souvent éprouvante. Cette page te donne une première orientation calme : quels statuts existent, comment se déroule la procédure et où obtenir un conseil personnel.",
    disclaimer: "Ceci est une orientation, pas un conseil juridique. Pour ta situation concrète, les services indiqués ci-dessous t'aident gratuitement et en toute confidentialité.",
    statusTitle: "Les principaux statuts",
    status: {
      n: { label: "Permis N — requérants d'asile", desc: "Tu as déposé une demande d'asile et attends la décision du SEM. Le permis N confirme la procédure en cours — ce n'est pas une autorisation de séjour." },
    ...
    process: {
      ...
      beschwerde: "Tu peux faire recours contre une décision négative auprès du Tribunal administratif fédéral — fais-toi conseiller pour cela.",
    },
    ...
    rightsTitle: "Tes droits dans la procédure",
    rights: {
      rechtsvertretung: "Représentation juridique gratuite : dans le centre fédéral, une représentation juridique gratuite t'est attribuée et t'accompagne durant la procédure. Accepte-la — c'est ton droit.",
      anhoerung: "Audition & interprète : tu as droit à une audition sur tes motifs de fuite, avec interprétation.",
      beschwerde: "Recours : tu peux contester une décision négative — ta représentation juridique te soutient.",
    },
    fristenTitle: "Important : les délais sont courts",
    fristenBody: "Dans la procédure accélérée, tu dois faire recours dans les 7 jours ouvrables, dans la procédure étendue dans les 30 jours. N'attends pas — contacte immédiatement ta représentation juridique ou un service de conseil.",
    cantonLink: "Ton canton : {canton} → trouver conseils d'asile & autorités",
  },
  alv: {
    title: "Indemnités de chômage",
    intro: "Une orientation sur ce que tu pourrais recevoir comme indemnité journalière en cas de perte d'emploi. Le calcul contraignant est effectué par l'ORP et ta caisse de chômage.",
    bruttolohn: "Salaire brut mensuel précédent (CHF)",
    bruttolohnHint: "Ton salaire brut soumis à l'AVS des 6 derniers mois. Maximum assuré : CHF 12’350/mois.",
    beitragsmonate: "Mois de cotisation",
    beitragsmonateHint: "Combien de mois as-tu travaillé ces 2 dernières années ? Un droit existe en général dès 12 mois.",
    ...
    disclaimer: "Orientation sans garantie. L'ORP / la caisse de chômage calcule le montant contraignant, selon ta situation.",
    ravTitle: "Où t'annoncer",
  ...
  stip: {
    checkTitle: "Vérification rapide : as-tu droit en principe ?",
    checkStatusQ: "Ton statut de séjour",
    checkScopeQ: "Ta formation",
    checkStatusOnlyEducation: "En Suisse uniquement pour la formation",
    checkScopeOther: "Autre / formation continue",
    resultEligible: "Tu remplis les conditions de base harmonisées. Dépose la demande auprès du service des bourses de ton canton de domicile (ou de celui de tes parents) — le canton fixe les montants et les limites exactes.",
    ...
    resultScopeOther: "Des règles plus strictes s'appliquent aux deuxièmes formations et à la formation continue. Clarifie ton cas directement auprès du service cantonal des bourses.",
    resultUnclear: "Ton droit n'est pas clair. Clarifie-le auprès du service cantonal des bourses — le premier examen est gratuit.",
    ...
    where: 'Dépose une demande formelle auprès du service des bourses de ton canton — c’est en général le canton de domicile de tes parents qui est compétent.',
    cantonalLink: 'Services cantonaux des bourses (répertoire CDIP)',
    yourCanton: 'Ton canton : {canton}',
    ...
    checklist3: 'Chercher des fondations privées adaptées à ta formation et ta situation',
