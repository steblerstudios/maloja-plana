export default {
  ...
  todesfall: {
    ...
    step3Text: 'Annunziai il mortori a la cassa da cumpensaziun AVS ed a la cassa da pensiun — survivents han savens dretg ad ina renta da vaivas, vaivs u orfens. Sche ina tala renta na cuvra betg ils custs da viver, pon prestaziuns cumplementaras (PC) la cumplettar. Infurmai era la cassa da malsauns, l’assicuranza da vita e la banca. Bler da quai ha intginas emnas temp.',
    step3Link: 'Guardar la prevenziun',
    step3LinkSituation: 'Sche in genitur è mort: la situaziun «mez orfen»',
    step4Title: '4 · Ierta & lubientscha',
