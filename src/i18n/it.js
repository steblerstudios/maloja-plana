export default {
  ...
  sectionIntros: {
    ...
    versicherungen: {
      ...
      additional: 'LAINF (assicurazione infortuni): Come dipendente sei coperto dal datore di lavoro — infortuni professionali e non professionali da 8h/settimana. IGM (indennità giornaliera malattia): Non obbligatoria, ma molti datori ne hanno una — paga l\'80% del salario in caso di malattia.',
  ...
  nav: {
    ...
    crosslink: {
      ...
      cantonTaxHint: 'Cantone scelto → stima le tue imposte →',
