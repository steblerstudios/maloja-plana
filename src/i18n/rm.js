export default {
  ...
  tax: {
    ...
    bandKonkubinatKinderabzugHaelftig: { sie: "Per la taglia chantunala e communala na mussa Maloja qua nagin import: cun autoritad parentala cuminaivla e senza contribuziuns da mantegniment per l'uffant parta quest chantun la deducziun per uffants per mesadad tranter ils geniturs, er sche mo ina persuna gudogna. La tabella da Maloja ed il calculatur da taglia da l'AFT quintan l'entira deducziun tar Vus e mussassan perquai ina taglia memia bassa. L'import decisiv stat en la taxaziun; l'administraziun chantunala da taglia As dat infurmaziuns.", du: "Per la taglia chantunala e communala na mussa Maloja qua nagin import: cun autoritad parentala cuminaivla e senza contribuziuns da mantegniment per l'uffant parta quest chantun la deducziun per uffants per mesadad tranter ils geniturs, er sche mo ina persuna gudogna. La tabella da Maloja ed il calculatur da taglia da l'AFT quintan l'entira deducziun tar tai e mussassan perquai ina taglia memia bassa. L'import decisiv stat en la taxaziun; l'administraziun chantunala da taglia ta dat infurmaziuns." },
