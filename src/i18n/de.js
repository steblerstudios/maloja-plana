export default {
  ...
  todesfall: {
    ...
    step3Text: 'Meldet den Todesfall der AHV-Ausgleichskasse, der Pensionskasse sowie Krankenkasse, Lebensversicherung und Bank. Vieles davon hat ein paar Wochen Zeit.',
    step3Link: 'Vorsorge ansehen',
  ...
  pflege: {
    ...
    stepLohnTitle: '2 · Deinen Einsatz entlöhnen lassen',
    ...
    entl: {
      ...
      extLink: 'Spitex-Organisation in deiner Region finden',
    },
    ...
    step4Text: 'Du musst das nicht allein tragen. Entlastungsdienste, Pro Senectute, Pro Infirmis und die Spitex begleiten und entlasten. Die passende Lebenssituation bündelt weitere Ansprüche an einem Ort.',
  ...
  fuehrerausweis: {
    ...
    step1Text: 'Leg den Führerausweis im Kreditkartenformat in deinen Dokumenten-Tresor — dann findest du ihn bei Verlust oder einer Kontrolle schnell wieder.',
    step1Link: 'Im Dokumenten-Tresor ablegen',
    step2Title: '2 · Alten Papierausweis umtauschen',
    step2Text: 'Hast du noch den alten blauen Führerausweis aus Papier? Er ist seit dem 1. November 2024 nicht mehr gültig. Tausch ihn beim kantonalen Strassenverkehrsamt ins Kreditkartenformat um — der Ausweis selbst hat kein Ablaufdatum.',
    ...
    step5Text: 'Ist der Ausweis weg, beantrag beim kantonalen Strassenverkehrsamt einen Ersatz. Eine Kopie oder ein Foto im Tresor hilft, die Angaben schnell zur Hand zu haben.',
  ...
  kind: {
    ...
    step5Text: 'Ein grösserer Haushalt ändert, was dir zusteht. Deine Prämienverbilligung (IPV) wird auf den neuen Haushalt neu berechnet — ein zweiter Blick lohnt sich. Wenn du das Kind allein grossziehst oder mit knappem Budget, sammeln die Lebenszustände weitere Unterstützung an einem ruhigen Ort.',
  ...
  selbstaendigkeit: {
    ...
    step2Text: 'Bleibt die Selbständigkeit ein Zusatz neben einer Anstellung (Nebenerwerb) oder wird sie dein Haupteinkommen? Das beeinflusst deine AHV-Beiträge, deine Vorsorge und ob du dich gegen Erwerbsausfall absichern musst. Beim Haupterwerb fällt das Sicherheitsnetz des Arbeitgebers ganz weg — und gegen Arbeitslosigkeit (ALV) bist du nicht versichert. Bleibt das Einkommen knapp oder unregelmässig, stehst du nicht ohne Unterstützung da: der Lebenszustand „Tiefes Einkommen" sammelt, was dir trotzdem zusteht (Prämienverbilligung, Mietzinsbeitrag, ergänzende Sozialhilfe).',
