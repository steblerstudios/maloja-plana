export default {
  ...
  finanzUebersicht: {
    ...
    povertyLineNote: 'Poverty line for your household: {amount}/month (based on FSO methodology 2024). The comparison uses your disposable income: net minus taxes, premiums and deductions.',
