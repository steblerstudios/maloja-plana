export default {
  ...
  lebenszustaende: {
    ...
    standLabel: 'Stand',
    regio: {
      title: 'Angebote in deiner Region',
      kulturlegiRegion: 'Deine regionale KulturLegi',
      kulturlegiRegionText: 'Die Angebote für deine Region — Kultur, Kurse, Sport und mehr.',
      checkTitle: 'Deine regionale KulturLegi finden',
      checkText: 'Die KulturLegi listet vergünstigte Angebote je Region — schau, was bei dir gilt.',
      noneNote: 'In deiner Region scheint es noch keine KulturLegi zu geben — das kann sich ändern.',
      offers: {
    ...
    tiefesEinkommen: {
      ...
      berechtigungen: {
        ...
        familienEL: { titel: 'Ergänzungsleistungen für Familien', text: 'Dein Kanton zahlt erwerbstätigen Familien mit kleinen Kindern und knappem Einkommen eine monatliche Ergänzungsleistung — damit eine Familie nicht in die Sozialhilfe rutscht. Oft unbekannt.' },
        mutterschaftsbeihilfe: { titel: 'Mutterschaftsbeihilfe', text: 'Einige Kantone zahlen dir nach der Geburt während mehreren Monaten eine Beihilfe, damit du dein Kleinkind selbst betreuen kannst, wenn das Einkommen den Lebensbedarf nicht deckt. Oft unbekannt.' },
  ...
  notfallEinstieg: {
    ...
    vorlesekarteTitle: 'Im Ernstfall: was du am Telefon sagst',
    vorlesekarteSub: 'Die Vorlesekarte führt dich durch den Anruf und zeigt deine wichtigsten Angaben',
    unfall: {
      title: 'Unfall',
  ...
  legal: {
    ...
    resources: {
      ...
      movedText: 'Diese Ressourcen — sichere Kanäle, Beratungs- und Ombudsstellen, Petitionen und die Herzensempfehlungen — findest du jetzt gebündelt in der Bibliothek.',
  ...
  notfallkarte: {
    ...
    intro: 'Wenn etwas passiert, musst du dir nichts merken. Diese Karte sagt dir, was du sagst — und liest deine hinterlegten Angaben ab.',
    step1Title: 'Nummer wählen',
    step1Text: 'Tippe auf eine Nummer, um anzurufen. 112 funktioniert auch ohne Guthaben oder SIM-Karte.',
    num_sani: 'Sanität',
    num_police: 'Polizei',
    num_fire: 'Feuerwehr',
    ...
    step1Note: 'Unsicher, welche? Ruf 144 — sie verbinden dich weiter.',
    step2Title: 'Was du sagst',
    step2Text: 'Bleib ruhig. Sag es der Reihe nach:',
    sayWhere: 'Wo bist du?',
    sayWhereEmpty: 'sag, wo du bist',
    sayWhat: 'Was ist passiert?',
    sayHowMany: 'Wie viele Personen sind betroffen?',
    sayWho: 'Wer bist du?',
    sayWhoEmpty: 'nenn deinen Namen und deine Nummer',
    step2Stay: 'Bleib am Telefon. Leg erst auf, wenn die Leitstelle es sagt.',
    ...
    loc_denied: 'Standort-Freigabe abgelehnt — das ist ok. Sag einfach, wo du bist.',
    loc_error: 'Standort liess sich nicht ermitteln. Sag einfach, wo du bist.',
    loc_unsupported: 'Dieses Gerät kann den Standort hier nicht ermitteln. Sag einfach, wo du bist.',
    step3Title: 'Deine Angaben zum Ablesen',
    step3Text: 'Du musst sie dir nicht merken — lies sie ab, wenn du gefragt wirst:',
    ...
    footerCalm: 'Diese Karte liegt nur auf deinem Gerät — niemand sonst sieht sie.',
  },
  notfallDossier: {
    title: 'Notfall-Dossier',
  ...
  kvg: {
    ...
    mammografieSynthese: 'Die Grundversicherung deckt diesen Rhythmus. Ob dein Wohnkanton ein organisiertes Programm mit persönlicher Einladung hat, ist unterschiedlich — mehr dazu unten.',
  ...
  schnellcheck: {
    ...
    noResultNoCanton: 'Für Prämienverbilligung und Sozialhilfe fehlt der Kanton — trag ihn im Profil ein.',
    enterIncome: 'Trag dein Monatseinkommen ein, um zu sehen, was möglich ist.',
    ...
    disclaimer: 'Grobe Orientierung, keine Zusicherung. Der genaue Anspruch hängt vom Kanton und deiner Situation ab — die verlinkten Rechner und Stellen prüfen im Detail.',
  },
  vr: {
    ...
    zukunftIkTitle: 'AHV-Grundlage: deine IK-Historie',
    zukunftIkAktiv: 'Diese Projektion nutzt deine erfasste IK-Historie als AHV-Fundament — {jahre} Beitragsjahre, Ø CHF {eink}.',
    zukunftIkInaktiv: 'Die AHV-Fläche im Graph beruht noch auf einer Schätzung. Erfasse deine IK-Historie für eine genauere Grundlage.',
    ...
    altersHilfenTitle: 'Was dich im Alter entlastet',
    altersHilfenIntro: 'Bei tiefer Rente steht dir oft mehr zu, als viele wissen — hier lohnt sich ein Blick.',
    ...
    altersKostenTitle: 'Was im Alter auf dich zukommt',
    altersKostenIntro: 'Grobe Übersicht der Posten, mit denen im Alter zu rechnen ist — keine Beträge, die Höhe hängt stark von deiner Situation und dem Kanton ab.',
    ...
    zukunftRenteKapitalHinweis: '3a und 3b sind Kapital — hier vereinfacht als Monatsrente gezeigt (gleichmässig verteilt bis Alter {le}). Die tatsächliche Auszahlung bestimmst du selbst.',
    ...
    zukunftAhvFlaeche: 'Die AHV-Fläche ist der geschätzte Barwert deiner AHV-Rente (kapitalisiert bis Alter {le}) — so wird die 1. Säule als Fundament sichtbar und mit den anderen Säulen vergleichbar.',
    ...
    zukunftSzenarioBridge: 'Die Jahre von {von} bis 63 überbrückst du ohne AHV — etwa aus BVG-Rente oder 3a-Kapital.',
    zukunftSzenarioSaeulen: 'BVG-Rente ist ab 58 möglich, 3a-Kapital ab 60 — je nach Reglement deiner Pensionskasse.',
