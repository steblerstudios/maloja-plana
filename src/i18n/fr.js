export default {
  ...
  pflege: {
    ...
    step2Title: '2 · Indemnité de prise en charge (APG)',
    ...
    step3Title: '3 · Allocation pour impotent de la personne aidée',
  ...
  vr: {
    ...
    achseAlter: 'Âge',
    zukunftGraphHinweis: 'Faites glisser le repère (ou les touches fléchées) pour changer l’âge de la retraite.',
