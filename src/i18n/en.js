export default {
  ...
  kvg: {
    ...
    mammoGeoNote: 'Not every canton invites you by letter for a mammogram and covers the cost (apart from the deductible and co-payment). Where there is no programme, you arrange screening yourself — after a medical referral.',
    ...
    mammoGeoWandel: 'This is changing — Lucerne, for example, has had a new programme since 2026.',
