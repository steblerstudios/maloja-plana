export default {
  ...
  legal: {
    ...
    terms: {
      ...
      ip1: 'Maloja Plana ist ein Open-Source-Projekt. Der Quellcode steht unter der AGPL-3.0-Lizenz. Du darfst ihn einsehen, kopieren und weiterentwickeln.',
  ...
  jobs: {
    ...
    sectionHint: 'Die meisten hatten schon mehr als einen Job. Hier kannst Du weitere oder frühere Anstellungen festhalten.',
  ...
  stip: {
    ...
    where: 'Reiche ein formelles Gesuch bei der Stipendienstelle Deines Kantons ein — zuständig ist in der Regel der Wohnsitzkanton Deiner Eltern.',
    cantonalLink: 'Kantonale Stipendienstellen (EDK-Verzeichnis)',
    yourCanton: 'Dein Kanton: {canton}',
    formTitle: 'Stipendium oder Darlehen?',
    formNote: 'Stipendien musst Du nicht zurückzahlen, Darlehen schon. Viele Kantone kombinieren beides.',
