export default {
  ...
  trennung: {
    ...
    step3Text: 'Con i figli, cura e responsabilità continuano — il bene dei figli è al centro. Il mantenimento dei figli ed eventualmente del coniuge viene regolato; in caso di disaccordo, l’APMA o il tribunale aiuta. Prendetevi tempo, non tutto va deciso subito.',
    step4Title: '4 · Finanze & imposte',
    step4Text: 'Dalla separazione siete tassati separatamente. Separate conti comuni e procure e fatevi una visione d’insieme. In caso di divorzio, la cassa pensioni degli anni di matrimonio viene inoltre divisa (conguaglio della previdenza).',
